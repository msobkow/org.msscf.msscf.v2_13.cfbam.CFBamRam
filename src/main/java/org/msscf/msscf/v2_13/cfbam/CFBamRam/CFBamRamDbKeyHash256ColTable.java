...
// Description: Java 11 in-memory RAM DbIO implementation for DbKeyHash256Col.
...
/*
 *	CFBamRamDbKeyHash256ColTable in-memory RAM DbIO implementation
 *	for DbKeyHash256Col.
 */
public class CFBamRamDbKeyHash256ColTable
	implements ICFBamDbKeyHash256ColTable
{
	private ICFBamSchema schema;
	private Map< CFBamValuePKey,
				CFBamDbKeyHash256ColBuff > dictByPKey
		= new HashMap< CFBamValuePKey,
				CFBamDbKeyHash256ColBuff >();
	private Map< CFBamDbKeyHash256ColByTableIdxKey,
				Map< CFBamValuePKey,
					CFBamDbKeyHash256ColBuff >> dictByTableIdx
		= new HashMap< CFBamDbKeyHash256ColByTableIdxKey,
				Map< CFBamValuePKey,
					CFBamDbKeyHash256ColBuff >>();

	public CFBamRamDbKeyHash256ColTable( ICFBamSchema argSchema ) {
		schema = argSchema;
	}

	public void createDbKeyHash256Col( CFSecAuthorization Authorization,
		CFBamDbKeyHash256ColBuff Buff )
	{
		final String S_ProcName = "createDbKeyHash256Col";
		CFBamValueBuff tail = null;
		if( Buff.getClassCode().equals( "a848" ) ) {
		...
		CFBamDbKeyHash256ColByTableIdxKey keyTableIdx = schema.getFactoryDbKeyHash256Col().newTableIdxKey();
		...
		Map< CFBamValuePKey, CFBamDbKeyHash256ColBuff > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< CFBamValuePKey, CFBamDbKeyHash256ColBuff >();
	...
	public CFBamDbKeyHash256ColBuff readDerived( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash256Col.readDerived";
	...
	public CFBamDbKeyHash256ColBuff lockDerived( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash256Col.readDerived";
		CFBamValuePKey key = schema.getFactoryValue().newPKey();
	...
	public CFBamDbKeyHash256ColBuff[] readAllDerived( CFSecAuthorization Authorization ) {
		final String S_ProcName = "CFBamRamDbKeyHash256Col.readAllDerived";
		CFBamDbKeyHash256ColBuff[] retList = new CFBamDbKeyHash256ColBuff[ dictByPKey.values().size() ];
		Iterator< CFBamDbKeyHash256ColBuff > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
	...
	public CFBamDbKeyHash256ColBuff readDerivedByUNameIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		String Name )
	{
		...
		else if( buff instanceof CFBamDbKeyHash256ColBuff ) {
			return( (CFBamDbKeyHash256ColBuff)buff );
		}
		else {
			return( null );
		}
	...
	public CFBamDbKeyHash256ColBuff[] readDerivedByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		...
		if( buffList == null ) {
			...
			CFBamValueBuff buff;
			ArrayList<CFBamDbKeyHash256ColBuff> filteredList = new ArrayList<CFBamDbKeyHash256ColBuff>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof CFBamDbKeyHash256ColBuff ) ) {
					filteredList.add( (CFBamDbKeyHash256ColBuff)buff );
				}
			}
			return( filteredList.toArray( new CFBamDbKeyHash256ColBuff[0] ) );
		}
	}

	public CFBamDbKeyHash256ColBuff[] readDerivedByScopeIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId )
	{
	...
	public CFBamDbKeyHash256ColBuff[] readDerivedByDefSchemaIdx( CFSecAuthorization Authorization,
	...
	public CFBamDbKeyHash256ColBuff[] readDerivedByPrevIdx( CFSecAuthorization Authorization,
		Long PrevTenantId,
		Long PrevId )
	{
	...
	public CFBamDbKeyHash256ColBuff[] readDerivedByNextIdx( CFSecAuthorization Authorization,
		Long NextTenantId,
		Long NextId )
	{
	...
	public CFBamDbKeyHash256ColBuff[] readDerivedByContPrevIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long PrevId )
	{
	...
	public CFBamDbKeyHash256ColBuff[] readDerivedByContNextIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long NextId )
	{
	...
	public CFBamDbKeyHash256ColBuff[] readDerivedByCodeVisIdx( CFSecAuthorization Authorization,
	...
	public CFBamDbKeyHash256ColBuff[] readDerivedByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
	...
	public CFBamDbKeyHash256ColBuff[] readDerivedByTableIdx( CFSecAuthorization Authorization,
		long TenantId,
		long TableId )
	{
		final String S_ProcName = "CFBamRamDbKeyHash256Col.readDerivedByTableIdx";
		CFBamDbKeyHash256ColByTableIdxKey key = schema.getFactoryDbKeyHash256Col().newTableIdxKey();
		key.setRequiredTenantId( TenantId );
		key.setRequiredTableId( TableId );

		CFBamDbKeyHash256ColBuff[] recArray;
		if( dictByTableIdx.containsKey( key ) ) {
			Map< CFBamValuePKey, CFBamDbKeyHash256ColBuff > subdictTableIdx
				= dictByTableIdx.get( key );
			recArray = new CFBamDbKeyHash256ColBuff[ subdictTableIdx.size() ];
			Iterator< CFBamDbKeyHash256ColBuff > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< CFBamValuePKey, CFBamDbKeyHash256ColBuff > subdictTableIdx
				= new HashMap< CFBamValuePKey, CFBamDbKeyHash256ColBuff >();
			dictByTableIdx.put( key, subdictTableIdx );
			recArray = new CFBamDbKeyHash256ColBuff[0];
		}
		return( recArray );
	}

	public CFBamDbKeyHash256ColBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		long TenantId,
		long Id )
	{
	...
	public CFBamDbKeyHash256ColBuff readBuff( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash256Col.readBuff";
		CFBamDbKeyHash256ColBuff buff = readDerived( Authorization, PKey );
	...
	public CFBamDbKeyHash256ColBuff lockBuff( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
	...
	public CFBamDbKeyHash256ColBuff[] readAllBuff( CFSecAuthorization Authorization )
	{
		final String S_ProcName = "CFBamRamDbKeyHash256Col.readAllBuff";
		CFBamDbKeyHash256ColBuff buff;
		ArrayList<CFBamDbKeyHash256ColBuff> filteredList = new ArrayList<CFBamDbKeyHash256ColBuff>();
		CFBamDbKeyHash256ColBuff[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a848" ) ) {
	...
	public CFBamDbKeyHash256ColBuff readBuffByIdIdx( CFSecAuthorization Authorization,
		long TenantId,
		long Id )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByIdIdx() ";
		CFBamDbKeyHash256ColBuff buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
	...
	public CFBamDbKeyHash256ColBuff readBuffByUNameIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		String Name )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByUNameIdx() ";
		CFBamDbKeyHash256ColBuff buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash256ColBuff[] readBuffByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByValTentIdx() ";
		CFBamDbKeyHash256ColBuff buff;
		ArrayList<CFBamDbKeyHash256ColBuff> filteredList = new ArrayList<CFBamDbKeyHash256ColBuff>();
		CFBamDbKeyHash256ColBuff[] buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash256ColBuff[] readBuffByScopeIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId )
	{
		...
		CFBamDbKeyHash256ColBuff buff;
		ArrayList<CFBamDbKeyHash256ColBuff> filteredList = new ArrayList<CFBamDbKeyHash256ColBuff>();
		CFBamDbKeyHash256ColBuff[] buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash256ColBuff[] readBuffByDefSchemaIdx( CFSecAuthorization Authorization,
		Long DefSchemaTenantId,
		Long DefSchemaId )
	{
		...
		CFBamDbKeyHash256ColBuff buff;
		ArrayList<CFBamDbKeyHash256ColBuff> filteredList = new ArrayList<CFBamDbKeyHash256ColBuff>();
		CFBamDbKeyHash256ColBuff[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash256ColBuff[] readBuffByPrevIdx( CFSecAuthorization Authorization,
		Long PrevTenantId,
		Long PrevId )
	{
		...
		CFBamDbKeyHash256ColBuff buff;
		ArrayList<CFBamDbKeyHash256ColBuff> filteredList = new ArrayList<CFBamDbKeyHash256ColBuff>();
		CFBamDbKeyHash256ColBuff[] buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash256ColBuff[] readBuffByNextIdx( CFSecAuthorization Authorization,
		Long NextTenantId,
		Long NextId )
	{
		...
		CFBamDbKeyHash256ColBuff buff;
		ArrayList<CFBamDbKeyHash256ColBuff> filteredList = new ArrayList<CFBamDbKeyHash256ColBuff>();
		CFBamDbKeyHash256ColBuff[] buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash256ColBuff[] readBuffByContPrevIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long PrevId )
	{
		...
		CFBamDbKeyHash256ColBuff buff;
		ArrayList<CFBamDbKeyHash256ColBuff> filteredList = new ArrayList<CFBamDbKeyHash256ColBuff>();
		CFBamDbKeyHash256ColBuff[] buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash256ColBuff[] readBuffByContNextIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long NextId )
	{
		...
		CFBamDbKeyHash256ColBuff buff;
		ArrayList<CFBamDbKeyHash256ColBuff> filteredList = new ArrayList<CFBamDbKeyHash256ColBuff>();
		CFBamDbKeyHash256ColBuff[] buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash256ColBuff[] readBuffByCodeVisIdx( CFSecAuthorization Authorization,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByCodeVisIdx() ";
		CFBamDbKeyHash256ColBuff buff;
		ArrayList<CFBamDbKeyHash256ColBuff> filteredList = new ArrayList<CFBamDbKeyHash256ColBuff>();
		CFBamDbKeyHash256ColBuff[] buffList = readDerivedByCodeVisIdx( Authorization,
			CodeVis );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash256ColBuff[] readBuffByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		...
		CFBamDbKeyHash256ColBuff buff;
		ArrayList<CFBamDbKeyHash256ColBuff> filteredList = new ArrayList<CFBamDbKeyHash256ColBuff>();
		CFBamDbKeyHash256ColBuff[] buffList = readDerivedByScopeCodeVisIdx( Authorization,
			TenantId,
			ScopeId,
			CodeVis );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash256ColBuff[] readBuffByTableIdx( CFSecAuthorization Authorization,
		long TenantId,
		long TableId )
	{
		final String S_ProcName = "CFBamRamDbKeyHash256Col.readBuffByTableIdx() ";
		CFBamDbKeyHash256ColBuff buff;
		ArrayList<CFBamDbKeyHash256ColBuff> filteredList = new ArrayList<CFBamDbKeyHash256ColBuff>();
		CFBamDbKeyHash256ColBuff[] buffList = readDerivedByTableIdx( Authorization,
			TenantId,
			TableId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	/**
	 *	Read a page array of the specific DbKeyHash256Col buffer instances identified by the duplicate key TableIdx.
	 *
	 ...
	 */
	public CFBamDbKeyHash256ColBuff[] pageBuffByTableIdx( CFSecAuthorization Authorization,
		long TenantId,
		long TableId,
		Long priorTenantId,
		Long priorId )
	 ...
	 */
	public CFBamDbKeyHash256ColBuff moveBuffUp( CFSecAuthorization Authorization,
		long TenantId,
		long Id,
		int revision )
	{
		...
		{
			return( (CFBamDbKeyHash256ColBuff)cur );
		}
		...
		return( (CFBamDbKeyHash256ColBuff)editCur );
	}
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public CFBamDbKeyHash256ColBuff moveBuffDown( CFSecAuthorization Authorization,
		long TenantId,
		long Id,
		int revision )
	{
	...
	public void updateDbKeyHash256Col( CFSecAuthorization Authorization,
		CFBamDbKeyHash256ColBuff Buff )
	{
		...
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
		CFBamDbKeyHash256ColBuff existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamDbKeyHash256ColByTableIdxKey existingKeyTableIdx = schema.getFactoryDbKeyHash256Col().newTableIdxKey();
		...
		CFBamDbKeyHash256ColByTableIdxKey newKeyTableIdx = schema.getFactoryDbKeyHash256Col().newTableIdxKey();
		...
		Map< CFBamValuePKey, CFBamDbKeyHash256ColBuff > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< CFBamValuePKey, CFBamDbKeyHash256ColBuff >();
	...
	public void deleteDbKeyHash256Col( CFSecAuthorization Authorization,
		CFBamDbKeyHash256ColBuff Buff )
	{
		final String S_ProcName = "CFBamRamDbKeyHash256ColTable.deleteDbKeyHash256Col() ";
		String classCode;
		CFBamValuePKey pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
	...
	public void deleteDbKeyHash256ColByTableIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argTableId )
	{
		CFBamDbKeyHash256ColByTableIdxKey key = schema.getFactoryDbKeyHash256Col().newTableIdxKey();
		...
		deleteDbKeyHash256ColByTableIdx( Authorization, key );
	}

	public void deleteDbKeyHash256ColByTableIdx( CFSecAuthorization Authorization,
		CFBamDbKeyHash256ColByTableIdxKey argKey )
	{
		CFBamDbKeyHash256ColBuff cur;
		...
		LinkedList<CFBamDbKeyHash256ColBuff> matchSet = new LinkedList<CFBamDbKeyHash256ColBuff>();
		Iterator<CFBamDbKeyHash256ColBuff> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamDbKeyHash256ColBuff> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = schema.getTableDbKeyHash256Col().readDerivedByIdIdx( Authorization,
				cur.getRequiredTenantId(),
				cur.getRequiredId() );
			deleteDbKeyHash256Col( Authorization, cur );
		}
	}

	public void deleteDbKeyHash256ColByIdIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argId )
	{
		CFBamValuePKey key = schema.getFactoryValue().newPKey();
		...
		deleteDbKeyHash256ColByIdIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash256ColByUNameIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		String argName )
	{
		...
		deleteDbKeyHash256ColByUNameIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash256ColByValTentIdx( CFSecAuthorization Authorization,
		long argTenantId )
	{
		CFBamValueByValTentIdxKey key = schema.getFactoryValue().newValTentIdxKey();
		key.setRequiredTenantId( argTenantId );
		deleteDbKeyHash256ColByValTentIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash256ColByScopeIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId )
	{
		...
		key.setRequiredTenantId( argTenantId );
		key.setRequiredScopeId( argScopeId );
		deleteDbKeyHash256ColByScopeIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash256ColByDefSchemaIdx( CFSecAuthorization Authorization,
		...
		Long argDefSchemaId )
	{
		...
		deleteDbKeyHash256ColByDefSchemaIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash256ColByPrevIdx( CFSecAuthorization Authorization,
		...
		Long argPrevId )
	{
		...
		deleteDbKeyHash256ColByPrevIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash256ColByNextIdx( CFSecAuthorization Authorization,
		...
		Long argNextId )
	{
		...
		deleteDbKeyHash256ColByNextIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash256ColByContPrevIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		Long argPrevId )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setOptionalPrevId( argPrevId );
		deleteDbKeyHash256ColByContPrevIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash256ColByContNextIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		Long argNextId )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setOptionalNextId( argNextId );
		deleteDbKeyHash256ColByContNextIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash256ColByCodeVisIdx( CFSecAuthorization Authorization,
		ICFBamSchema.CodeVisibilityEnum argCodeVis )
	{
		...
		deleteDbKeyHash256ColByCodeVisIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash256ColByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		ICFBamSchema.CodeVisibilityEnum argCodeVis )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setRequiredCodeVis( argCodeVis );
		deleteDbKeyHash256ColByScopeCodeVisIdx( Authorization, key );
	}
