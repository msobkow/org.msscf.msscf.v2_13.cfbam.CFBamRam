	...
	implements ICFBamDoubleColTable
{
		...
		CFBamDoubleColBuff Buff )
	{
		...
		if( Buff.getClassCode().equals( "a871" ) ) {
	...
	public CFBamDoubleColBuff[] readDerivedByCodeVisIdx( CFSecAuthorization Authorization,
	...
	public CFBamDoubleColBuff[] readDerivedByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		...
		CFBamValuePKey PKey )
	{
		...
		if( ( buff != null ) && ( ! buff.getClassCode().equals( "a871" ) ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	public CFBamDoubleColBuff[] readBuffByCodeVisIdx( CFSecAuthorization Authorization,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByCodeVisIdx() ";
		CFBamDoubleColBuff buff;
		ArrayList<CFBamDoubleColBuff> filteredList = new ArrayList<CFBamDoubleColBuff>();
		CFBamDoubleColBuff[] buffList = readDerivedByCodeVisIdx( Authorization,
			CodeVis );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDoubleColBuff[] readBuffByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		...
		CFBamDoubleColBuff buff;
		ArrayList<CFBamDoubleColBuff> filteredList = new ArrayList<CFBamDoubleColBuff>();
		CFBamDoubleColBuff[] buffList = readDerivedByScopeCodeVisIdx( Authorization,
			TenantId,
			ScopeId,
			CodeVis );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public void deleteDoubleColByCodeVisIdx( CFSecAuthorization Authorization,
		ICFBamSchema.CodeVisibilityEnum argCodeVis )
	{
		...
		deleteDoubleColByCodeVisIdx( Authorization, key );
	}
	...
	public void deleteDoubleColByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		ICFBamSchema.CodeVisibilityEnum argCodeVis )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setRequiredCodeVis( argCodeVis );
		deleteDoubleColByScopeCodeVisIdx( Authorization, key );
	}
