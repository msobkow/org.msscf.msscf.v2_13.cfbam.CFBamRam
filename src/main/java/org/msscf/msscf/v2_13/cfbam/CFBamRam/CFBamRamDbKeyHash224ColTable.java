...
// Description: Java 11 in-memory RAM DbIO implementation for DbKeyHash224Col.
...
/*
 *	CFBamRamDbKeyHash224ColTable in-memory RAM DbIO implementation
 *	for DbKeyHash224Col.
 */
public class CFBamRamDbKeyHash224ColTable
	implements ICFBamDbKeyHash224ColTable
{
	private ICFBamSchema schema;
	private Map< CFBamValuePKey,
				CFBamDbKeyHash224ColBuff > dictByPKey
		= new HashMap< CFBamValuePKey,
				CFBamDbKeyHash224ColBuff >();
	private Map< CFBamDbKeyHash224ColByTableIdxKey,
				Map< CFBamValuePKey,
					CFBamDbKeyHash224ColBuff >> dictByTableIdx
		= new HashMap< CFBamDbKeyHash224ColByTableIdxKey,
				Map< CFBamValuePKey,
					CFBamDbKeyHash224ColBuff >>();

	public CFBamRamDbKeyHash224ColTable( ICFBamSchema argSchema ) {
		schema = argSchema;
	}

	public void createDbKeyHash224Col( CFSecAuthorization Authorization,
		CFBamDbKeyHash224ColBuff Buff )
	{
		final String S_ProcName = "createDbKeyHash224Col";
		CFBamValueBuff tail = null;
		if( Buff.getClassCode().equals( "a844" ) ) {
		...
		schema.getTableDbKeyHash224Def().createDbKeyHash224Def( Authorization,
			Buff );
		CFBamValuePKey pkey = schema.getFactoryValue().newPKey();
		pkey.setClassCode( Buff.getClassCode() );
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
		CFBamDbKeyHash224ColByTableIdxKey keyTableIdx = schema.getFactoryDbKeyHash224Col().newTableIdxKey();
...

		{
			...
			allNull = false;
			if( ! allNull ) {
				if( null == schema.getTableDbKeyHash224Def().readDerivedByIdIdx( Authorization,
						Buff.getRequiredTenantId(),
						Buff.getRequiredId() ) )
				{
		...
		Map< CFBamValuePKey, CFBamDbKeyHash224ColBuff > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< CFBamValuePKey, CFBamDbKeyHash224ColBuff >();
	...
	public CFBamDbKeyHash224ColBuff readDerived( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash224Col.readDerived";
	...
	public CFBamDbKeyHash224ColBuff lockDerived( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash224Col.readDerived";
		CFBamValuePKey key = schema.getFactoryValue().newPKey();
	...
	public CFBamDbKeyHash224ColBuff[] readAllDerived( CFSecAuthorization Authorization ) {
		final String S_ProcName = "CFBamRamDbKeyHash224Col.readAllDerived";
		CFBamDbKeyHash224ColBuff[] retList = new CFBamDbKeyHash224ColBuff[ dictByPKey.values().size() ];
		Iterator< CFBamDbKeyHash224ColBuff > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
	...
	public CFBamDbKeyHash224ColBuff readDerivedByUNameIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		String Name )
	{
		...
		else if( buff instanceof CFBamDbKeyHash224ColBuff ) {
			return( (CFBamDbKeyHash224ColBuff)buff );
		}
		else {
			return( null );
		}
	...
	public CFBamDbKeyHash224ColBuff[] readDerivedByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		...
		if( buffList == null ) {
			...
			CFBamValueBuff buff;
			ArrayList<CFBamDbKeyHash224ColBuff> filteredList = new ArrayList<CFBamDbKeyHash224ColBuff>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof CFBamDbKeyHash224ColBuff ) ) {
					filteredList.add( (CFBamDbKeyHash224ColBuff)buff );
				}
			}
			return( filteredList.toArray( new CFBamDbKeyHash224ColBuff[0] ) );
		}
	}

	public CFBamDbKeyHash224ColBuff[] readDerivedByScopeIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId )
	{
	...
	public CFBamDbKeyHash224ColBuff[] readDerivedByDefSchemaIdx( CFSecAuthorization Authorization,
	...
	public CFBamDbKeyHash224ColBuff[] readDerivedByPrevIdx( CFSecAuthorization Authorization,
		Long PrevTenantId,
		Long PrevId )
	{
	...
	public CFBamDbKeyHash224ColBuff[] readDerivedByNextIdx( CFSecAuthorization Authorization,
		Long NextTenantId,
		Long NextId )
	{
	...
	public CFBamDbKeyHash224ColBuff[] readDerivedByContPrevIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long PrevId )
	{
	...
	public CFBamDbKeyHash224ColBuff[] readDerivedByContNextIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long NextId )
	{
	...
	public CFBamDbKeyHash224ColBuff[] readDerivedByCodeVisIdx( CFSecAuthorization Authorization,
	...
	public CFBamDbKeyHash224ColBuff[] readDerivedByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
	...
	public CFBamDbKeyHash224ColBuff[] readDerivedByTableIdx( CFSecAuthorization Authorization,
		long TenantId,
		long TableId )
	{
		final String S_ProcName = "CFBamRamDbKeyHash224Col.readDerivedByTableIdx";
		CFBamDbKeyHash224ColByTableIdxKey key = schema.getFactoryDbKeyHash224Col().newTableIdxKey();
		key.setRequiredTenantId( TenantId );
		key.setRequiredTableId( TableId );

		CFBamDbKeyHash224ColBuff[] recArray;
		if( dictByTableIdx.containsKey( key ) ) {
			Map< CFBamValuePKey, CFBamDbKeyHash224ColBuff > subdictTableIdx
				= dictByTableIdx.get( key );
			recArray = new CFBamDbKeyHash224ColBuff[ subdictTableIdx.size() ];
			Iterator< CFBamDbKeyHash224ColBuff > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< CFBamValuePKey, CFBamDbKeyHash224ColBuff > subdictTableIdx
				= new HashMap< CFBamValuePKey, CFBamDbKeyHash224ColBuff >();
			dictByTableIdx.put( key, subdictTableIdx );
			recArray = new CFBamDbKeyHash224ColBuff[0];
		}
		return( recArray );
	}

	public CFBamDbKeyHash224ColBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		long TenantId,
		long Id )
	{
	...
	public CFBamDbKeyHash224ColBuff readBuff( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash224Col.readBuff";
		CFBamDbKeyHash224ColBuff buff = readDerived( Authorization, PKey );
		if( ( buff != null ) && ( ! buff.getClassCode().equals( "a844" ) ) ) {
			buff = null;
		}
		return( buff );
	}

	public CFBamDbKeyHash224ColBuff lockBuff( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
	...
	public CFBamDbKeyHash224ColBuff[] readAllBuff( CFSecAuthorization Authorization )
	{
		final String S_ProcName = "CFBamRamDbKeyHash224Col.readAllBuff";
		CFBamDbKeyHash224ColBuff buff;
		ArrayList<CFBamDbKeyHash224ColBuff> filteredList = new ArrayList<CFBamDbKeyHash224ColBuff>();
		CFBamDbKeyHash224ColBuff[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a844" ) ) {
	...
	public CFBamDbKeyHash224ColBuff readBuffByIdIdx( CFSecAuthorization Authorization,
		long TenantId,
		long Id )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByIdIdx() ";
		CFBamDbKeyHash224ColBuff buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
	...
	public CFBamDbKeyHash224ColBuff readBuffByUNameIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		String Name )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByUNameIdx() ";
		CFBamDbKeyHash224ColBuff buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash224ColBuff[] readBuffByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByValTentIdx() ";
		CFBamDbKeyHash224ColBuff buff;
		ArrayList<CFBamDbKeyHash224ColBuff> filteredList = new ArrayList<CFBamDbKeyHash224ColBuff>();
		CFBamDbKeyHash224ColBuff[] buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash224ColBuff[] readBuffByScopeIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId )
	{
		...
		CFBamDbKeyHash224ColBuff buff;
		ArrayList<CFBamDbKeyHash224ColBuff> filteredList = new ArrayList<CFBamDbKeyHash224ColBuff>();
		CFBamDbKeyHash224ColBuff[] buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash224ColBuff[] readBuffByDefSchemaIdx( CFSecAuthorization Authorization,
		Long DefSchemaTenantId,
		Long DefSchemaId )
	{
		...
		CFBamDbKeyHash224ColBuff buff;
		ArrayList<CFBamDbKeyHash224ColBuff> filteredList = new ArrayList<CFBamDbKeyHash224ColBuff>();
		CFBamDbKeyHash224ColBuff[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash224ColBuff[] readBuffByPrevIdx( CFSecAuthorization Authorization,
		Long PrevTenantId,
		Long PrevId )
	{
		...
		CFBamDbKeyHash224ColBuff buff;
		ArrayList<CFBamDbKeyHash224ColBuff> filteredList = new ArrayList<CFBamDbKeyHash224ColBuff>();
		CFBamDbKeyHash224ColBuff[] buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash224ColBuff[] readBuffByNextIdx( CFSecAuthorization Authorization,
		Long NextTenantId,
		Long NextId )
	{
		...
		CFBamDbKeyHash224ColBuff buff;
		ArrayList<CFBamDbKeyHash224ColBuff> filteredList = new ArrayList<CFBamDbKeyHash224ColBuff>();
		CFBamDbKeyHash224ColBuff[] buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash224ColBuff[] readBuffByContPrevIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long PrevId )
	{
		...
		CFBamDbKeyHash224ColBuff buff;
		ArrayList<CFBamDbKeyHash224ColBuff> filteredList = new ArrayList<CFBamDbKeyHash224ColBuff>();
		CFBamDbKeyHash224ColBuff[] buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash224ColBuff[] readBuffByContNextIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long NextId )
	{
		...
		CFBamDbKeyHash224ColBuff buff;
		ArrayList<CFBamDbKeyHash224ColBuff> filteredList = new ArrayList<CFBamDbKeyHash224ColBuff>();
		CFBamDbKeyHash224ColBuff[] buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash224ColBuff[] readBuffByCodeVisIdx( CFSecAuthorization Authorization,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByCodeVisIdx() ";
		CFBamDbKeyHash224ColBuff buff;
		ArrayList<CFBamDbKeyHash224ColBuff> filteredList = new ArrayList<CFBamDbKeyHash224ColBuff>();
		CFBamDbKeyHash224ColBuff[] buffList = readDerivedByCodeVisIdx( Authorization,
			CodeVis );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash224ColBuff[] readBuffByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		...
		CFBamDbKeyHash224ColBuff buff;
		ArrayList<CFBamDbKeyHash224ColBuff> filteredList = new ArrayList<CFBamDbKeyHash224ColBuff>();
		CFBamDbKeyHash224ColBuff[] buffList = readDerivedByScopeCodeVisIdx( Authorization,
			TenantId,
			ScopeId,
			CodeVis );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash224ColBuff[] readBuffByTableIdx( CFSecAuthorization Authorization,
		long TenantId,
		long TableId )
	{
		final String S_ProcName = "CFBamRamDbKeyHash224Col.readBuffByTableIdx() ";
		CFBamDbKeyHash224ColBuff buff;
		ArrayList<CFBamDbKeyHash224ColBuff> filteredList = new ArrayList<CFBamDbKeyHash224ColBuff>();
		CFBamDbKeyHash224ColBuff[] buffList = readDerivedByTableIdx( Authorization,
			TenantId,
			TableId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	/**
	 *	Read a page array of the specific DbKeyHash224Col buffer instances identified by the duplicate key TableIdx.
	 *
	 ...
	 */
	public CFBamDbKeyHash224ColBuff[] pageBuffByTableIdx( CFSecAuthorization Authorization,
		long TenantId,
		long TableId,
		Long priorTenantId,
		Long priorId )
	 ...
	 */
	public CFBamDbKeyHash224ColBuff moveBuffUp( CFSecAuthorization Authorization,
		long TenantId,
		long Id,
		int revision )
	{
		...
		{
			return( (CFBamDbKeyHash224ColBuff)cur );
		}
		...
		return( (CFBamDbKeyHash224ColBuff)editCur );
	}
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public CFBamDbKeyHash224ColBuff moveBuffDown( CFSecAuthorization Authorization,
		long TenantId,
		long Id,
		int revision )
	{
	...
	public void updateDbKeyHash224Col( CFSecAuthorization Authorization,
		CFBamDbKeyHash224ColBuff Buff )
	{
		schema.getTableDbKeyHash224Def().updateDbKeyHash224Def( Authorization,
			Buff );
		CFBamValuePKey pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
		CFBamDbKeyHash224ColBuff existing = dictByPKey.get( pkey );
		if( existing == null ) {
			throw new CFLibStaleCacheDetectedException( getClass(),
				"updateDbKeyHash224Col",
				"Existing record not found",
				"DbKeyHash224Col",
				pkey );
		}
		CFBamDbKeyHash224ColByTableIdxKey existingKeyTableIdx = schema.getFactoryDbKeyHash224Col().newTableIdxKey();
		...
		CFBamDbKeyHash224ColByTableIdxKey newKeyTableIdx = schema.getFactoryDbKeyHash224Col().newTableIdxKey();
		...
		Map< CFBamValuePKey, CFBamDbKeyHash224ColBuff > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< CFBamValuePKey, CFBamDbKeyHash224ColBuff >();
	...
	public void deleteDbKeyHash224Col( CFSecAuthorization Authorization,
		CFBamDbKeyHash224ColBuff Buff )
	{
		final String S_ProcName = "CFBamRamDbKeyHash224ColTable.deleteDbKeyHash224Col() ";
		String classCode;
		CFBamValuePKey pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
		...
		schema.getTableDbKeyHash224Def().deleteDbKeyHash224Def( Authorization,
			Buff );
	}
	public void deleteDbKeyHash224ColByTableIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argTableId )
	{
		CFBamDbKeyHash224ColByTableIdxKey key = schema.getFactoryDbKeyHash224Col().newTableIdxKey();
		...
		deleteDbKeyHash224ColByTableIdx( Authorization, key );
	}

	public void deleteDbKeyHash224ColByTableIdx( CFSecAuthorization Authorization,
		CFBamDbKeyHash224ColByTableIdxKey argKey )
	{
		CFBamDbKeyHash224ColBuff cur;
		...
		LinkedList<CFBamDbKeyHash224ColBuff> matchSet = new LinkedList<CFBamDbKeyHash224ColBuff>();
		Iterator<CFBamDbKeyHash224ColBuff> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamDbKeyHash224ColBuff> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = schema.getTableDbKeyHash224Col().readDerivedByIdIdx( Authorization,
				cur.getRequiredTenantId(),
				cur.getRequiredId() );
			deleteDbKeyHash224Col( Authorization, cur );
		}
	}

	public void deleteDbKeyHash224ColByIdIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argId )
	{
		CFBamValuePKey key = schema.getFactoryValue().newPKey();
		...
		deleteDbKeyHash224ColByIdIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash224ColByUNameIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		String argName )
	{
		...
		deleteDbKeyHash224ColByUNameIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash224ColByValTentIdx( CFSecAuthorization Authorization,
		long argTenantId )
	{
		CFBamValueByValTentIdxKey key = schema.getFactoryValue().newValTentIdxKey();
		key.setRequiredTenantId( argTenantId );
		deleteDbKeyHash224ColByValTentIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash224ColByScopeIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId )
	{
		...
		key.setRequiredTenantId( argTenantId );
		key.setRequiredScopeId( argScopeId );
		deleteDbKeyHash224ColByScopeIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash224ColByDefSchemaIdx( CFSecAuthorization Authorization,
		...
		Long argDefSchemaId )
	{
		...
		deleteDbKeyHash224ColByDefSchemaIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash224ColByPrevIdx( CFSecAuthorization Authorization,
		...
		Long argPrevId )
	{
		...
		deleteDbKeyHash224ColByPrevIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash224ColByNextIdx( CFSecAuthorization Authorization,
		...
		Long argNextId )
	{
		...
		deleteDbKeyHash224ColByNextIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash224ColByContPrevIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		Long argPrevId )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setOptionalPrevId( argPrevId );
		deleteDbKeyHash224ColByContPrevIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash224ColByContNextIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		Long argNextId )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setOptionalNextId( argNextId );
		deleteDbKeyHash224ColByContNextIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash224ColByCodeVisIdx( CFSecAuthorization Authorization,
		ICFBamSchema.CodeVisibilityEnum argCodeVis )
	{
		...
		deleteDbKeyHash224ColByCodeVisIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash224ColByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		ICFBamSchema.CodeVisibilityEnum argCodeVis )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setRequiredCodeVis( argCodeVis );
		deleteDbKeyHash224ColByScopeCodeVisIdx( Authorization, key );
	}
