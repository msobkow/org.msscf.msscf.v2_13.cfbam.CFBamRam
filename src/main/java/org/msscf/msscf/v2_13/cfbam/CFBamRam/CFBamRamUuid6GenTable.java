...
// Description: Java 11 in-memory RAM DbIO implementation for Uuid6Gen.
...
/*
 *	CFBamRamUuid6GenTable in-memory RAM DbIO implementation
 *	for Uuid6Gen.
 */
public class CFBamRamUuid6GenTable
	implements ICFBamUuid6GenTable
{
	...
	public void createUuid6Gen( CFSecAuthorization Authorization,
		CFBamUuid6GenBuff Buff )
	{
		final String S_ProcName = "createUuid6Gen";
		CFBamValueBuff tail = null;
		if( Buff.getClassCode().equals( "a88c" ) ) {
		...
		schema.getTableUuid6Type().createUuid6Type( Authorization,
			Buff );
...

		{
			...
			allNull = false;
			if( ! allNull ) {
				if( null == schema.getTableUuid6Type().readDerivedByIdIdx( Authorization,
						Buff.getRequiredTenantId(),
						Buff.getRequiredId() ) )
				{
	...
	public CFBamUuid6GenBuff readDerived( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamUuid6Gen.readDerived";
	...
	public CFBamUuid6GenBuff lockDerived( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamUuid6Gen.readDerived";
		CFBamValuePKey key = schema.getFactoryValue().newPKey();
	...
	public CFBamUuid6GenBuff[] readAllDerived( CFSecAuthorization Authorization ) {
		final String S_ProcName = "CFBamRamUuid6Gen.readAllDerived";
		CFBamUuid6GenBuff[] retList = new CFBamUuid6GenBuff[ dictByPKey.values().size() ];
		Iterator< CFBamUuid6GenBuff > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
	...
	public CFBamUuid6GenBuff readDerivedByUNameIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		String Name )
	{
		...
		else if( buff instanceof CFBamUuid6GenBuff ) {
			return( (CFBamUuid6GenBuff)buff );
		}
		else {
			return( null );
		}
	...
	public CFBamUuid6GenBuff[] readDerivedByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		...
		if( buffList == null ) {
			...
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof CFBamUuid6GenBuff ) ) {
	...
	public CFBamUuid6GenBuff[] readDerivedByScopeIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId )
	{
	...
	public CFBamUuid6GenBuff[] readDerivedByDefSchemaIdx( CFSecAuthorization Authorization,
	...
	public CFBamUuid6GenBuff[] readDerivedByPrevIdx( CFSecAuthorization Authorization,
		Long PrevTenantId,
		Long PrevId )
	{
	...
	public CFBamUuid6GenBuff[] readDerivedByNextIdx( CFSecAuthorization Authorization,
		Long NextTenantId,
		Long NextId )
	{
	...
	public CFBamUuid6GenBuff[] readDerivedByContPrevIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long PrevId )
	{
	...
	public CFBamUuid6GenBuff[] readDerivedByContNextIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long NextId )
	{
	...
	public CFBamUuid6GenBuff[] readDerivedByCodeVisIdx( CFSecAuthorization Authorization,
	...
	public CFBamUuid6GenBuff[] readDerivedByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
	...
	public CFBamUuid6GenBuff[] readDerivedBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId )
	{
		final String S_ProcName = "CFBamRamUuid6Type.readDerivedBySchemaIdx";
		CFBamUuid6TypeBuff buffList[] = schema.getTableUuid6Type().readDerivedBySchemaIdx( Authorization,
			TenantId,
			SchemaDefId );
		if( buffList == null ) {
			return( null );
	...
	public CFBamUuid6GenBuff readBuff( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamUuid6Gen.readBuff";
		CFBamUuid6GenBuff buff = readDerived( Authorization, PKey );
	...
	public CFBamUuid6GenBuff lockBuff( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
	...
	public CFBamUuid6GenBuff[] readAllBuff( CFSecAuthorization Authorization )
	{
		final String S_ProcName = "CFBamRamUuid6Gen.readAllBuff";
		CFBamUuid6GenBuff buff;
		ArrayList<CFBamUuid6GenBuff> filteredList = new ArrayList<CFBamUuid6GenBuff>();
		CFBamUuid6GenBuff[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a88c" ) ) {
	...
	public CFBamUuid6GenBuff readBuffByIdIdx( CFSecAuthorization Authorization,
		long TenantId,
		long Id )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByIdIdx() ";
		CFBamUuid6GenBuff buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
	...
	public CFBamUuid6GenBuff readBuffByUNameIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		String Name )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByUNameIdx() ";
		CFBamUuid6GenBuff buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamUuid6GenBuff[] readBuffByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByValTentIdx() ";
		CFBamUuid6GenBuff buff;
		ArrayList<CFBamUuid6GenBuff> filteredList = new ArrayList<CFBamUuid6GenBuff>();
		CFBamUuid6GenBuff[] buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamUuid6GenBuff[] readBuffByScopeIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId )
	{
		...
		CFBamUuid6GenBuff buff;
		ArrayList<CFBamUuid6GenBuff> filteredList = new ArrayList<CFBamUuid6GenBuff>();
		CFBamUuid6GenBuff[] buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamUuid6GenBuff[] readBuffByDefSchemaIdx( CFSecAuthorization Authorization,
		Long DefSchemaTenantId,
		Long DefSchemaId )
	{
		...
		CFBamUuid6GenBuff buff;
		ArrayList<CFBamUuid6GenBuff> filteredList = new ArrayList<CFBamUuid6GenBuff>();
		CFBamUuid6GenBuff[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamUuid6GenBuff[] readBuffByPrevIdx( CFSecAuthorization Authorization,
		Long PrevTenantId,
		Long PrevId )
	{
		...
		CFBamUuid6GenBuff buff;
		ArrayList<CFBamUuid6GenBuff> filteredList = new ArrayList<CFBamUuid6GenBuff>();
		CFBamUuid6GenBuff[] buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamUuid6GenBuff[] readBuffByNextIdx( CFSecAuthorization Authorization,
		Long NextTenantId,
		Long NextId )
	{
		...
		CFBamUuid6GenBuff buff;
		ArrayList<CFBamUuid6GenBuff> filteredList = new ArrayList<CFBamUuid6GenBuff>();
		CFBamUuid6GenBuff[] buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamUuid6GenBuff[] readBuffByContPrevIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long PrevId )
	{
		...
		CFBamUuid6GenBuff buff;
		ArrayList<CFBamUuid6GenBuff> filteredList = new ArrayList<CFBamUuid6GenBuff>();
		CFBamUuid6GenBuff[] buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamUuid6GenBuff[] readBuffByContNextIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long NextId )
	{
		...
		CFBamUuid6GenBuff buff;
		ArrayList<CFBamUuid6GenBuff> filteredList = new ArrayList<CFBamUuid6GenBuff>();
		CFBamUuid6GenBuff[] buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamUuid6GenBuff[] readBuffByCodeVisIdx( CFSecAuthorization Authorization,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByCodeVisIdx() ";
		CFBamUuid6GenBuff buff;
		ArrayList<CFBamUuid6GenBuff> filteredList = new ArrayList<CFBamUuid6GenBuff>();
		CFBamUuid6GenBuff[] buffList = readDerivedByCodeVisIdx( Authorization,
			CodeVis );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamUuid6GenBuff[] readBuffByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		...
		CFBamUuid6GenBuff buff;
		ArrayList<CFBamUuid6GenBuff> filteredList = new ArrayList<CFBamUuid6GenBuff>();
		CFBamUuid6GenBuff[] buffList = readDerivedByScopeCodeVisIdx( Authorization,
			TenantId,
			ScopeId,
			CodeVis );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamUuid6GenBuff[] readBuffBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId )
	{
		...
		CFBamUuid6GenBuff buff;
		ArrayList<CFBamUuid6GenBuff> filteredList = new ArrayList<CFBamUuid6GenBuff>();
		CFBamUuid6GenBuff[] buffList = readDerivedBySchemaIdx( Authorization,
			TenantId,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	 ...
	 */
	public CFBamUuid6GenBuff[] pageBuffBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId,
		Long priorTenantId,
		Long priorId )
	 ...
	 */
	public CFBamUuid6GenBuff moveBuffUp( CFSecAuthorization Authorization,
		long TenantId,
		long Id,
		int revision )
	{
		...
		return( (CFBamUuid6GenBuff)editCur );
	}
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public CFBamUuid6GenBuff moveBuffDown( CFSecAuthorization Authorization,
		long TenantId,
		long Id,
		int revision )
	{
	...
	public void updateUuid6Gen( CFSecAuthorization Authorization,
		CFBamUuid6GenBuff Buff )
	{
		schema.getTableUuid6Type().updateUuid6Type( Authorization,
			Buff );
		CFBamValuePKey pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
		CFBamUuid6GenBuff existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		Map< CFBamValuePKey, CFBamUuid6GenBuff > subdict;
	...
	public void deleteUuid6Gen( CFSecAuthorization Authorization,
		CFBamUuid6GenBuff Buff )
	{
		final String S_ProcName = "CFBamRamUuid6GenTable.deleteUuid6Gen() ";
		String classCode;
		CFBamValuePKey pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
		...
		long argSchemaDefId )
	{
		...
		deleteUuid6GenBySchemaIdx( Authorization, key );
	}
	...
	public void deleteUuid6GenByIdIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argId )
	{
		CFBamValuePKey key = schema.getFactoryValue().newPKey();
		...
		deleteUuid6GenByIdIdx( Authorization, key );
	}
	...
	public void deleteUuid6GenByUNameIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		String argName )
	{
		...
		deleteUuid6GenByUNameIdx( Authorization, key );
	}
	...
	public void deleteUuid6GenByValTentIdx( CFSecAuthorization Authorization,
		long argTenantId )
	{
		CFBamValueByValTentIdxKey key = schema.getFactoryValue().newValTentIdxKey();
		key.setRequiredTenantId( argTenantId );
		deleteUuid6GenByValTentIdx( Authorization, key );
	}
	...
	public void deleteUuid6GenByScopeIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId )
	{
		...
		key.setRequiredTenantId( argTenantId );
		key.setRequiredScopeId( argScopeId );
		deleteUuid6GenByScopeIdx( Authorization, key );
	}
	...
	public void deleteUuid6GenByDefSchemaIdx( CFSecAuthorization Authorization,
		...
		Long argDefSchemaId )
	{
		...
		deleteUuid6GenByDefSchemaIdx( Authorization, key );
	}
	...
	public void deleteUuid6GenByPrevIdx( CFSecAuthorization Authorization,
		...
		Long argPrevId )
	{
		...
		deleteUuid6GenByPrevIdx( Authorization, key );
	}
	...
	public void deleteUuid6GenByNextIdx( CFSecAuthorization Authorization,
		...
		Long argNextId )
	{
		...
		deleteUuid6GenByNextIdx( Authorization, key );
	}
	...
	public void deleteUuid6GenByContPrevIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		Long argPrevId )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setOptionalPrevId( argPrevId );
		deleteUuid6GenByContPrevIdx( Authorization, key );
	}
	...
	public void deleteUuid6GenByContNextIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		Long argNextId )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setOptionalNextId( argNextId );
		deleteUuid6GenByContNextIdx( Authorization, key );
	}
	...
	public void deleteUuid6GenByCodeVisIdx( CFSecAuthorization Authorization,
		ICFBamSchema.CodeVisibilityEnum argCodeVis )
	{
		...
		deleteUuid6GenByCodeVisIdx( Authorization, key );
	}
	...
	public void deleteUuid6GenByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		ICFBamSchema.CodeVisibilityEnum argCodeVis )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setRequiredCodeVis( argCodeVis );
		deleteUuid6GenByScopeCodeVisIdx( Authorization, key );
	}
