...
// Description: Java 11 in-memory RAM DbIO implementation for Uuid6Type.
...
/*
 *	CFBamRamUuid6TypeTable in-memory RAM DbIO implementation
 *	for Uuid6Type.
 */
public class CFBamRamUuid6TypeTable
	implements ICFBamUuid6TypeTable
{
	private ICFBamSchema schema;
	private Map< CFBamValuePKey,
				CFBamUuid6TypeBuff > dictByPKey
		= new HashMap< CFBamValuePKey,
				CFBamUuid6TypeBuff >();
	private Map< CFBamUuid6TypeBySchemaIdxKey,
				Map< CFBamValuePKey,
					CFBamUuid6TypeBuff >> dictBySchemaIdx
		= new HashMap< CFBamUuid6TypeBySchemaIdxKey,
				Map< CFBamValuePKey,
					CFBamUuid6TypeBuff >>();

	public CFBamRamUuid6TypeTable( ICFBamSchema argSchema ) {
		schema = argSchema;
	}

	public void createUuid6Type( CFSecAuthorization Authorization,
		CFBamUuid6TypeBuff Buff )
	{
		...
		schema.getTableUuid6Def().createUuid6Def( Authorization,
			Buff );
		CFBamValuePKey pkey = schema.getFactoryValue().newPKey();
		pkey.setClassCode( Buff.getClassCode() );
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
		CFBamUuid6TypeBySchemaIdxKey keySchemaIdx = schema.getFactoryUuid6Type().newSchemaIdxKey();
		...
		Map< CFBamValuePKey, CFBamUuid6TypeBuff > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< CFBamValuePKey, CFBamUuid6TypeBuff >();
	...
	public CFBamUuid6TypeBuff readDerived( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamUuid6Type.readDerived";
	...
	public CFBamUuid6TypeBuff lockDerived( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamUuid6Type.readDerived";
		CFBamValuePKey key = schema.getFactoryValue().newPKey();
	...
	public CFBamUuid6TypeBuff[] readAllDerived( CFSecAuthorization Authorization ) {
		final String S_ProcName = "CFBamRamUuid6Type.readAllDerived";
		CFBamUuid6TypeBuff[] retList = new CFBamUuid6TypeBuff[ dictByPKey.values().size() ];
		Iterator< CFBamUuid6TypeBuff > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
	...
	public CFBamUuid6TypeBuff readDerivedByUNameIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		String Name )
	{
		...
		else if( buff instanceof CFBamUuid6TypeBuff ) {
			return( (CFBamUuid6TypeBuff)buff );
		}
		else {
			return( null );
		}
	...
	public CFBamUuid6TypeBuff[] readDerivedByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		...
		if( buffList == null ) {
			...
			CFBamValueBuff buff;
			ArrayList<CFBamUuid6TypeBuff> filteredList = new ArrayList<CFBamUuid6TypeBuff>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof CFBamUuid6TypeBuff ) ) {
					filteredList.add( (CFBamUuid6TypeBuff)buff );
				}
			}
			return( filteredList.toArray( new CFBamUuid6TypeBuff[0] ) );
		}
	}

	public CFBamUuid6TypeBuff[] readDerivedByScopeIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId )
	{
	...
	public CFBamUuid6TypeBuff[] readDerivedByDefSchemaIdx( CFSecAuthorization Authorization,
	...
	public CFBamUuid6TypeBuff[] readDerivedByPrevIdx( CFSecAuthorization Authorization,
		Long PrevTenantId,
		Long PrevId )
	{
	...
	public CFBamUuid6TypeBuff[] readDerivedByNextIdx( CFSecAuthorization Authorization,
		Long NextTenantId,
		Long NextId )
	{
	...
	public CFBamUuid6TypeBuff[] readDerivedByContPrevIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long PrevId )
	{
	...
	public CFBamUuid6TypeBuff[] readDerivedByContNextIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long NextId )
	{
	...
	public CFBamUuid6TypeBuff[] readDerivedByCodeVisIdx( CFSecAuthorization Authorization,
	...
	public CFBamUuid6TypeBuff[] readDerivedByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
	...
	public CFBamUuid6TypeBuff[] readDerivedBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId )
	{
		final String S_ProcName = "CFBamRamUuid6Type.readDerivedBySchemaIdx";
		CFBamUuid6TypeBySchemaIdxKey key = schema.getFactoryUuid6Type().newSchemaIdxKey();
		key.setRequiredTenantId( TenantId );
		key.setRequiredSchemaDefId( SchemaDefId );

		CFBamUuid6TypeBuff[] recArray;
		if( dictBySchemaIdx.containsKey( key ) ) {
			Map< CFBamValuePKey, CFBamUuid6TypeBuff > subdictSchemaIdx
				= dictBySchemaIdx.get( key );
			recArray = new CFBamUuid6TypeBuff[ subdictSchemaIdx.size() ];
			Iterator< CFBamUuid6TypeBuff > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< CFBamValuePKey, CFBamUuid6TypeBuff > subdictSchemaIdx
				= new HashMap< CFBamValuePKey, CFBamUuid6TypeBuff >();
			dictBySchemaIdx.put( key, subdictSchemaIdx );
			recArray = new CFBamUuid6TypeBuff[0];
		}
		return( recArray );
	}

	public CFBamUuid6TypeBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		long TenantId,
		long Id )
	{
	...
	public CFBamUuid6TypeBuff readBuff( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamUuid6Type.readBuff";
		CFBamUuid6TypeBuff buff = readDerived( Authorization, PKey );
	...
	public CFBamUuid6TypeBuff lockBuff( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
	...
	public CFBamUuid6TypeBuff[] readAllBuff( CFSecAuthorization Authorization )
	{
		final String S_ProcName = "CFBamRamUuid6Type.readAllBuff";
		CFBamUuid6TypeBuff buff;
		ArrayList<CFBamUuid6TypeBuff> filteredList = new ArrayList<CFBamUuid6TypeBuff>();
		CFBamUuid6TypeBuff[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a86d" ) ) {
	...
	public CFBamUuid6TypeBuff readBuffByIdIdx( CFSecAuthorization Authorization,
		long TenantId,
		long Id )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByIdIdx() ";
		CFBamUuid6TypeBuff buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
	...
	public CFBamUuid6TypeBuff readBuffByUNameIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		String Name )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByUNameIdx() ";
		CFBamUuid6TypeBuff buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamUuid6TypeBuff[] readBuffByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByValTentIdx() ";
		CFBamUuid6TypeBuff buff;
		ArrayList<CFBamUuid6TypeBuff> filteredList = new ArrayList<CFBamUuid6TypeBuff>();
		CFBamUuid6TypeBuff[] buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamUuid6TypeBuff[] readBuffByScopeIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId )
	{
		...
		CFBamUuid6TypeBuff buff;
		ArrayList<CFBamUuid6TypeBuff> filteredList = new ArrayList<CFBamUuid6TypeBuff>();
		CFBamUuid6TypeBuff[] buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamUuid6TypeBuff[] readBuffByDefSchemaIdx( CFSecAuthorization Authorization,
		Long DefSchemaTenantId,
		Long DefSchemaId )
	{
		...
		CFBamUuid6TypeBuff buff;
		ArrayList<CFBamUuid6TypeBuff> filteredList = new ArrayList<CFBamUuid6TypeBuff>();
		CFBamUuid6TypeBuff[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamUuid6TypeBuff[] readBuffByPrevIdx( CFSecAuthorization Authorization,
		Long PrevTenantId,
		Long PrevId )
	{
		...
		CFBamUuid6TypeBuff buff;
		ArrayList<CFBamUuid6TypeBuff> filteredList = new ArrayList<CFBamUuid6TypeBuff>();
		CFBamUuid6TypeBuff[] buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamUuid6TypeBuff[] readBuffByNextIdx( CFSecAuthorization Authorization,
		Long NextTenantId,
		Long NextId )
	{
		...
		CFBamUuid6TypeBuff buff;
		ArrayList<CFBamUuid6TypeBuff> filteredList = new ArrayList<CFBamUuid6TypeBuff>();
		CFBamUuid6TypeBuff[] buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamUuid6TypeBuff[] readBuffByContPrevIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long PrevId )
	{
		...
		CFBamUuid6TypeBuff buff;
		ArrayList<CFBamUuid6TypeBuff> filteredList = new ArrayList<CFBamUuid6TypeBuff>();
		CFBamUuid6TypeBuff[] buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamUuid6TypeBuff[] readBuffByContNextIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long NextId )
	{
		...
		CFBamUuid6TypeBuff buff;
		ArrayList<CFBamUuid6TypeBuff> filteredList = new ArrayList<CFBamUuid6TypeBuff>();
		CFBamUuid6TypeBuff[] buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamUuid6TypeBuff[] readBuffByCodeVisIdx( CFSecAuthorization Authorization,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByCodeVisIdx() ";
		CFBamUuid6TypeBuff buff;
		ArrayList<CFBamUuid6TypeBuff> filteredList = new ArrayList<CFBamUuid6TypeBuff>();
		CFBamUuid6TypeBuff[] buffList = readDerivedByCodeVisIdx( Authorization,
			CodeVis );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamUuid6TypeBuff[] readBuffByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		...
		CFBamUuid6TypeBuff buff;
		ArrayList<CFBamUuid6TypeBuff> filteredList = new ArrayList<CFBamUuid6TypeBuff>();
		CFBamUuid6TypeBuff[] buffList = readDerivedByScopeCodeVisIdx( Authorization,
			TenantId,
			ScopeId,
			CodeVis );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamUuid6TypeBuff[] readBuffBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId )
	{
		final String S_ProcName = "CFBamRamUuid6Type.readBuffBySchemaIdx() ";
		CFBamUuid6TypeBuff buff;
		ArrayList<CFBamUuid6TypeBuff> filteredList = new ArrayList<CFBamUuid6TypeBuff>();
		CFBamUuid6TypeBuff[] buffList = readDerivedBySchemaIdx( Authorization,
			TenantId,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	/**
	 *	Read a page array of the specific Uuid6Type buffer instances identified by the duplicate key SchemaIdx.
	 *
	 ...
	 */
	public CFBamUuid6TypeBuff[] pageBuffBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId,
		Long priorTenantId,
		Long priorId )
	 ...
	 */
	public CFBamUuid6TypeBuff moveBuffUp( CFSecAuthorization Authorization,
		long TenantId,
		long Id,
		int revision )
	{
		...
		return( (CFBamUuid6TypeBuff)editCur );
	}
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public CFBamUuid6TypeBuff moveBuffDown( CFSecAuthorization Authorization,
		long TenantId,
		long Id,
		int revision )
	{
	...
	public void updateUuid6Type( CFSecAuthorization Authorization,
		CFBamUuid6TypeBuff Buff )
	{
		schema.getTableUuid6Def().updateUuid6Def( Authorization,
			Buff );
		CFBamValuePKey pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
		CFBamUuid6TypeBuff existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamUuid6TypeBySchemaIdxKey existingKeySchemaIdx = schema.getFactoryUuid6Type().newSchemaIdxKey();
		...
		CFBamUuid6TypeBySchemaIdxKey newKeySchemaIdx = schema.getFactoryUuid6Type().newSchemaIdxKey();
		...
		Map< CFBamValuePKey, CFBamUuid6TypeBuff > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< CFBamValuePKey, CFBamUuid6TypeBuff >();
	...
	public void deleteUuid6Type( CFSecAuthorization Authorization,
		CFBamUuid6TypeBuff Buff )
	{
		final String S_ProcName = "CFBamRamUuid6TypeTable.deleteUuid6Type() ";
		String classCode;
		CFBamValuePKey pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
		...
		if( schema.getTableUuid6Gen().readDerivedByIdIdx( Authorization,
					existing.getRequiredTenantId(),
	...
	public void deleteUuid6TypeBySchemaIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argSchemaDefId )
	{
		CFBamUuid6TypeBySchemaIdxKey key = schema.getFactoryUuid6Type().newSchemaIdxKey();
		...
		deleteUuid6TypeBySchemaIdx( Authorization, key );
	}
		...
		CFBamUuid6TypeBySchemaIdxKey argKey )
	{
		...
		LinkedList<CFBamUuid6TypeBuff> matchSet = new LinkedList<CFBamUuid6TypeBuff>();
		Iterator<CFBamUuid6TypeBuff> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamUuid6TypeBuff> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = schema.getTableUuid6Type().readDerivedByIdIdx( Authorization,
				cur.getRequiredTenantId(),
				cur.getRequiredId() );
			String subClassCode = cur.getClassCode();
			if( "a86d".equals( subClassCode ) ) {
				schema.getTableUuid6Type().deleteUuid6Type( Authorization, cur );
			}
				...
				throw new CFLibUnsupportedClassException( getClass(),
					...
					"subClassCode",
					cur,
					"Instance of or subclass of Uuid6Type must not be \"" + subClassCode + "\"" );
			}
		}
	}

	public void deleteUuid6TypeByIdIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argId )
	{
		CFBamValuePKey key = schema.getFactoryValue().newPKey();
		...
		deleteUuid6TypeByIdIdx( Authorization, key );
	}
	...
	public void deleteUuid6TypeByUNameIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		String argName )
	{
		...
		deleteUuid6TypeByUNameIdx( Authorization, key );
	}
	...
	public void deleteUuid6TypeByValTentIdx( CFSecAuthorization Authorization,
		long argTenantId )
	{
		CFBamValueByValTentIdxKey key = schema.getFactoryValue().newValTentIdxKey();
		key.setRequiredTenantId( argTenantId );
		deleteUuid6TypeByValTentIdx( Authorization, key );
	}

	public void deleteUuid6TypeByValTentIdx( CFSecAuthorization Authorization,
		CFBamValueByValTentIdxKey argKey )
	{
		final String S_ProcName = "deleteUuid6TypeByValTentIdx";
		CFBamUuid6TypeBuff cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
	...
	public void deleteUuid6TypeByScopeIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId )
	{
		...
		key.setRequiredTenantId( argTenantId );
		key.setRequiredScopeId( argScopeId );
		deleteUuid6TypeByScopeIdx( Authorization, key );
	}
	...
	public void deleteUuid6TypeByDefSchemaIdx( CFSecAuthorization Authorization,
		...
		Long argDefSchemaId )
	{
		...
		deleteUuid6TypeByDefSchemaIdx( Authorization, key );
	}
	...
	public void deleteUuid6TypeByPrevIdx( CFSecAuthorization Authorization,
		...
		Long argPrevId )
	{
		...
		deleteUuid6TypeByPrevIdx( Authorization, key );
	}
	...
	public void deleteUuid6TypeByNextIdx( CFSecAuthorization Authorization,
		...
		Long argNextId )
	{
		...
		deleteUuid6TypeByNextIdx( Authorization, key );
	}
	...
	public void deleteUuid6TypeByContPrevIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		Long argPrevId )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setOptionalPrevId( argPrevId );
		deleteUuid6TypeByContPrevIdx( Authorization, key );
	}
	...
	public void deleteUuid6TypeByContNextIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		Long argNextId )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setOptionalNextId( argNextId );
		deleteUuid6TypeByContNextIdx( Authorization, key );
	}
	...
	public void deleteUuid6TypeByCodeVisIdx( CFSecAuthorization Authorization,
		ICFBamSchema.CodeVisibilityEnum argCodeVis )
	{
		...
		deleteUuid6TypeByCodeVisIdx( Authorization, key );
	}

	public void deleteUuid6TypeByCodeVisIdx( CFSecAuthorization Authorization,
		CFBamValueByCodeVisIdxKey argKey )
	{
		final String S_ProcName = "deleteUuid6TypeByCodeVisIdx";
		CFBamUuid6TypeBuff cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
	...
	public void deleteUuid6TypeByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		ICFBamSchema.CodeVisibilityEnum argCodeVis )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setRequiredCodeVis( argCodeVis );
		deleteUuid6TypeByScopeCodeVisIdx( Authorization, key );
	}

	public void deleteUuid6TypeByScopeCodeVisIdx( CFSecAuthorization Authorization,
		CFBamValueByScopeCodeVisIdxKey argKey )
	{
		final String S_ProcName = "deleteUuid6TypeByScopeCodeVisIdx";
		CFBamUuid6TypeBuff cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		anyNotNull = true;
