	...
	implements ICFBamTextDefTable
{
	...
	public CFBamTextDefBuff[] readDerivedByCodeVisIdx( CFSecAuthorization Authorization,
	...
	public CFBamTextDefBuff[] readDerivedByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
	...
	public CFBamTextDefBuff[] readBuffByCodeVisIdx( CFSecAuthorization Authorization,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByCodeVisIdx() ";
		CFBamTextDefBuff buff;
		ArrayList<CFBamTextDefBuff> filteredList = new ArrayList<CFBamTextDefBuff>();
		CFBamTextDefBuff[] buffList = readDerivedByCodeVisIdx( Authorization,
			CodeVis );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamTextDefBuff[] readBuffByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		...
		CFBamTextDefBuff buff;
		ArrayList<CFBamTextDefBuff> filteredList = new ArrayList<CFBamTextDefBuff>();
		CFBamTextDefBuff[] buffList = readDerivedByScopeCodeVisIdx( Authorization,
			TenantId,
			ScopeId,
			CodeVis );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public void deleteTextDefByCodeVisIdx( CFSecAuthorization Authorization,
		ICFBamSchema.CodeVisibilityEnum argCodeVis )
	{
		...
		deleteTextDefByCodeVisIdx( Authorization, key );
	}

	public void deleteTextDefByCodeVisIdx( CFSecAuthorization Authorization,
		CFBamValueByCodeVisIdxKey argKey )
	{
		final String S_ProcName = "deleteTextDefByCodeVisIdx";
		CFBamTextDefBuff cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
	...
	public void deleteTextDefByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		ICFBamSchema.CodeVisibilityEnum argCodeVis )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setRequiredCodeVis( argCodeVis );
		deleteTextDefByScopeCodeVisIdx( Authorization, key );
	}

	public void deleteTextDefByScopeCodeVisIdx( CFSecAuthorization Authorization,
		CFBamValueByScopeCodeVisIdxKey argKey )
	{
		final String S_ProcName = "deleteTextDefByScopeCodeVisIdx";
		CFBamTextDefBuff cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		anyNotNull = true;
