...
// Description: Java 11 in-memory RAM DbIO implementation for DbKeyHash128Col.
	...
	implements ICFBamDbKeyHash128ColTable
{
	...
	private Map< CFBamValuePKey,
				CFBamDbKeyHash128ColBuff > dictByPKey
		= new HashMap< CFBamValuePKey,
				CFBamDbKeyHash128ColBuff >();
	private Map< CFBamDbKeyHash128ColByTableIdxKey,
				Map< CFBamValuePKey,
					CFBamDbKeyHash128ColBuff >> dictByTableIdx
		= new HashMap< CFBamDbKeyHash128ColByTableIdxKey,
				Map< CFBamValuePKey,
					CFBamDbKeyHash128ColBuff >>();
	...
	public void createDbKeyHash128Col( CFSecAuthorization Authorization,
		CFBamDbKeyHash128ColBuff Buff )
	{
		...
		CFBamDbKeyHash128ColByTableIdxKey keyTableIdx = schema.getFactoryDbKeyHash128Col().newTableIdxKey();
		...
		Map< CFBamValuePKey, CFBamDbKeyHash128ColBuff > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< CFBamValuePKey, CFBamDbKeyHash128ColBuff >();
	...
	public CFBamDbKeyHash128ColBuff readDerived( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
	...
	public CFBamDbKeyHash128ColBuff lockDerived( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash128Col.readDerived";
		CFBamValuePKey key = schema.getFactoryValue().newPKey();
	...
	public CFBamDbKeyHash128ColBuff[] readAllDerived( CFSecAuthorization Authorization ) {
		final String S_ProcName = "CFBamRamDbKeyHash128Col.readAllDerived";
		CFBamDbKeyHash128ColBuff[] retList = new CFBamDbKeyHash128ColBuff[ dictByPKey.values().size() ];
		Iterator< CFBamDbKeyHash128ColBuff > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
	...
	public CFBamDbKeyHash128ColBuff readDerivedByUNameIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		String Name )
	{
		...
		else if( buff instanceof CFBamDbKeyHash128ColBuff ) {
			return( (CFBamDbKeyHash128ColBuff)buff );
		}
		else {
			return( null );
		}
	...
	public CFBamDbKeyHash128ColBuff[] readDerivedByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		...
		if( buffList == null ) {
			...
			CFBamValueBuff buff;
			ArrayList<CFBamDbKeyHash128ColBuff> filteredList = new ArrayList<CFBamDbKeyHash128ColBuff>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof CFBamDbKeyHash128ColBuff ) ) {
					filteredList.add( (CFBamDbKeyHash128ColBuff)buff );
				}
			}
			return( filteredList.toArray( new CFBamDbKeyHash128ColBuff[0] ) );
		}
	}

	public CFBamDbKeyHash128ColBuff[] readDerivedByScopeIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId )
	{
	...
	public CFBamDbKeyHash128ColBuff[] readDerivedByDefSchemaIdx( CFSecAuthorization Authorization,
	...
	public CFBamDbKeyHash128ColBuff[] readDerivedByPrevIdx( CFSecAuthorization Authorization,
		Long PrevTenantId,
		Long PrevId )
	{
	...
	public CFBamDbKeyHash128ColBuff[] readDerivedByNextIdx( CFSecAuthorization Authorization,
		Long NextTenantId,
		Long NextId )
	{
	...
	public CFBamDbKeyHash128ColBuff[] readDerivedByContPrevIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long PrevId )
	{
	...
	public CFBamDbKeyHash128ColBuff[] readDerivedByContNextIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long NextId )
	{
	...
	public CFBamDbKeyHash128ColBuff[] readDerivedByCodeVisIdx( CFSecAuthorization Authorization,
	...
	public CFBamDbKeyHash128ColBuff[] readDerivedByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
	...
	public CFBamDbKeyHash128ColBuff[] readDerivedByTableIdx( CFSecAuthorization Authorization,
		long TenantId,
		long TableId )
	{
		final String S_ProcName = "CFBamRamDbKeyHash128Col.readDerivedByTableIdx";
		CFBamDbKeyHash128ColByTableIdxKey key = schema.getFactoryDbKeyHash128Col().newTableIdxKey();
		key.setRequiredTenantId( TenantId );
		key.setRequiredTableId( TableId );

		CFBamDbKeyHash128ColBuff[] recArray;
		if( dictByTableIdx.containsKey( key ) ) {
			Map< CFBamValuePKey, CFBamDbKeyHash128ColBuff > subdictTableIdx
				= dictByTableIdx.get( key );
			recArray = new CFBamDbKeyHash128ColBuff[ subdictTableIdx.size() ];
			Iterator< CFBamDbKeyHash128ColBuff > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< CFBamValuePKey, CFBamDbKeyHash128ColBuff > subdictTableIdx
				= new HashMap< CFBamValuePKey, CFBamDbKeyHash128ColBuff >();
			dictByTableIdx.put( key, subdictTableIdx );
			recArray = new CFBamDbKeyHash128ColBuff[0];
		}
		return( recArray );
	}

	public CFBamDbKeyHash128ColBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		long TenantId,
		long Id )
	{
	...
	public CFBamDbKeyHash128ColBuff readBuff( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash128Col.readBuff";
		CFBamDbKeyHash128ColBuff buff = readDerived( Authorization, PKey );
	...
	public CFBamDbKeyHash128ColBuff lockBuff( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
	...
	public CFBamDbKeyHash128ColBuff[] readAllBuff( CFSecAuthorization Authorization )
	{
		final String S_ProcName = "CFBamRamDbKeyHash128Col.readAllBuff";
		CFBamDbKeyHash128ColBuff buff;
		ArrayList<CFBamDbKeyHash128ColBuff> filteredList = new ArrayList<CFBamDbKeyHash128ColBuff>();
		CFBamDbKeyHash128ColBuff[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a83c" ) ) {
	...
	public CFBamDbKeyHash128ColBuff readBuffByIdIdx( CFSecAuthorization Authorization,
		long TenantId,
		long Id )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByIdIdx() ";
		CFBamDbKeyHash128ColBuff buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
	...
	public CFBamDbKeyHash128ColBuff readBuffByUNameIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		String Name )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByUNameIdx() ";
		CFBamDbKeyHash128ColBuff buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash128ColBuff[] readBuffByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByValTentIdx() ";
		CFBamDbKeyHash128ColBuff buff;
		ArrayList<CFBamDbKeyHash128ColBuff> filteredList = new ArrayList<CFBamDbKeyHash128ColBuff>();
		CFBamDbKeyHash128ColBuff[] buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash128ColBuff[] readBuffByScopeIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId )
	{
		...
		CFBamDbKeyHash128ColBuff buff;
		ArrayList<CFBamDbKeyHash128ColBuff> filteredList = new ArrayList<CFBamDbKeyHash128ColBuff>();
		CFBamDbKeyHash128ColBuff[] buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash128ColBuff[] readBuffByDefSchemaIdx( CFSecAuthorization Authorization,
		Long DefSchemaTenantId,
		Long DefSchemaId )
	{
		...
		CFBamDbKeyHash128ColBuff buff;
		ArrayList<CFBamDbKeyHash128ColBuff> filteredList = new ArrayList<CFBamDbKeyHash128ColBuff>();
		CFBamDbKeyHash128ColBuff[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash128ColBuff[] readBuffByPrevIdx( CFSecAuthorization Authorization,
		Long PrevTenantId,
		Long PrevId )
	{
		...
		CFBamDbKeyHash128ColBuff buff;
		ArrayList<CFBamDbKeyHash128ColBuff> filteredList = new ArrayList<CFBamDbKeyHash128ColBuff>();
		CFBamDbKeyHash128ColBuff[] buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash128ColBuff[] readBuffByNextIdx( CFSecAuthorization Authorization,
		Long NextTenantId,
		Long NextId )
	{
		...
		CFBamDbKeyHash128ColBuff buff;
		ArrayList<CFBamDbKeyHash128ColBuff> filteredList = new ArrayList<CFBamDbKeyHash128ColBuff>();
		CFBamDbKeyHash128ColBuff[] buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash128ColBuff[] readBuffByContPrevIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long PrevId )
	{
		...
		CFBamDbKeyHash128ColBuff buff;
		ArrayList<CFBamDbKeyHash128ColBuff> filteredList = new ArrayList<CFBamDbKeyHash128ColBuff>();
		CFBamDbKeyHash128ColBuff[] buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash128ColBuff[] readBuffByContNextIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long NextId )
	{
		...
		CFBamDbKeyHash128ColBuff buff;
		ArrayList<CFBamDbKeyHash128ColBuff> filteredList = new ArrayList<CFBamDbKeyHash128ColBuff>();
		CFBamDbKeyHash128ColBuff[] buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash128ColBuff[] readBuffByCodeVisIdx( CFSecAuthorization Authorization,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByCodeVisIdx() ";
		CFBamDbKeyHash128ColBuff buff;
		ArrayList<CFBamDbKeyHash128ColBuff> filteredList = new ArrayList<CFBamDbKeyHash128ColBuff>();
		CFBamDbKeyHash128ColBuff[] buffList = readDerivedByCodeVisIdx( Authorization,
			CodeVis );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash128ColBuff[] readBuffByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		...
		CFBamDbKeyHash128ColBuff buff;
		ArrayList<CFBamDbKeyHash128ColBuff> filteredList = new ArrayList<CFBamDbKeyHash128ColBuff>();
		CFBamDbKeyHash128ColBuff[] buffList = readDerivedByScopeCodeVisIdx( Authorization,
			TenantId,
			ScopeId,
			CodeVis );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash128ColBuff[] readBuffByTableIdx( CFSecAuthorization Authorization,
		long TenantId,
		long TableId )
	{
		final String S_ProcName = "CFBamRamDbKeyHash128Col.readBuffByTableIdx() ";
		CFBamDbKeyHash128ColBuff buff;
		ArrayList<CFBamDbKeyHash128ColBuff> filteredList = new ArrayList<CFBamDbKeyHash128ColBuff>();
		CFBamDbKeyHash128ColBuff[] buffList = readDerivedByTableIdx( Authorization,
			TenantId,
			TableId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	 ...
	 */
	public CFBamDbKeyHash128ColBuff[] pageBuffByTableIdx( CFSecAuthorization Authorization,
		long TenantId,
		long TableId,
		Long priorTenantId,
		Long priorId )
	 ...
	 */
	public CFBamDbKeyHash128ColBuff moveBuffUp( CFSecAuthorization Authorization,
		long TenantId,
		long Id,
		int revision )
	{
		...
		{
			return( (CFBamDbKeyHash128ColBuff)cur );
		}
		...
		return( (CFBamDbKeyHash128ColBuff)editCur );
	}
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public CFBamDbKeyHash128ColBuff moveBuffDown( CFSecAuthorization Authorization,
		long TenantId,
		long Id,
		int revision )
	{
	...
	public void updateDbKeyHash128Col( CFSecAuthorization Authorization,
		CFBamDbKeyHash128ColBuff Buff )
	{
		...
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
		CFBamDbKeyHash128ColBuff existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamDbKeyHash128ColByTableIdxKey existingKeyTableIdx = schema.getFactoryDbKeyHash128Col().newTableIdxKey();
		...
		CFBamDbKeyHash128ColByTableIdxKey newKeyTableIdx = schema.getFactoryDbKeyHash128Col().newTableIdxKey();
		...
		Map< CFBamValuePKey, CFBamDbKeyHash128ColBuff > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< CFBamValuePKey, CFBamDbKeyHash128ColBuff >();
	...
	public void deleteDbKeyHash128Col( CFSecAuthorization Authorization,
		CFBamDbKeyHash128ColBuff Buff )
	{
	...
	public void deleteDbKeyHash128ColByTableIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argTableId )
	{
		CFBamDbKeyHash128ColByTableIdxKey key = schema.getFactoryDbKeyHash128Col().newTableIdxKey();
		...
		CFBamDbKeyHash128ColByTableIdxKey argKey )
	{
		...
		LinkedList<CFBamDbKeyHash128ColBuff> matchSet = new LinkedList<CFBamDbKeyHash128ColBuff>();
		Iterator<CFBamDbKeyHash128ColBuff> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamDbKeyHash128ColBuff> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = schema.getTableDbKeyHash128Col().readDerivedByIdIdx( Authorization,
	...
	public void deleteDbKeyHash128ColByIdIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argId )
	{
		CFBamValuePKey key = schema.getFactoryValue().newPKey();
		...
		deleteDbKeyHash128ColByIdIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash128ColByUNameIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		String argName )
	{
	...
	public void deleteDbKeyHash128ColByValTentIdx( CFSecAuthorization Authorization,
		long argTenantId )
	{
		CFBamValueByValTentIdxKey key = schema.getFactoryValue().newValTentIdxKey();
		key.setRequiredTenantId( argTenantId );
		deleteDbKeyHash128ColByValTentIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash128ColByScopeIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId )
	{
	...
	public void deleteDbKeyHash128ColByDefSchemaIdx( CFSecAuthorization Authorization,
	...
	public void deleteDbKeyHash128ColByPrevIdx( CFSecAuthorization Authorization,
	...
	public void deleteDbKeyHash128ColByNextIdx( CFSecAuthorization Authorization,
	...
	public void deleteDbKeyHash128ColByContPrevIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		Long argPrevId )
	{
	...
	public void deleteDbKeyHash128ColByContNextIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		Long argNextId )
	{
	...
	public void deleteDbKeyHash128ColByCodeVisIdx( CFSecAuthorization Authorization,
		ICFBamSchema.CodeVisibilityEnum argCodeVis )
	{
		...
		deleteDbKeyHash128ColByCodeVisIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash128ColByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		ICFBamSchema.CodeVisibilityEnum argCodeVis )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setRequiredCodeVis( argCodeVis );
		deleteDbKeyHash128ColByScopeCodeVisIdx( Authorization, key );
	}
