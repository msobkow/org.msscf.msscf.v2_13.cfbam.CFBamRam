...
// Description: Java 11 in-memory RAM DbIO implementation for DbKeyHash224Gen.
...
/*
 *	CFBamRamDbKeyHash224GenTable in-memory RAM DbIO implementation
 *	for DbKeyHash224Gen.
 */
public class CFBamRamDbKeyHash224GenTable
	implements ICFBamDbKeyHash224GenTable
{
	private ICFBamSchema schema;
	private Map< CFBamValuePKey,
				CFBamDbKeyHash224GenBuff > dictByPKey
		= new HashMap< CFBamValuePKey,
				CFBamDbKeyHash224GenBuff >();
	private Map< CFBamDbKeyHash224GenByDispIdxKey,
				Map< CFBamValuePKey,
					CFBamDbKeyHash224GenBuff >> dictByDispIdx
		= new HashMap< CFBamDbKeyHash224GenByDispIdxKey,
				Map< CFBamValuePKey,
					CFBamDbKeyHash224GenBuff >>();

	public CFBamRamDbKeyHash224GenTable( ICFBamSchema argSchema ) {
		schema = argSchema;
	}

	public void createDbKeyHash224Gen( CFSecAuthorization Authorization,
		CFBamDbKeyHash224GenBuff Buff )
	{
		final String S_ProcName = "createDbKeyHash224Gen";
		CFBamValueBuff tail = null;
		if( Buff.getClassCode().equals( "a846" ) ) {
		...
		schema.getTableDbKeyHash224Type().createDbKeyHash224Type( Authorization,
			Buff );
		CFBamValuePKey pkey = schema.getFactoryValue().newPKey();
		pkey.setClassCode( Buff.getClassCode() );
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
		CFBamDbKeyHash224GenByDispIdxKey keyDispIdx = schema.getFactoryDbKeyHash224Gen().newDispIdxKey();
...

		{
			...
			allNull = false;
			if( ! allNull ) {
				if( null == schema.getTableDbKeyHash224Type().readDerivedByIdIdx( Authorization,
						Buff.getRequiredTenantId(),
						Buff.getRequiredId() ) )
				{
		...
		Map< CFBamValuePKey, CFBamDbKeyHash224GenBuff > subdictDispIdx;
		if( dictByDispIdx.containsKey( keyDispIdx ) ) {
			subdictDispIdx = dictByDispIdx.get( keyDispIdx );
		}
		else {
			subdictDispIdx = new HashMap< CFBamValuePKey, CFBamDbKeyHash224GenBuff >();
	...
	public CFBamDbKeyHash224GenBuff readDerived( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash224Gen.readDerived";
	...
	public CFBamDbKeyHash224GenBuff lockDerived( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash224Gen.readDerived";
		CFBamValuePKey key = schema.getFactoryValue().newPKey();
	...
	public CFBamDbKeyHash224GenBuff[] readAllDerived( CFSecAuthorization Authorization ) {
		final String S_ProcName = "CFBamRamDbKeyHash224Gen.readAllDerived";
		CFBamDbKeyHash224GenBuff[] retList = new CFBamDbKeyHash224GenBuff[ dictByPKey.values().size() ];
		Iterator< CFBamDbKeyHash224GenBuff > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
	...
	public CFBamDbKeyHash224GenBuff readDerivedByUNameIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		String Name )
	{
		...
		else if( buff instanceof CFBamDbKeyHash224GenBuff ) {
			return( (CFBamDbKeyHash224GenBuff)buff );
		}
		else {
			return( null );
		}
	...
	public CFBamDbKeyHash224GenBuff[] readDerivedByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		...
		if( buffList == null ) {
			...
			CFBamValueBuff buff;
			ArrayList<CFBamDbKeyHash224GenBuff> filteredList = new ArrayList<CFBamDbKeyHash224GenBuff>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof CFBamDbKeyHash224GenBuff ) ) {
					filteredList.add( (CFBamDbKeyHash224GenBuff)buff );
				}
			}
			return( filteredList.toArray( new CFBamDbKeyHash224GenBuff[0] ) );
		}
	}

	public CFBamDbKeyHash224GenBuff[] readDerivedByScopeIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId )
	{
	...
	public CFBamDbKeyHash224GenBuff[] readDerivedByDefSchemaIdx( CFSecAuthorization Authorization,
	...
	public CFBamDbKeyHash224GenBuff[] readDerivedByPrevIdx( CFSecAuthorization Authorization,
		Long PrevTenantId,
		Long PrevId )
	{
	...
	public CFBamDbKeyHash224GenBuff[] readDerivedByNextIdx( CFSecAuthorization Authorization,
		Long NextTenantId,
		Long NextId )
	{
	...
	public CFBamDbKeyHash224GenBuff[] readDerivedByContPrevIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long PrevId )
	{
	...
	public CFBamDbKeyHash224GenBuff[] readDerivedByContNextIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long NextId )
	{
	...
	public CFBamDbKeyHash224GenBuff[] readDerivedByCodeVisIdx( CFSecAuthorization Authorization,
	...
	public CFBamDbKeyHash224GenBuff[] readDerivedByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
	...
	public CFBamDbKeyHash224GenBuff[] readDerivedBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId )
	{
		final String S_ProcName = "CFBamRamDbKeyHash224Type.readDerivedBySchemaIdx";
		CFBamDbKeyHash224TypeBuff buffList[] = schema.getTableDbKeyHash224Type().readDerivedBySchemaIdx( Authorization,
			TenantId,
			SchemaDefId );
		if( buffList == null ) {
			return( null );
	...
	public CFBamDbKeyHash224GenBuff[] readDerivedByDispIdx( CFSecAuthorization Authorization,
		Long DispenserTenantId,
		Long DispenserId )
	{
		final String S_ProcName = "CFBamRamDbKeyHash224Gen.readDerivedByDispIdx";
		CFBamDbKeyHash224GenByDispIdxKey key = schema.getFactoryDbKeyHash224Gen().newDispIdxKey();
		key.setOptionalDispenserTenantId( DispenserTenantId );
		key.setOptionalDispenserId( DispenserId );

		CFBamDbKeyHash224GenBuff[] recArray;
		if( dictByDispIdx.containsKey( key ) ) {
			Map< CFBamValuePKey, CFBamDbKeyHash224GenBuff > subdictDispIdx
				= dictByDispIdx.get( key );
			recArray = new CFBamDbKeyHash224GenBuff[ subdictDispIdx.size() ];
			Iterator< CFBamDbKeyHash224GenBuff > iter = subdictDispIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< CFBamValuePKey, CFBamDbKeyHash224GenBuff > subdictDispIdx
				= new HashMap< CFBamValuePKey, CFBamDbKeyHash224GenBuff >();
			dictByDispIdx.put( key, subdictDispIdx );
			recArray = new CFBamDbKeyHash224GenBuff[0];
		}
		return( recArray );
	}

	public CFBamDbKeyHash224GenBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		long TenantId,
		long Id )
	{
	...
	public CFBamDbKeyHash224GenBuff readBuff( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash224Gen.readBuff";
		CFBamDbKeyHash224GenBuff buff = readDerived( Authorization, PKey );
	...
	public CFBamDbKeyHash224GenBuff lockBuff( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
	...
	public CFBamDbKeyHash224GenBuff[] readAllBuff( CFSecAuthorization Authorization )
	{
		final String S_ProcName = "CFBamRamDbKeyHash224Gen.readAllBuff";
		CFBamDbKeyHash224GenBuff buff;
		ArrayList<CFBamDbKeyHash224GenBuff> filteredList = new ArrayList<CFBamDbKeyHash224GenBuff>();
		CFBamDbKeyHash224GenBuff[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a846" ) ) {
	...
	public CFBamDbKeyHash224GenBuff readBuffByIdIdx( CFSecAuthorization Authorization,
		long TenantId,
		long Id )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByIdIdx() ";
		CFBamDbKeyHash224GenBuff buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
	...
	public CFBamDbKeyHash224GenBuff readBuffByUNameIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		String Name )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByUNameIdx() ";
		CFBamDbKeyHash224GenBuff buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash224GenBuff[] readBuffByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByValTentIdx() ";
		CFBamDbKeyHash224GenBuff buff;
		ArrayList<CFBamDbKeyHash224GenBuff> filteredList = new ArrayList<CFBamDbKeyHash224GenBuff>();
		CFBamDbKeyHash224GenBuff[] buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash224GenBuff[] readBuffByScopeIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId )
	{
		...
		CFBamDbKeyHash224GenBuff buff;
		ArrayList<CFBamDbKeyHash224GenBuff> filteredList = new ArrayList<CFBamDbKeyHash224GenBuff>();
		CFBamDbKeyHash224GenBuff[] buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash224GenBuff[] readBuffByDefSchemaIdx( CFSecAuthorization Authorization,
		Long DefSchemaTenantId,
		Long DefSchemaId )
	{
		...
		CFBamDbKeyHash224GenBuff buff;
		ArrayList<CFBamDbKeyHash224GenBuff> filteredList = new ArrayList<CFBamDbKeyHash224GenBuff>();
		CFBamDbKeyHash224GenBuff[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash224GenBuff[] readBuffByPrevIdx( CFSecAuthorization Authorization,
		Long PrevTenantId,
		Long PrevId )
	{
		...
		CFBamDbKeyHash224GenBuff buff;
		ArrayList<CFBamDbKeyHash224GenBuff> filteredList = new ArrayList<CFBamDbKeyHash224GenBuff>();
		CFBamDbKeyHash224GenBuff[] buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash224GenBuff[] readBuffByNextIdx( CFSecAuthorization Authorization,
		Long NextTenantId,
		Long NextId )
	{
		...
		CFBamDbKeyHash224GenBuff buff;
		ArrayList<CFBamDbKeyHash224GenBuff> filteredList = new ArrayList<CFBamDbKeyHash224GenBuff>();
		CFBamDbKeyHash224GenBuff[] buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash224GenBuff[] readBuffByContPrevIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long PrevId )
	{
		...
		CFBamDbKeyHash224GenBuff buff;
		ArrayList<CFBamDbKeyHash224GenBuff> filteredList = new ArrayList<CFBamDbKeyHash224GenBuff>();
		CFBamDbKeyHash224GenBuff[] buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash224GenBuff[] readBuffByContNextIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long NextId )
	{
		...
		CFBamDbKeyHash224GenBuff buff;
		ArrayList<CFBamDbKeyHash224GenBuff> filteredList = new ArrayList<CFBamDbKeyHash224GenBuff>();
		CFBamDbKeyHash224GenBuff[] buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash224GenBuff[] readBuffByCodeVisIdx( CFSecAuthorization Authorization,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByCodeVisIdx() ";
		CFBamDbKeyHash224GenBuff buff;
		ArrayList<CFBamDbKeyHash224GenBuff> filteredList = new ArrayList<CFBamDbKeyHash224GenBuff>();
		CFBamDbKeyHash224GenBuff[] buffList = readDerivedByCodeVisIdx( Authorization,
			CodeVis );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash224GenBuff[] readBuffByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		...
		CFBamDbKeyHash224GenBuff buff;
		ArrayList<CFBamDbKeyHash224GenBuff> filteredList = new ArrayList<CFBamDbKeyHash224GenBuff>();
		CFBamDbKeyHash224GenBuff[] buffList = readDerivedByScopeCodeVisIdx( Authorization,
			TenantId,
			ScopeId,
			CodeVis );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash224GenBuff[] readBuffBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId )
	{
		final String S_ProcName = "CFBamRamDbKeyHash224Type.readBuffBySchemaIdx() ";
		CFBamDbKeyHash224GenBuff buff;
		ArrayList<CFBamDbKeyHash224GenBuff> filteredList = new ArrayList<CFBamDbKeyHash224GenBuff>();
		CFBamDbKeyHash224GenBuff[] buffList = readDerivedBySchemaIdx( Authorization,
			TenantId,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash224GenBuff[] readBuffByDispIdx( CFSecAuthorization Authorization,
		Long DispenserTenantId,
		Long DispenserId )
	{
		final String S_ProcName = "CFBamRamDbKeyHash224Gen.readBuffByDispIdx() ";
		CFBamDbKeyHash224GenBuff buff;
		ArrayList<CFBamDbKeyHash224GenBuff> filteredList = new ArrayList<CFBamDbKeyHash224GenBuff>();
		CFBamDbKeyHash224GenBuff[] buffList = readDerivedByDispIdx( Authorization,
			DispenserTenantId,
			DispenserId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	 ...
	 */
	public CFBamDbKeyHash224GenBuff[] pageBuffBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId,
		Long priorTenantId,
		Long priorId )
	...
	/**
	 *	Read a page array of the specific DbKeyHash224Gen buffer instances identified by the duplicate key DispIdx.
	 *
	 *	@param	Authorization	The session authorization information.
	 *
	 ...
	 *	@throws	CFLibNotSupportedException thrown by client-side implementations.
	 */
	public CFBamDbKeyHash224GenBuff[] pageBuffByDispIdx( CFSecAuthorization Authorization,
		Long DispenserTenantId,
		Long DispenserId,
		Long priorTenantId,
		Long priorId )
	 ...
	 */
	public CFBamDbKeyHash224GenBuff moveBuffUp( CFSecAuthorization Authorization,
		long TenantId,
		long Id,
		int revision )
	{
		...
		{
			return( (CFBamDbKeyHash224GenBuff)cur );
		}
		...
		return( (CFBamDbKeyHash224GenBuff)editCur );
	}
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public CFBamDbKeyHash224GenBuff moveBuffDown( CFSecAuthorization Authorization,
		long TenantId,
		long Id,
		int revision )
	{
	...
	public void updateDbKeyHash224Gen( CFSecAuthorization Authorization,
		CFBamDbKeyHash224GenBuff Buff )
	{
		schema.getTableDbKeyHash224Type().updateDbKeyHash224Type( Authorization,
			Buff );
		CFBamValuePKey pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
		CFBamDbKeyHash224GenBuff existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamDbKeyHash224GenByDispIdxKey existingKeyDispIdx = schema.getFactoryDbKeyHash224Gen().newDispIdxKey();
		...
		CFBamDbKeyHash224GenByDispIdxKey newKeyDispIdx = schema.getFactoryDbKeyHash224Gen().newDispIdxKey();
		...
		Map< CFBamValuePKey, CFBamDbKeyHash224GenBuff > subdict;
		...
		if( dictByDispIdx.containsKey( newKeyDispIdx ) ) {
			...
			subdict = new HashMap< CFBamValuePKey, CFBamDbKeyHash224GenBuff >();
	...
	public void deleteDbKeyHash224Gen( CFSecAuthorization Authorization,
		CFBamDbKeyHash224GenBuff Buff )
	{
		final String S_ProcName = "CFBamRamDbKeyHash224GenTable.deleteDbKeyHash224Gen() ";
		String classCode;
		CFBamValuePKey pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
	...
	public void deleteDbKeyHash224GenByDispIdx( CFSecAuthorization Authorization,
		...
		Long argDispenserId )
	{
		...
		deleteDbKeyHash224GenByDispIdx( Authorization, key );
	}

	public void deleteDbKeyHash224GenByDispIdx( CFSecAuthorization Authorization,
		CFBamDbKeyHash224GenByDispIdxKey argKey )
	{
		CFBamDbKeyHash224GenBuff cur;
		...
		LinkedList<CFBamDbKeyHash224GenBuff> matchSet = new LinkedList<CFBamDbKeyHash224GenBuff>();
		Iterator<CFBamDbKeyHash224GenBuff> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamDbKeyHash224GenBuff> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = schema.getTableDbKeyHash224Gen().readDerivedByIdIdx( Authorization,
				cur.getRequiredTenantId(),
				cur.getRequiredId() );
			deleteDbKeyHash224Gen( Authorization, cur );
		}
	}

	public void deleteDbKeyHash224GenBySchemaIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argSchemaDefId )
	{
		CFBamDbKeyHash224TypeBySchemaIdxKey key = schema.getFactoryDbKeyHash224Type().newSchemaIdxKey();
	...
	public void deleteDbKeyHash224GenByIdIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argId )
	{
		CFBamValuePKey key = schema.getFactoryValue().newPKey();
		...
		deleteDbKeyHash224GenByIdIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash224GenByUNameIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		String argName )
	{
	...
	public void deleteDbKeyHash224GenByValTentIdx( CFSecAuthorization Authorization,
		long argTenantId )
	{
		CFBamValueByValTentIdxKey key = schema.getFactoryValue().newValTentIdxKey();
		key.setRequiredTenantId( argTenantId );
		deleteDbKeyHash224GenByValTentIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash224GenByScopeIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId )
	{
	...
	public void deleteDbKeyHash224GenByDefSchemaIdx( CFSecAuthorization Authorization,
	...
	public void deleteDbKeyHash224GenByPrevIdx( CFSecAuthorization Authorization,
	...
	public void deleteDbKeyHash224GenByNextIdx( CFSecAuthorization Authorization,
	...
	public void deleteDbKeyHash224GenByContPrevIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		Long argPrevId )
	{
	...
	public void deleteDbKeyHash224GenByContNextIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		Long argNextId )
	{
	...
	public void deleteDbKeyHash224GenByCodeVisIdx( CFSecAuthorization Authorization,
		ICFBamSchema.CodeVisibilityEnum argCodeVis )
	{
		...
		deleteDbKeyHash224GenByCodeVisIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash224GenByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		ICFBamSchema.CodeVisibilityEnum argCodeVis )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setRequiredCodeVis( argCodeVis );
		deleteDbKeyHash224GenByScopeCodeVisIdx( Authorization, key );
	}
