...
// Description: Java 11 in-memory RAM DbIO implementation for DbKeyHash384Gen.
...
/*
 *	CFBamRamDbKeyHash384GenTable in-memory RAM DbIO implementation
 *	for DbKeyHash384Gen.
 */
public class CFBamRamDbKeyHash384GenTable
	implements ICFBamDbKeyHash384GenTable
{
	...
	public void createDbKeyHash384Gen( CFSecAuthorization Authorization,
		CFBamDbKeyHash384GenBuff Buff )
	{
		...
		schema.getTableDbKeyHash384Type().createDbKeyHash384Type( Authorization,
			Buff );
...

		{
			...
			allNull = false;
			if( ! allNull ) {
				if( null == schema.getTableDbKeyHash384Type().readDerivedByIdIdx( Authorization,
						Buff.getRequiredTenantId(),
						Buff.getRequiredId() ) )
				{
	...
	public CFBamDbKeyHash384GenBuff readDerived( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash384Gen.readDerived";
	...
	public CFBamDbKeyHash384GenBuff lockDerived( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash384Gen.readDerived";
		CFBamValuePKey key = schema.getFactoryValue().newPKey();
	...
	public CFBamDbKeyHash384GenBuff[] readAllDerived( CFSecAuthorization Authorization ) {
		final String S_ProcName = "CFBamRamDbKeyHash384Gen.readAllDerived";
		CFBamDbKeyHash384GenBuff[] retList = new CFBamDbKeyHash384GenBuff[ dictByPKey.values().size() ];
		Iterator< CFBamDbKeyHash384GenBuff > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
	...
	public CFBamDbKeyHash384GenBuff readDerivedByUNameIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		String Name )
	{
		...
		else if( buff instanceof CFBamDbKeyHash384GenBuff ) {
			return( (CFBamDbKeyHash384GenBuff)buff );
		}
		else {
			return( null );
		}
	...
	public CFBamDbKeyHash384GenBuff[] readDerivedByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		...
		if( buffList == null ) {
			...
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof CFBamDbKeyHash384GenBuff ) ) {
	...
	public CFBamDbKeyHash384GenBuff[] readDerivedByScopeIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId )
	{
	...
	public CFBamDbKeyHash384GenBuff[] readDerivedByDefSchemaIdx( CFSecAuthorization Authorization,
	...
	public CFBamDbKeyHash384GenBuff[] readDerivedByPrevIdx( CFSecAuthorization Authorization,
		Long PrevTenantId,
		Long PrevId )
	{
	...
	public CFBamDbKeyHash384GenBuff[] readDerivedByNextIdx( CFSecAuthorization Authorization,
		Long NextTenantId,
		Long NextId )
	{
	...
	public CFBamDbKeyHash384GenBuff[] readDerivedByContPrevIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long PrevId )
	{
	...
	public CFBamDbKeyHash384GenBuff[] readDerivedByContNextIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long NextId )
	{
	...
	public CFBamDbKeyHash384GenBuff[] readDerivedByCodeVisIdx( CFSecAuthorization Authorization,
	...
	public CFBamDbKeyHash384GenBuff[] readDerivedByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
	...
	public CFBamDbKeyHash384GenBuff[] readDerivedBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId )
	{
		final String S_ProcName = "CFBamRamDbKeyHash384Type.readDerivedBySchemaIdx";
		CFBamDbKeyHash384TypeBuff buffList[] = schema.getTableDbKeyHash384Type().readDerivedBySchemaIdx( Authorization,
			TenantId,
			SchemaDefId );
		if( buffList == null ) {
			return( null );
	...
	public CFBamDbKeyHash384GenBuff readBuff( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash384Gen.readBuff";
		CFBamDbKeyHash384GenBuff buff = readDerived( Authorization, PKey );
	...
	public CFBamDbKeyHash384GenBuff lockBuff( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
	...
	public CFBamDbKeyHash384GenBuff[] readAllBuff( CFSecAuthorization Authorization )
	{
		final String S_ProcName = "CFBamRamDbKeyHash384Gen.readAllBuff";
		CFBamDbKeyHash384GenBuff buff;
		ArrayList<CFBamDbKeyHash384GenBuff> filteredList = new ArrayList<CFBamDbKeyHash384GenBuff>();
		CFBamDbKeyHash384GenBuff[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a84e" ) ) {
	...
	public CFBamDbKeyHash384GenBuff readBuffByIdIdx( CFSecAuthorization Authorization,
		long TenantId,
		long Id )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByIdIdx() ";
		CFBamDbKeyHash384GenBuff buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
	...
	public CFBamDbKeyHash384GenBuff readBuffByUNameIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		String Name )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByUNameIdx() ";
		CFBamDbKeyHash384GenBuff buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash384GenBuff[] readBuffByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByValTentIdx() ";
		CFBamDbKeyHash384GenBuff buff;
		ArrayList<CFBamDbKeyHash384GenBuff> filteredList = new ArrayList<CFBamDbKeyHash384GenBuff>();
		CFBamDbKeyHash384GenBuff[] buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash384GenBuff[] readBuffByScopeIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId )
	{
		...
		CFBamDbKeyHash384GenBuff buff;
		ArrayList<CFBamDbKeyHash384GenBuff> filteredList = new ArrayList<CFBamDbKeyHash384GenBuff>();
		CFBamDbKeyHash384GenBuff[] buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash384GenBuff[] readBuffByDefSchemaIdx( CFSecAuthorization Authorization,
		Long DefSchemaTenantId,
		Long DefSchemaId )
	{
		...
		CFBamDbKeyHash384GenBuff buff;
		ArrayList<CFBamDbKeyHash384GenBuff> filteredList = new ArrayList<CFBamDbKeyHash384GenBuff>();
		CFBamDbKeyHash384GenBuff[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash384GenBuff[] readBuffByPrevIdx( CFSecAuthorization Authorization,
		Long PrevTenantId,
		Long PrevId )
	{
		...
		CFBamDbKeyHash384GenBuff buff;
		ArrayList<CFBamDbKeyHash384GenBuff> filteredList = new ArrayList<CFBamDbKeyHash384GenBuff>();
		CFBamDbKeyHash384GenBuff[] buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash384GenBuff[] readBuffByNextIdx( CFSecAuthorization Authorization,
		Long NextTenantId,
		Long NextId )
	{
		...
		CFBamDbKeyHash384GenBuff buff;
		ArrayList<CFBamDbKeyHash384GenBuff> filteredList = new ArrayList<CFBamDbKeyHash384GenBuff>();
		CFBamDbKeyHash384GenBuff[] buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash384GenBuff[] readBuffByContPrevIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long PrevId )
	{
		...
		CFBamDbKeyHash384GenBuff buff;
		ArrayList<CFBamDbKeyHash384GenBuff> filteredList = new ArrayList<CFBamDbKeyHash384GenBuff>();
		CFBamDbKeyHash384GenBuff[] buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash384GenBuff[] readBuffByContNextIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long NextId )
	{
		...
		CFBamDbKeyHash384GenBuff buff;
		ArrayList<CFBamDbKeyHash384GenBuff> filteredList = new ArrayList<CFBamDbKeyHash384GenBuff>();
		CFBamDbKeyHash384GenBuff[] buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash384GenBuff[] readBuffByCodeVisIdx( CFSecAuthorization Authorization,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByCodeVisIdx() ";
		CFBamDbKeyHash384GenBuff buff;
		ArrayList<CFBamDbKeyHash384GenBuff> filteredList = new ArrayList<CFBamDbKeyHash384GenBuff>();
		CFBamDbKeyHash384GenBuff[] buffList = readDerivedByCodeVisIdx( Authorization,
			CodeVis );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash384GenBuff[] readBuffByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		...
		CFBamDbKeyHash384GenBuff buff;
		ArrayList<CFBamDbKeyHash384GenBuff> filteredList = new ArrayList<CFBamDbKeyHash384GenBuff>();
		CFBamDbKeyHash384GenBuff[] buffList = readDerivedByScopeCodeVisIdx( Authorization,
			TenantId,
			ScopeId,
			CodeVis );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash384GenBuff[] readBuffBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId )
	{
		...
		CFBamDbKeyHash384GenBuff buff;
		ArrayList<CFBamDbKeyHash384GenBuff> filteredList = new ArrayList<CFBamDbKeyHash384GenBuff>();
		CFBamDbKeyHash384GenBuff[] buffList = readDerivedBySchemaIdx( Authorization,
			TenantId,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	 ...
	 */
	public CFBamDbKeyHash384GenBuff[] pageBuffBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId,
		Long priorTenantId,
		Long priorId )
	 ...
	 */
	public CFBamDbKeyHash384GenBuff moveBuffUp( CFSecAuthorization Authorization,
		long TenantId,
		long Id,
		int revision )
	{
		...
		{
			return( (CFBamDbKeyHash384GenBuff)cur );
		}
		...
		return( (CFBamDbKeyHash384GenBuff)editCur );
	}
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public CFBamDbKeyHash384GenBuff moveBuffDown( CFSecAuthorization Authorization,
		long TenantId,
		long Id,
		int revision )
	{
	...
	public void updateDbKeyHash384Gen( CFSecAuthorization Authorization,
		CFBamDbKeyHash384GenBuff Buff )
	{
		schema.getTableDbKeyHash384Type().updateDbKeyHash384Type( Authorization,
			Buff );
		CFBamValuePKey pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
		CFBamDbKeyHash384GenBuff existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		Map< CFBamValuePKey, CFBamDbKeyHash384GenBuff > subdict;
	...
	public void deleteDbKeyHash384Gen( CFSecAuthorization Authorization,
		CFBamDbKeyHash384GenBuff Buff )
	{
		final String S_ProcName = "CFBamRamDbKeyHash384GenTable.deleteDbKeyHash384Gen() ";
		String classCode;
		CFBamValuePKey pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
		...
		long argSchemaDefId )
	{
		...
		deleteDbKeyHash384GenBySchemaIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash384GenByIdIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argId )
	{
		CFBamValuePKey key = schema.getFactoryValue().newPKey();
		...
		deleteDbKeyHash384GenByIdIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash384GenByUNameIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		String argName )
	{
		...
		deleteDbKeyHash384GenByUNameIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash384GenByValTentIdx( CFSecAuthorization Authorization,
		long argTenantId )
	{
		CFBamValueByValTentIdxKey key = schema.getFactoryValue().newValTentIdxKey();
		key.setRequiredTenantId( argTenantId );
		deleteDbKeyHash384GenByValTentIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash384GenByScopeIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId )
	{
		...
		key.setRequiredTenantId( argTenantId );
		key.setRequiredScopeId( argScopeId );
		deleteDbKeyHash384GenByScopeIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash384GenByDefSchemaIdx( CFSecAuthorization Authorization,
		...
		Long argDefSchemaId )
	{
		...
		deleteDbKeyHash384GenByDefSchemaIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash384GenByPrevIdx( CFSecAuthorization Authorization,
		...
		Long argPrevId )
	{
		...
		deleteDbKeyHash384GenByPrevIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash384GenByNextIdx( CFSecAuthorization Authorization,
		...
		Long argNextId )
	{
		...
		deleteDbKeyHash384GenByNextIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash384GenByContPrevIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		Long argPrevId )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setOptionalPrevId( argPrevId );
		deleteDbKeyHash384GenByContPrevIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash384GenByContNextIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		Long argNextId )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setOptionalNextId( argNextId );
		deleteDbKeyHash384GenByContNextIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash384GenByCodeVisIdx( CFSecAuthorization Authorization,
		ICFBamSchema.CodeVisibilityEnum argCodeVis )
	{
		...
		deleteDbKeyHash384GenByCodeVisIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash384GenByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		ICFBamSchema.CodeVisibilityEnum argCodeVis )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setRequiredCodeVis( argCodeVis );
		deleteDbKeyHash384GenByScopeCodeVisIdx( Authorization, key );
	}
