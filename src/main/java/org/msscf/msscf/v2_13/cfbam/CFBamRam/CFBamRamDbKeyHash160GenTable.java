...
// Description: Java 11 in-memory RAM DbIO implementation for DbKeyHash160Gen.
...
/*
 *	CFBamRamDbKeyHash160GenTable in-memory RAM DbIO implementation
 *	for DbKeyHash160Gen.
 */
public class CFBamRamDbKeyHash160GenTable
	implements ICFBamDbKeyHash160GenTable
{
	private ICFBamSchema schema;
	private Map< CFBamValuePKey,
				CFBamDbKeyHash160GenBuff > dictByPKey
		= new HashMap< CFBamValuePKey,
				CFBamDbKeyHash160GenBuff >();
	private Map< CFBamDbKeyHash160GenByDispIdxKey,
				Map< CFBamValuePKey,
					CFBamDbKeyHash160GenBuff >> dictByDispIdx
		= new HashMap< CFBamDbKeyHash160GenByDispIdxKey,
				Map< CFBamValuePKey,
					CFBamDbKeyHash160GenBuff >>();

	public CFBamRamDbKeyHash160GenTable( ICFBamSchema argSchema ) {
		schema = argSchema;
	}

	public void createDbKeyHash160Gen( CFSecAuthorization Authorization,
		CFBamDbKeyHash160GenBuff Buff )
	{
		final String S_ProcName = "createDbKeyHash160Gen";
		...
		schema.getTableDbKeyHash160Type().createDbKeyHash160Type( Authorization,
			Buff );
		CFBamValuePKey pkey = schema.getFactoryValue().newPKey();
		pkey.setClassCode( Buff.getClassCode() );
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
		CFBamDbKeyHash160GenByDispIdxKey keyDispIdx = schema.getFactoryDbKeyHash160Gen().newDispIdxKey();
...

		{
			...
			allNull = false;
			if( ! allNull ) {
				if( null == schema.getTableDbKeyHash160Type().readDerivedByIdIdx( Authorization,
						Buff.getRequiredTenantId(),
						Buff.getRequiredId() ) )
				{
		...
		Map< CFBamValuePKey, CFBamDbKeyHash160GenBuff > subdictDispIdx;
		if( dictByDispIdx.containsKey( keyDispIdx ) ) {
			subdictDispIdx = dictByDispIdx.get( keyDispIdx );
		}
		else {
			subdictDispIdx = new HashMap< CFBamValuePKey, CFBamDbKeyHash160GenBuff >();
	...
	public CFBamDbKeyHash160GenBuff readDerived( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
	...
	public CFBamDbKeyHash160GenBuff lockDerived( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash160Gen.readDerived";
		CFBamValuePKey key = schema.getFactoryValue().newPKey();
	...
	public CFBamDbKeyHash160GenBuff[] readAllDerived( CFSecAuthorization Authorization ) {
		final String S_ProcName = "CFBamRamDbKeyHash160Gen.readAllDerived";
		CFBamDbKeyHash160GenBuff[] retList = new CFBamDbKeyHash160GenBuff[ dictByPKey.values().size() ];
		Iterator< CFBamDbKeyHash160GenBuff > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
	...
	public CFBamDbKeyHash160GenBuff readDerivedByUNameIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		String Name )
	{
		...
		else if( buff instanceof CFBamDbKeyHash160GenBuff ) {
			return( (CFBamDbKeyHash160GenBuff)buff );
		}
		else {
			return( null );
		}
	...
	public CFBamDbKeyHash160GenBuff[] readDerivedByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		...
		if( buffList == null ) {
			...
			CFBamValueBuff buff;
			ArrayList<CFBamDbKeyHash160GenBuff> filteredList = new ArrayList<CFBamDbKeyHash160GenBuff>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof CFBamDbKeyHash160GenBuff ) ) {
					filteredList.add( (CFBamDbKeyHash160GenBuff)buff );
				}
			}
			return( filteredList.toArray( new CFBamDbKeyHash160GenBuff[0] ) );
		}
	}

	public CFBamDbKeyHash160GenBuff[] readDerivedByScopeIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId )
	{
	...
	public CFBamDbKeyHash160GenBuff[] readDerivedByDefSchemaIdx( CFSecAuthorization Authorization,
	...
	public CFBamDbKeyHash160GenBuff[] readDerivedByPrevIdx( CFSecAuthorization Authorization,
		Long PrevTenantId,
		Long PrevId )
	{
	...
	public CFBamDbKeyHash160GenBuff[] readDerivedByNextIdx( CFSecAuthorization Authorization,
		Long NextTenantId,
		Long NextId )
	{
	...
	public CFBamDbKeyHash160GenBuff[] readDerivedByContPrevIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long PrevId )
	{
	...
	public CFBamDbKeyHash160GenBuff[] readDerivedByContNextIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long NextId )
	{
	...
	public CFBamDbKeyHash160GenBuff[] readDerivedByCodeVisIdx( CFSecAuthorization Authorization,
	...
	public CFBamDbKeyHash160GenBuff[] readDerivedByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
	...
	public CFBamDbKeyHash160GenBuff[] readDerivedBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId )
	{
		final String S_ProcName = "CFBamRamDbKeyHash160Type.readDerivedBySchemaIdx";
		CFBamDbKeyHash160TypeBuff buffList[] = schema.getTableDbKeyHash160Type().readDerivedBySchemaIdx( Authorization,
			TenantId,
			SchemaDefId );
		if( buffList == null ) {
			return( null );
	...
	public CFBamDbKeyHash160GenBuff[] readDerivedByDispIdx( CFSecAuthorization Authorization,
		Long DispenserTenantId,
		Long DispenserId )
	{
		final String S_ProcName = "CFBamRamDbKeyHash160Gen.readDerivedByDispIdx";
		CFBamDbKeyHash160GenByDispIdxKey key = schema.getFactoryDbKeyHash160Gen().newDispIdxKey();
		key.setOptionalDispenserTenantId( DispenserTenantId );
		key.setOptionalDispenserId( DispenserId );

		CFBamDbKeyHash160GenBuff[] recArray;
		if( dictByDispIdx.containsKey( key ) ) {
			Map< CFBamValuePKey, CFBamDbKeyHash160GenBuff > subdictDispIdx
				= dictByDispIdx.get( key );
			recArray = new CFBamDbKeyHash160GenBuff[ subdictDispIdx.size() ];
			Iterator< CFBamDbKeyHash160GenBuff > iter = subdictDispIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< CFBamValuePKey, CFBamDbKeyHash160GenBuff > subdictDispIdx
				= new HashMap< CFBamValuePKey, CFBamDbKeyHash160GenBuff >();
			dictByDispIdx.put( key, subdictDispIdx );
			recArray = new CFBamDbKeyHash160GenBuff[0];
		}
		return( recArray );
	}

	public CFBamDbKeyHash160GenBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		long TenantId,
		long Id )
	{
	...
	public CFBamDbKeyHash160GenBuff readBuff( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash160Gen.readBuff";
		CFBamDbKeyHash160GenBuff buff = readDerived( Authorization, PKey );
	...
	public CFBamDbKeyHash160GenBuff lockBuff( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
	...
	public CFBamDbKeyHash160GenBuff[] readAllBuff( CFSecAuthorization Authorization )
	{
		final String S_ProcName = "CFBamRamDbKeyHash160Gen.readAllBuff";
		CFBamDbKeyHash160GenBuff buff;
		ArrayList<CFBamDbKeyHash160GenBuff> filteredList = new ArrayList<CFBamDbKeyHash160GenBuff>();
		CFBamDbKeyHash160GenBuff[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a842" ) ) {
	...
	public CFBamDbKeyHash160GenBuff readBuffByIdIdx( CFSecAuthorization Authorization,
		long TenantId,
		long Id )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByIdIdx() ";
		CFBamDbKeyHash160GenBuff buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
	...
	public CFBamDbKeyHash160GenBuff readBuffByUNameIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		String Name )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByUNameIdx() ";
		CFBamDbKeyHash160GenBuff buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash160GenBuff[] readBuffByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByValTentIdx() ";
		CFBamDbKeyHash160GenBuff buff;
		ArrayList<CFBamDbKeyHash160GenBuff> filteredList = new ArrayList<CFBamDbKeyHash160GenBuff>();
		CFBamDbKeyHash160GenBuff[] buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash160GenBuff[] readBuffByScopeIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId )
	{
		...
		CFBamDbKeyHash160GenBuff buff;
		ArrayList<CFBamDbKeyHash160GenBuff> filteredList = new ArrayList<CFBamDbKeyHash160GenBuff>();
		CFBamDbKeyHash160GenBuff[] buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash160GenBuff[] readBuffByDefSchemaIdx( CFSecAuthorization Authorization,
		Long DefSchemaTenantId,
		Long DefSchemaId )
	{
		...
		CFBamDbKeyHash160GenBuff buff;
		ArrayList<CFBamDbKeyHash160GenBuff> filteredList = new ArrayList<CFBamDbKeyHash160GenBuff>();
		CFBamDbKeyHash160GenBuff[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash160GenBuff[] readBuffByPrevIdx( CFSecAuthorization Authorization,
		Long PrevTenantId,
		Long PrevId )
	{
		...
		CFBamDbKeyHash160GenBuff buff;
		ArrayList<CFBamDbKeyHash160GenBuff> filteredList = new ArrayList<CFBamDbKeyHash160GenBuff>();
		CFBamDbKeyHash160GenBuff[] buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash160GenBuff[] readBuffByNextIdx( CFSecAuthorization Authorization,
		Long NextTenantId,
		Long NextId )
	{
		...
		CFBamDbKeyHash160GenBuff buff;
		ArrayList<CFBamDbKeyHash160GenBuff> filteredList = new ArrayList<CFBamDbKeyHash160GenBuff>();
		CFBamDbKeyHash160GenBuff[] buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash160GenBuff[] readBuffByContPrevIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long PrevId )
	{
		...
		CFBamDbKeyHash160GenBuff buff;
		ArrayList<CFBamDbKeyHash160GenBuff> filteredList = new ArrayList<CFBamDbKeyHash160GenBuff>();
		CFBamDbKeyHash160GenBuff[] buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash160GenBuff[] readBuffByContNextIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long NextId )
	{
		...
		CFBamDbKeyHash160GenBuff buff;
		ArrayList<CFBamDbKeyHash160GenBuff> filteredList = new ArrayList<CFBamDbKeyHash160GenBuff>();
		CFBamDbKeyHash160GenBuff[] buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash160GenBuff[] readBuffByCodeVisIdx( CFSecAuthorization Authorization,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByCodeVisIdx() ";
		CFBamDbKeyHash160GenBuff buff;
		ArrayList<CFBamDbKeyHash160GenBuff> filteredList = new ArrayList<CFBamDbKeyHash160GenBuff>();
		CFBamDbKeyHash160GenBuff[] buffList = readDerivedByCodeVisIdx( Authorization,
			CodeVis );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash160GenBuff[] readBuffByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		...
		CFBamDbKeyHash160GenBuff buff;
		ArrayList<CFBamDbKeyHash160GenBuff> filteredList = new ArrayList<CFBamDbKeyHash160GenBuff>();
		CFBamDbKeyHash160GenBuff[] buffList = readDerivedByScopeCodeVisIdx( Authorization,
			TenantId,
			ScopeId,
			CodeVis );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash160GenBuff[] readBuffBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId )
	{
		final String S_ProcName = "CFBamRamDbKeyHash160Type.readBuffBySchemaIdx() ";
		CFBamDbKeyHash160GenBuff buff;
		ArrayList<CFBamDbKeyHash160GenBuff> filteredList = new ArrayList<CFBamDbKeyHash160GenBuff>();
		CFBamDbKeyHash160GenBuff[] buffList = readDerivedBySchemaIdx( Authorization,
			TenantId,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash160GenBuff[] readBuffByDispIdx( CFSecAuthorization Authorization,
		Long DispenserTenantId,
		Long DispenserId )
	{
		final String S_ProcName = "CFBamRamDbKeyHash160Gen.readBuffByDispIdx() ";
		CFBamDbKeyHash160GenBuff buff;
		ArrayList<CFBamDbKeyHash160GenBuff> filteredList = new ArrayList<CFBamDbKeyHash160GenBuff>();
		CFBamDbKeyHash160GenBuff[] buffList = readDerivedByDispIdx( Authorization,
			DispenserTenantId,
			DispenserId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	/**
	 *	Read a page array of the specific DbKeyHash160Gen buffer instances identified by the duplicate key SchemaIdx.
	 *
	 ...
	 */
	public CFBamDbKeyHash160GenBuff[] pageBuffBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId,
		Long priorTenantId,
		Long priorId )
	...
	/**
	 *	Read a page array of the specific DbKeyHash160Gen buffer instances identified by the duplicate key DispIdx.
	 *
	 *	@param	Authorization	The session authorization information.
	 *
	 ...
	 *	@throws	CFLibNotSupportedException thrown by client-side implementations.
	 */
	public CFBamDbKeyHash160GenBuff[] pageBuffByDispIdx( CFSecAuthorization Authorization,
		Long DispenserTenantId,
		Long DispenserId,
		Long priorTenantId,
		Long priorId )
	 ...
	 */
	public CFBamDbKeyHash160GenBuff moveBuffUp( CFSecAuthorization Authorization,
		long TenantId,
		long Id,
		int revision )
	{
		...
		{
			return( (CFBamDbKeyHash160GenBuff)cur );
		}
		...
		return( (CFBamDbKeyHash160GenBuff)editCur );
	}
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public CFBamDbKeyHash160GenBuff moveBuffDown( CFSecAuthorization Authorization,
		long TenantId,
		long Id,
		int revision )
	{
	...
	public void updateDbKeyHash160Gen( CFSecAuthorization Authorization,
		CFBamDbKeyHash160GenBuff Buff )
	{
		schema.getTableDbKeyHash160Type().updateDbKeyHash160Type( Authorization,
			Buff );
		CFBamValuePKey pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
		CFBamDbKeyHash160GenBuff existing = dictByPKey.get( pkey );
		if( existing == null ) {
			throw new CFLibStaleCacheDetectedException( getClass(),
				"updateDbKeyHash160Gen",
				"Existing record not found",
				"DbKeyHash160Gen",
				pkey );
		}
		CFBamDbKeyHash160GenByDispIdxKey existingKeyDispIdx = schema.getFactoryDbKeyHash160Gen().newDispIdxKey();
		...
		CFBamDbKeyHash160GenByDispIdxKey newKeyDispIdx = schema.getFactoryDbKeyHash160Gen().newDispIdxKey();
		...
		Map< CFBamValuePKey, CFBamDbKeyHash160GenBuff > subdict;
		...
		if( dictByDispIdx.containsKey( newKeyDispIdx ) ) {
			...
			subdict = new HashMap< CFBamValuePKey, CFBamDbKeyHash160GenBuff >();
	...
	public void deleteDbKeyHash160Gen( CFSecAuthorization Authorization,
		CFBamDbKeyHash160GenBuff Buff )
	{
		final String S_ProcName = "CFBamRamDbKeyHash160GenTable.deleteDbKeyHash160Gen() ";
		String classCode;
		CFBamValuePKey pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
		...
		schema.getTableDbKeyHash160Type().deleteDbKeyHash160Type( Authorization,
			Buff );
	}
	public void deleteDbKeyHash160GenByDispIdx( CFSecAuthorization Authorization,
		...
		Long argDispenserId )
	{
		...
		deleteDbKeyHash160GenByDispIdx( Authorization, key );
	}

	public void deleteDbKeyHash160GenByDispIdx( CFSecAuthorization Authorization,
		CFBamDbKeyHash160GenByDispIdxKey argKey )
	{
		CFBamDbKeyHash160GenBuff cur;
		...
		LinkedList<CFBamDbKeyHash160GenBuff> matchSet = new LinkedList<CFBamDbKeyHash160GenBuff>();
		Iterator<CFBamDbKeyHash160GenBuff> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamDbKeyHash160GenBuff> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = schema.getTableDbKeyHash160Gen().readDerivedByIdIdx( Authorization,
				cur.getRequiredTenantId(),
				cur.getRequiredId() );
			deleteDbKeyHash160Gen( Authorization, cur );
		}
	}

	public void deleteDbKeyHash160GenBySchemaIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argSchemaDefId )
	{
		CFBamDbKeyHash160TypeBySchemaIdxKey key = schema.getFactoryDbKeyHash160Type().newSchemaIdxKey();
		key.setRequiredTenantId( argTenantId );
		key.setRequiredSchemaDefId( argSchemaDefId );
		deleteDbKeyHash160GenBySchemaIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash160GenByIdIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argId )
	{
		CFBamValuePKey key = schema.getFactoryValue().newPKey();
		...
		deleteDbKeyHash160GenByIdIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash160GenByUNameIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		String argName )
	{
		...
		deleteDbKeyHash160GenByUNameIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash160GenByValTentIdx( CFSecAuthorization Authorization,
		long argTenantId )
	{
		CFBamValueByValTentIdxKey key = schema.getFactoryValue().newValTentIdxKey();
		key.setRequiredTenantId( argTenantId );
		deleteDbKeyHash160GenByValTentIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash160GenByScopeIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId )
	{
		...
		key.setRequiredTenantId( argTenantId );
		key.setRequiredScopeId( argScopeId );
		deleteDbKeyHash160GenByScopeIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash160GenByDefSchemaIdx( CFSecAuthorization Authorization,
		...
		Long argDefSchemaId )
	{
		...
		deleteDbKeyHash160GenByDefSchemaIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash160GenByPrevIdx( CFSecAuthorization Authorization,
		...
		Long argPrevId )
	{
		...
		deleteDbKeyHash160GenByPrevIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash160GenByNextIdx( CFSecAuthorization Authorization,
		...
		Long argNextId )
	{
		...
		deleteDbKeyHash160GenByNextIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash160GenByContPrevIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		Long argPrevId )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setOptionalPrevId( argPrevId );
		deleteDbKeyHash160GenByContPrevIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash160GenByContNextIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		Long argNextId )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setOptionalNextId( argNextId );
		deleteDbKeyHash160GenByContNextIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash160GenByCodeVisIdx( CFSecAuthorization Authorization,
		ICFBamSchema.CodeVisibilityEnum argCodeVis )
	{
		...
		deleteDbKeyHash160GenByCodeVisIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash160GenByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		ICFBamSchema.CodeVisibilityEnum argCodeVis )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setRequiredCodeVis( argCodeVis );
		deleteDbKeyHash160GenByScopeCodeVisIdx( Authorization, key );
	}
