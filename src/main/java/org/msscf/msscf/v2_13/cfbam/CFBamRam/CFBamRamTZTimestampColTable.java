	...
	implements ICFBamTZTimestampColTable
{
		...
		CFBamTZTimestampColBuff Buff )
	{
		...
		if( Buff.getClassCode().equals( "a881" ) ) {
	...
	public CFBamTZTimestampColBuff[] readDerivedByCodeVisIdx( CFSecAuthorization Authorization,
	...
	public CFBamTZTimestampColBuff[] readDerivedByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		...
		CFBamValuePKey PKey )
	{
		...
		if( ( buff != null ) && ( ! buff.getClassCode().equals( "a881" ) ) ) {
			buff = null;
		}
		return( buff );
	}
	...
	public CFBamTZTimestampColBuff[] readBuffByCodeVisIdx( CFSecAuthorization Authorization,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByCodeVisIdx() ";
		CFBamTZTimestampColBuff buff;
		ArrayList<CFBamTZTimestampColBuff> filteredList = new ArrayList<CFBamTZTimestampColBuff>();
		CFBamTZTimestampColBuff[] buffList = readDerivedByCodeVisIdx( Authorization,
			CodeVis );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamTZTimestampColBuff[] readBuffByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		...
		CFBamTZTimestampColBuff buff;
		ArrayList<CFBamTZTimestampColBuff> filteredList = new ArrayList<CFBamTZTimestampColBuff>();
		CFBamTZTimestampColBuff[] buffList = readDerivedByScopeCodeVisIdx( Authorization,
			TenantId,
			ScopeId,
			CodeVis );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public void deleteTZTimestampColByCodeVisIdx( CFSecAuthorization Authorization,
		ICFBamSchema.CodeVisibilityEnum argCodeVis )
	{
		...
		deleteTZTimestampColByCodeVisIdx( Authorization, key );
	}
	...
	public void deleteTZTimestampColByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		ICFBamSchema.CodeVisibilityEnum argCodeVis )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setRequiredCodeVis( argCodeVis );
		deleteTZTimestampColByScopeCodeVisIdx( Authorization, key );
	}
