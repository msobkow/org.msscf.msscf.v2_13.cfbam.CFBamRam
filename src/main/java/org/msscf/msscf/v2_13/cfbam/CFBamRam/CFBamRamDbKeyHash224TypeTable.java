...
// Description: Java 11 in-memory RAM DbIO implementation for DbKeyHash224Type.
...
/*
 *	CFBamRamDbKeyHash224TypeTable in-memory RAM DbIO implementation
 *	for DbKeyHash224Type.
 */
public class CFBamRamDbKeyHash224TypeTable
	implements ICFBamDbKeyHash224TypeTable
{
	private ICFBamSchema schema;
	private Map< CFBamValuePKey,
				CFBamDbKeyHash224TypeBuff > dictByPKey
		= new HashMap< CFBamValuePKey,
				CFBamDbKeyHash224TypeBuff >();
	private Map< CFBamDbKeyHash224TypeBySchemaIdxKey,
				Map< CFBamValuePKey,
					CFBamDbKeyHash224TypeBuff >> dictBySchemaIdx
		= new HashMap< CFBamDbKeyHash224TypeBySchemaIdxKey,
				Map< CFBamValuePKey,
					CFBamDbKeyHash224TypeBuff >>();

	public CFBamRamDbKeyHash224TypeTable( ICFBamSchema argSchema ) {
		schema = argSchema;
	}

	public void createDbKeyHash224Type( CFSecAuthorization Authorization,
		CFBamDbKeyHash224TypeBuff Buff )
	{
		final String S_ProcName = "createDbKeyHash224Type";
		...
		CFBamDbKeyHash224TypeBySchemaIdxKey keySchemaIdx = schema.getFactoryDbKeyHash224Type().newSchemaIdxKey();
		...
		Map< CFBamValuePKey, CFBamDbKeyHash224TypeBuff > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< CFBamValuePKey, CFBamDbKeyHash224TypeBuff >();
	...
	public CFBamDbKeyHash224TypeBuff readDerived( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash224Type.readDerived";
	...
	public CFBamDbKeyHash224TypeBuff lockDerived( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash224Type.readDerived";
		CFBamValuePKey key = schema.getFactoryValue().newPKey();
	...
	public CFBamDbKeyHash224TypeBuff[] readAllDerived( CFSecAuthorization Authorization ) {
		final String S_ProcName = "CFBamRamDbKeyHash224Type.readAllDerived";
		CFBamDbKeyHash224TypeBuff[] retList = new CFBamDbKeyHash224TypeBuff[ dictByPKey.values().size() ];
		Iterator< CFBamDbKeyHash224TypeBuff > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
	...
	public CFBamDbKeyHash224TypeBuff readDerivedByUNameIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		String Name )
	{
		...
		else if( buff instanceof CFBamDbKeyHash224TypeBuff ) {
			return( (CFBamDbKeyHash224TypeBuff)buff );
		}
		else {
			return( null );
		}
	...
	public CFBamDbKeyHash224TypeBuff[] readDerivedByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
	...
	public CFBamDbKeyHash224TypeBuff[] readDerivedByScopeIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId )
	{
	...
	public CFBamDbKeyHash224TypeBuff[] readDerivedByDefSchemaIdx( CFSecAuthorization Authorization,
	...
	public CFBamDbKeyHash224TypeBuff[] readDerivedByPrevIdx( CFSecAuthorization Authorization,
		Long PrevTenantId,
		Long PrevId )
	{
	...
	public CFBamDbKeyHash224TypeBuff[] readDerivedByNextIdx( CFSecAuthorization Authorization,
		Long NextTenantId,
		Long NextId )
	{
	...
	public CFBamDbKeyHash224TypeBuff[] readDerivedByContPrevIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long PrevId )
	{
	...
	public CFBamDbKeyHash224TypeBuff[] readDerivedByContNextIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long NextId )
	{
		...
		long SchemaDefId )
	{
		...
		CFBamDbKeyHash224TypeBuff[] recArray;
		if( dictBySchemaIdx.containsKey( key ) ) {
			Map< CFBamValuePKey, CFBamDbKeyHash224TypeBuff > subdictSchemaIdx
				= dictBySchemaIdx.get( key );
			recArray = new CFBamDbKeyHash224TypeBuff[ subdictSchemaIdx.size() ];
			Iterator< CFBamDbKeyHash224TypeBuff > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< CFBamValuePKey, CFBamDbKeyHash224TypeBuff > subdictSchemaIdx
				= new HashMap< CFBamValuePKey, CFBamDbKeyHash224TypeBuff >();
			dictBySchemaIdx.put( key, subdictSchemaIdx );
			recArray = new CFBamDbKeyHash224TypeBuff[0];
		}
		return( recArray );
	}

	public CFBamDbKeyHash224TypeBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		long TenantId,
		long Id )
	{
	...
	public CFBamDbKeyHash224TypeBuff readBuff( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash224Type.readBuff";
		CFBamDbKeyHash224TypeBuff buff = readDerived( Authorization, PKey );
	...
	public CFBamDbKeyHash224TypeBuff lockBuff( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
	...
	public CFBamDbKeyHash224TypeBuff[] readAllBuff( CFSecAuthorization Authorization )
	{
		final String S_ProcName = "CFBamRamDbKeyHash224Type.readAllBuff";
		CFBamDbKeyHash224TypeBuff buff;
		ArrayList<CFBamDbKeyHash224TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash224TypeBuff>();
		CFBamDbKeyHash224TypeBuff[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a842" ) ) {
	...
	public CFBamDbKeyHash224TypeBuff readBuffByIdIdx( CFSecAuthorization Authorization,
		long TenantId,
		long Id )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByIdIdx() ";
		CFBamDbKeyHash224TypeBuff buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
	...
	public CFBamDbKeyHash224TypeBuff readBuffByUNameIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		String Name )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByUNameIdx() ";
		CFBamDbKeyHash224TypeBuff buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( ( buff != null ) && buff.getClassCode().equals( "a809" ) ) {
	...
	public CFBamDbKeyHash224TypeBuff[] readBuffByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByValTentIdx() ";
		CFBamDbKeyHash224TypeBuff buff;
		ArrayList<CFBamDbKeyHash224TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash224TypeBuff>();
		CFBamDbKeyHash224TypeBuff[] buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a809" ) ) {
	...
	public CFBamDbKeyHash224TypeBuff[] readBuffByScopeIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId )
	{
		...
		CFBamDbKeyHash224TypeBuff buff;
		ArrayList<CFBamDbKeyHash224TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash224TypeBuff>();
		CFBamDbKeyHash224TypeBuff[] buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash224TypeBuff[] readBuffByDefSchemaIdx( CFSecAuthorization Authorization,
		Long DefSchemaTenantId,
		Long DefSchemaId )
	{
		...
		CFBamDbKeyHash224TypeBuff buff;
		ArrayList<CFBamDbKeyHash224TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash224TypeBuff>();
		CFBamDbKeyHash224TypeBuff[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash224TypeBuff[] readBuffByPrevIdx( CFSecAuthorization Authorization,
		Long PrevTenantId,
		Long PrevId )
	{
		...
		CFBamDbKeyHash224TypeBuff buff;
		ArrayList<CFBamDbKeyHash224TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash224TypeBuff>();
		CFBamDbKeyHash224TypeBuff[] buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash224TypeBuff[] readBuffByNextIdx( CFSecAuthorization Authorization,
		Long NextTenantId,
		Long NextId )
	{
		...
		CFBamDbKeyHash224TypeBuff buff;
		ArrayList<CFBamDbKeyHash224TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash224TypeBuff>();
		CFBamDbKeyHash224TypeBuff[] buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash224TypeBuff[] readBuffByContPrevIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long PrevId )
	{
		...
		CFBamDbKeyHash224TypeBuff buff;
		ArrayList<CFBamDbKeyHash224TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash224TypeBuff>();
		CFBamDbKeyHash224TypeBuff[] buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash224TypeBuff[] readBuffByContNextIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long NextId )
	{
		...
		CFBamDbKeyHash224TypeBuff buff;
		ArrayList<CFBamDbKeyHash224TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash224TypeBuff>();
		CFBamDbKeyHash224TypeBuff[] buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash224TypeBuff[] readBuffBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId )
	{
		...
		CFBamDbKeyHash224TypeBuff buff;
		ArrayList<CFBamDbKeyHash224TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash224TypeBuff>();
		CFBamDbKeyHash224TypeBuff[] buffList = readDerivedBySchemaIdx( Authorization,
			TenantId,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	/**
	 *	Read a page array of the specific DbKeyHash224Type buffer instances identified by the duplicate key SchemaIdx.
	 *
	 ...
	 */
	public CFBamDbKeyHash224TypeBuff[] pageBuffBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId,
		Long priorTenantId,
		Long priorId )
	 ...
	 */
	public CFBamDbKeyHash224TypeBuff moveBuffUp( CFSecAuthorization Authorization,
		long TenantId,
		long Id,
		int revision )
	{
		...
		{
			return( (CFBamDbKeyHash224TypeBuff)cur );
		}
		...
		return( (CFBamDbKeyHash224TypeBuff)editCur );
	}
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public CFBamDbKeyHash224TypeBuff moveBuffDown( CFSecAuthorization Authorization,
		long TenantId,
		long Id,
		int revision )
	{
	...
	public void updateDbKeyHash224Type( CFSecAuthorization Authorization,
		CFBamDbKeyHash224TypeBuff Buff )
	{
		...
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
		CFBamDbKeyHash224TypeBuff existing = dictByPKey.get( pkey );
		if( existing == null ) {
			throw new CFLibStaleCacheDetectedException( getClass(),
				"updateDbKeyHash224Type",
				"Existing record not found",
				"DbKeyHash224Type",
				pkey );
		}
		CFBamDbKeyHash224TypeBySchemaIdxKey existingKeySchemaIdx = schema.getFactoryDbKeyHash224Type().newSchemaIdxKey();
		...
		CFBamDbKeyHash224TypeBySchemaIdxKey newKeySchemaIdx = schema.getFactoryDbKeyHash224Type().newSchemaIdxKey();
		...
		Map< CFBamValuePKey, CFBamDbKeyHash224TypeBuff > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< CFBamValuePKey, CFBamDbKeyHash224TypeBuff >();
	...
	public void deleteDbKeyHash224Type( CFSecAuthorization Authorization,
		CFBamDbKeyHash224TypeBuff Buff )
	{
		final String S_ProcName = "CFBamRamDbKeyHash224TypeTable.deleteDbKeyHash224Type() ";
		String classCode;
		CFBamValuePKey pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
		...
		if( schema.getTableDbKeyHash224Gen().readDerivedByIdIdx( Authorization,
					existing.getRequiredTenantId(),
	...
	public void deleteDbKeyHash224TypeBySchemaIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argSchemaDefId )
	{
		CFBamDbKeyHash224TypeBySchemaIdxKey key = schema.getFactoryDbKeyHash224Type().newSchemaIdxKey();
		...
		deleteDbKeyHash224TypeBySchemaIdx( Authorization, key );
	}

	public void deleteDbKeyHash224TypeBySchemaIdx( CFSecAuthorization Authorization,
		CFBamDbKeyHash224TypeBySchemaIdxKey argKey )
	{
		final String S_ProcName = "deleteDbKeyHash224TypeBySchemaIdx";
	...
	public void deleteDbKeyHash224TypeByIdIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argId )
	{
		CFBamValuePKey key = schema.getFactoryValue().newPKey();
		...
		deleteDbKeyHash224TypeByIdIdx( Authorization, key );
	}

	public void deleteDbKeyHash224TypeByIdIdx( CFSecAuthorization Authorization,
		CFBamValuePKey argKey )
	{
		final String S_ProcName = "deleteDbKeyHash224TypeByIdIdx";
		boolean anyNotNull = false;
		anyNotNull = true;
		anyNotNull = true;
		if( ! anyNotNull ) {
	...
	public void deleteDbKeyHash224TypeByUNameIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		String argName )
	{
		...
		deleteDbKeyHash224TypeByUNameIdx( Authorization, key );
	}

	public void deleteDbKeyHash224TypeByUNameIdx( CFSecAuthorization Authorization,
		CFBamValueByUNameIdxKey argKey )
	{
		final String S_ProcName = "deleteDbKeyHash224TypeByUNameIdx";
		CFBamDbKeyHash224TypeBuff cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		anyNotNull = true;
	...
	public void deleteDbKeyHash224TypeByValTentIdx( CFSecAuthorization Authorization,
		long argTenantId )
	{
		CFBamValueByValTentIdxKey key = schema.getFactoryValue().newValTentIdxKey();
		key.setRequiredTenantId( argTenantId );
		deleteDbKeyHash224TypeByValTentIdx( Authorization, key );
	}

	public void deleteDbKeyHash224TypeByValTentIdx( CFSecAuthorization Authorization,
		CFBamValueByValTentIdxKey argKey )
	{
		final String S_ProcName = "deleteDbKeyHash224TypeByValTentIdx";
		CFBamDbKeyHash224TypeBuff cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
	...
	public void deleteDbKeyHash224TypeByScopeIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId )
	{
		...
		key.setRequiredTenantId( argTenantId );
		key.setRequiredScopeId( argScopeId );
		deleteDbKeyHash224TypeByScopeIdx( Authorization, key );
	}

	public void deleteDbKeyHash224TypeByScopeIdx( CFSecAuthorization Authorization,
		CFBamValueByScopeIdxKey argKey )
	{
		final String S_ProcName = "deleteDbKeyHash224TypeByScopeIdx";
		CFBamDbKeyHash224TypeBuff cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		anyNotNull = true;
	...
	public void deleteDbKeyHash224TypeByDefSchemaIdx( CFSecAuthorization Authorization,
		...
		Long argDefSchemaId )
	{
		...
		deleteDbKeyHash224TypeByDefSchemaIdx( Authorization, key );
	}

	public void deleteDbKeyHash224TypeByDefSchemaIdx( CFSecAuthorization Authorization,
		CFBamValueByDefSchemaIdxKey argKey )
	{
		final String S_ProcName = "deleteDbKeyHash224TypeByDefSchemaIdx";
		CFBamDbKeyHash224TypeBuff cur;
		boolean anyNotNull = false;
	...
	public void deleteDbKeyHash224TypeByPrevIdx( CFSecAuthorization Authorization,
		...
		Long argPrevId )
	{
		...
		deleteDbKeyHash224TypeByPrevIdx( Authorization, key );
	}

	public void deleteDbKeyHash224TypeByPrevIdx( CFSecAuthorization Authorization,
		CFBamValueByPrevIdxKey argKey )
	{
		final String S_ProcName = "deleteDbKeyHash224TypeByPrevIdx";
		CFBamDbKeyHash224TypeBuff cur;
		boolean anyNotNull = false;
	...
	public void deleteDbKeyHash224TypeByNextIdx( CFSecAuthorization Authorization,
		...
		Long argNextId )
	{
		...
		deleteDbKeyHash224TypeByNextIdx( Authorization, key );
	}

	public void deleteDbKeyHash224TypeByNextIdx( CFSecAuthorization Authorization,
		CFBamValueByNextIdxKey argKey )
	{
		final String S_ProcName = "deleteDbKeyHash224TypeByNextIdx";
		CFBamDbKeyHash224TypeBuff cur;
		boolean anyNotNull = false;
	...
	public void deleteDbKeyHash224TypeByContPrevIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		Long argPrevId )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setOptionalPrevId( argPrevId );
		deleteDbKeyHash224TypeByContPrevIdx( Authorization, key );
	}

	public void deleteDbKeyHash224TypeByContPrevIdx( CFSecAuthorization Authorization,
		CFBamValueByContPrevIdxKey argKey )
	{
		final String S_ProcName = "deleteDbKeyHash224TypeByContPrevIdx";
		CFBamDbKeyHash224TypeBuff cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		anyNotNull = true;
	...
	public void deleteDbKeyHash224TypeByContNextIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		Long argNextId )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setOptionalNextId( argNextId );
		deleteDbKeyHash224TypeByContNextIdx( Authorization, key );
	}

	public void deleteDbKeyHash224TypeByContNextIdx( CFSecAuthorization Authorization,
		CFBamValueByContNextIdxKey argKey )
	{
		final String S_ProcName = "deleteDbKeyHash224TypeByContNextIdx";
		CFBamDbKeyHash224TypeBuff cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		anyNotNull = true;
