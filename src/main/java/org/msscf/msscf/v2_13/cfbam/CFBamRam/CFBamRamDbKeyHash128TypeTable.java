...
// Description: Java 11 in-memory RAM DbIO implementation for DbKeyHash128Type.
...
/*
 *	CFBamRamDbKeyHash128TypeTable in-memory RAM DbIO implementation
 *	for DbKeyHash128Type.
 */
public class CFBamRamDbKeyHash128TypeTable
	implements ICFBamDbKeyHash128TypeTable
{
	private ICFBamSchema schema;
	private Map< CFBamValuePKey,
				CFBamDbKeyHash128TypeBuff > dictByPKey
		= new HashMap< CFBamValuePKey,
				CFBamDbKeyHash128TypeBuff >();
	private Map< CFBamDbKeyHash128TypeBySchemaIdxKey,
				Map< CFBamValuePKey,
					CFBamDbKeyHash128TypeBuff >> dictBySchemaIdx
		= new HashMap< CFBamDbKeyHash128TypeBySchemaIdxKey,
				Map< CFBamValuePKey,
					CFBamDbKeyHash128TypeBuff >>();

	public CFBamRamDbKeyHash128TypeTable( ICFBamSchema argSchema ) {
		schema = argSchema;
	}

	public void createDbKeyHash128Type( CFSecAuthorization Authorization,
		CFBamDbKeyHash128TypeBuff Buff )
	{
		...
		schema.getTableDbKeyHash128Def().createDbKeyHash128Def( Authorization,
			Buff );
		CFBamValuePKey pkey = schema.getFactoryValue().newPKey();
		pkey.setClassCode( Buff.getClassCode() );
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
		CFBamDbKeyHash128TypeBySchemaIdxKey keySchemaIdx = schema.getFactoryDbKeyHash128Type().newSchemaIdxKey();
		...
		Map< CFBamValuePKey, CFBamDbKeyHash128TypeBuff > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< CFBamValuePKey, CFBamDbKeyHash128TypeBuff >();
	...
	public CFBamDbKeyHash128TypeBuff readDerived( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash128Type.readDerived";
	...
	public CFBamDbKeyHash128TypeBuff lockDerived( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash128Type.readDerived";
		CFBamValuePKey key = schema.getFactoryValue().newPKey();
	...
	public CFBamDbKeyHash128TypeBuff[] readAllDerived( CFSecAuthorization Authorization ) {
		final String S_ProcName = "CFBamRamDbKeyHash128Type.readAllDerived";
		CFBamDbKeyHash128TypeBuff[] retList = new CFBamDbKeyHash128TypeBuff[ dictByPKey.values().size() ];
		Iterator< CFBamDbKeyHash128TypeBuff > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
	...
	public CFBamDbKeyHash128TypeBuff readDerivedByUNameIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		String Name )
	{
		...
		else if( buff instanceof CFBamDbKeyHash128TypeBuff ) {
			return( (CFBamDbKeyHash128TypeBuff)buff );
		}
		else {
			return( null );
		}
	...
	public CFBamDbKeyHash128TypeBuff[] readDerivedByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		...
		if( buffList == null ) {
			...
			CFBamValueBuff buff;
			ArrayList<CFBamDbKeyHash128TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash128TypeBuff>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof CFBamDbKeyHash128TypeBuff ) ) {
					filteredList.add( (CFBamDbKeyHash128TypeBuff)buff );
				}
			}
			return( filteredList.toArray( new CFBamDbKeyHash128TypeBuff[0] ) );
		}
	}

	public CFBamDbKeyHash128TypeBuff[] readDerivedByScopeIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId )
	{
	...
	public CFBamDbKeyHash128TypeBuff[] readDerivedByDefSchemaIdx( CFSecAuthorization Authorization,
	...
	public CFBamDbKeyHash128TypeBuff[] readDerivedByPrevIdx( CFSecAuthorization Authorization,
		Long PrevTenantId,
		Long PrevId )
	{
	...
	public CFBamDbKeyHash128TypeBuff[] readDerivedByNextIdx( CFSecAuthorization Authorization,
		Long NextTenantId,
		Long NextId )
	{
	...
	public CFBamDbKeyHash128TypeBuff[] readDerivedByContPrevIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long PrevId )
	{
	...
	public CFBamDbKeyHash128TypeBuff[] readDerivedByContNextIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long NextId )
	{
	...
	public CFBamDbKeyHash128TypeBuff[] readDerivedByCodeVisIdx( CFSecAuthorization Authorization,
	...
	public CFBamDbKeyHash128TypeBuff[] readDerivedByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
	...
	public CFBamDbKeyHash128TypeBuff[] readDerivedBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId )
	{
		...
		CFBamDbKeyHash128TypeBuff[] recArray;
		if( dictBySchemaIdx.containsKey( key ) ) {
			Map< CFBamValuePKey, CFBamDbKeyHash128TypeBuff > subdictSchemaIdx
				= dictBySchemaIdx.get( key );
			recArray = new CFBamDbKeyHash128TypeBuff[ subdictSchemaIdx.size() ];
			Iterator< CFBamDbKeyHash128TypeBuff > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< CFBamValuePKey, CFBamDbKeyHash128TypeBuff > subdictSchemaIdx
				= new HashMap< CFBamValuePKey, CFBamDbKeyHash128TypeBuff >();
			dictBySchemaIdx.put( key, subdictSchemaIdx );
			recArray = new CFBamDbKeyHash128TypeBuff[0];
		}
		return( recArray );
	}

	public CFBamDbKeyHash128TypeBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		long TenantId,
		long Id )
	{
	...
	public CFBamDbKeyHash128TypeBuff readBuff( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash128Type.readBuff";
		CFBamDbKeyHash128TypeBuff buff = readDerived( Authorization, PKey );
	...
	public CFBamDbKeyHash128TypeBuff lockBuff( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
	...
	public CFBamDbKeyHash128TypeBuff[] readAllBuff( CFSecAuthorization Authorization )
	{
		final String S_ProcName = "CFBamRamDbKeyHash128Type.readAllBuff";
		CFBamDbKeyHash128TypeBuff buff;
		ArrayList<CFBamDbKeyHash128TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash128TypeBuff>();
		CFBamDbKeyHash128TypeBuff[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a83d" ) ) {
	...
	public CFBamDbKeyHash128TypeBuff readBuffByIdIdx( CFSecAuthorization Authorization,
		long TenantId,
		long Id )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByIdIdx() ";
		CFBamDbKeyHash128TypeBuff buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
	...
	public CFBamDbKeyHash128TypeBuff readBuffByUNameIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		String Name )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByUNameIdx() ";
		CFBamDbKeyHash128TypeBuff buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash128TypeBuff[] readBuffByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByValTentIdx() ";
		CFBamDbKeyHash128TypeBuff buff;
		ArrayList<CFBamDbKeyHash128TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash128TypeBuff>();
		CFBamDbKeyHash128TypeBuff[] buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash128TypeBuff[] readBuffByScopeIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId )
	{
		...
		CFBamDbKeyHash128TypeBuff buff;
		ArrayList<CFBamDbKeyHash128TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash128TypeBuff>();
		CFBamDbKeyHash128TypeBuff[] buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash128TypeBuff[] readBuffByDefSchemaIdx( CFSecAuthorization Authorization,
		Long DefSchemaTenantId,
		Long DefSchemaId )
	{
		...
		CFBamDbKeyHash128TypeBuff buff;
		ArrayList<CFBamDbKeyHash128TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash128TypeBuff>();
		CFBamDbKeyHash128TypeBuff[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash128TypeBuff[] readBuffByPrevIdx( CFSecAuthorization Authorization,
		Long PrevTenantId,
		Long PrevId )
	{
		...
		CFBamDbKeyHash128TypeBuff buff;
		ArrayList<CFBamDbKeyHash128TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash128TypeBuff>();
		CFBamDbKeyHash128TypeBuff[] buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash128TypeBuff[] readBuffByNextIdx( CFSecAuthorization Authorization,
		Long NextTenantId,
		Long NextId )
	{
		...
		CFBamDbKeyHash128TypeBuff buff;
		ArrayList<CFBamDbKeyHash128TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash128TypeBuff>();
		CFBamDbKeyHash128TypeBuff[] buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash128TypeBuff[] readBuffByContPrevIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long PrevId )
	{
		...
		CFBamDbKeyHash128TypeBuff buff;
		ArrayList<CFBamDbKeyHash128TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash128TypeBuff>();
		CFBamDbKeyHash128TypeBuff[] buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash128TypeBuff[] readBuffByContNextIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long NextId )
	{
		...
		CFBamDbKeyHash128TypeBuff buff;
		ArrayList<CFBamDbKeyHash128TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash128TypeBuff>();
		CFBamDbKeyHash128TypeBuff[] buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash128TypeBuff[] readBuffByCodeVisIdx( CFSecAuthorization Authorization,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByCodeVisIdx() ";
		CFBamDbKeyHash128TypeBuff buff;
		ArrayList<CFBamDbKeyHash128TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash128TypeBuff>();
		CFBamDbKeyHash128TypeBuff[] buffList = readDerivedByCodeVisIdx( Authorization,
			CodeVis );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash128TypeBuff[] readBuffByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		...
		CFBamDbKeyHash128TypeBuff buff;
		ArrayList<CFBamDbKeyHash128TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash128TypeBuff>();
		CFBamDbKeyHash128TypeBuff[] buffList = readDerivedByScopeCodeVisIdx( Authorization,
			TenantId,
			ScopeId,
			CodeVis );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash128TypeBuff[] readBuffBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId )
	{
		...
		CFBamDbKeyHash128TypeBuff buff;
		ArrayList<CFBamDbKeyHash128TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash128TypeBuff>();
		CFBamDbKeyHash128TypeBuff[] buffList = readDerivedBySchemaIdx( Authorization,
			TenantId,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	/**
	 *	Read a page array of the specific DbKeyHash128Type buffer instances identified by the duplicate key SchemaIdx.
	 *
	 ...
	 */
	public CFBamDbKeyHash128TypeBuff[] pageBuffBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId,
		Long priorTenantId,
		Long priorId )
	 ...
	 */
	public CFBamDbKeyHash128TypeBuff moveBuffUp( CFSecAuthorization Authorization,
		long TenantId,
		long Id,
		int revision )
	{
		...
		{
			return( (CFBamDbKeyHash128TypeBuff)cur );
		}
		...
		return( (CFBamDbKeyHash128TypeBuff)editCur );
	}
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public CFBamDbKeyHash128TypeBuff moveBuffDown( CFSecAuthorization Authorization,
		long TenantId,
		long Id,
		int revision )
	{
	...
	public void updateDbKeyHash128Type( CFSecAuthorization Authorization,
		CFBamDbKeyHash128TypeBuff Buff )
	{
		schema.getTableDbKeyHash128Def().updateDbKeyHash128Def( Authorization,
			Buff );
		CFBamValuePKey pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
		CFBamDbKeyHash128TypeBuff existing = dictByPKey.get( pkey );
		if( existing == null ) {
			throw new CFLibStaleCacheDetectedException( getClass(),
				"updateDbKeyHash128Type",
				"Existing record not found",
				"DbKeyHash128Type",
				pkey );
		}
		CFBamDbKeyHash128TypeBySchemaIdxKey existingKeySchemaIdx = schema.getFactoryDbKeyHash128Type().newSchemaIdxKey();
		...
		CFBamDbKeyHash128TypeBySchemaIdxKey newKeySchemaIdx = schema.getFactoryDbKeyHash128Type().newSchemaIdxKey();
		...
		Map< CFBamValuePKey, CFBamDbKeyHash128TypeBuff > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< CFBamValuePKey, CFBamDbKeyHash128TypeBuff >();
	...
	public void deleteDbKeyHash128Type( CFSecAuthorization Authorization,
		CFBamDbKeyHash128TypeBuff Buff )
	{
		final String S_ProcName = "CFBamRamDbKeyHash128TypeTable.deleteDbKeyHash128Type() ";
		String classCode;
		CFBamValuePKey pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
		...
		if( schema.getTableDbKeyHash128Gen().readDerivedByIdIdx( Authorization,
					existing.getRequiredTenantId(),
	...
	public void deleteDbKeyHash128TypeBySchemaIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argSchemaDefId )
	{
		CFBamDbKeyHash128TypeBySchemaIdxKey key = schema.getFactoryDbKeyHash128Type().newSchemaIdxKey();
		...
		deleteDbKeyHash128TypeBySchemaIdx( Authorization, key );
	}
		...
		CFBamDbKeyHash128TypeBySchemaIdxKey argKey )
	{
		...
		LinkedList<CFBamDbKeyHash128TypeBuff> matchSet = new LinkedList<CFBamDbKeyHash128TypeBuff>();
		Iterator<CFBamDbKeyHash128TypeBuff> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamDbKeyHash128TypeBuff> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = schema.getTableDbKeyHash128Type().readDerivedByIdIdx( Authorization,
				cur.getRequiredTenantId(),
				cur.getRequiredId() );
			String subClassCode = cur.getClassCode();
			if( "a83d".equals( subClassCode ) ) {
				schema.getTableDbKeyHash128Type().deleteDbKeyHash128Type( Authorization, cur );
			}
				...
				throw new CFLibUnsupportedClassException( getClass(),
					...
					"subClassCode",
					cur,
					"Instance of or subclass of DbKeyHash128Type must not be \"" + subClassCode + "\"" );
			}
		}
	}

	public void deleteDbKeyHash128TypeByIdIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argId )
	{
		CFBamValuePKey key = schema.getFactoryValue().newPKey();
		...
		deleteDbKeyHash128TypeByIdIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash128TypeByUNameIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		String argName )
	{
		...
		deleteDbKeyHash128TypeByUNameIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash128TypeByValTentIdx( CFSecAuthorization Authorization,
		long argTenantId )
	{
		CFBamValueByValTentIdxKey key = schema.getFactoryValue().newValTentIdxKey();
		key.setRequiredTenantId( argTenantId );
		deleteDbKeyHash128TypeByValTentIdx( Authorization, key );
	}

	public void deleteDbKeyHash128TypeByValTentIdx( CFSecAuthorization Authorization,
		CFBamValueByValTentIdxKey argKey )
	{
		final String S_ProcName = "deleteDbKeyHash128TypeByValTentIdx";
		CFBamDbKeyHash128TypeBuff cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
	...
	public void deleteDbKeyHash128TypeByScopeIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId )
	{
		...
		key.setRequiredTenantId( argTenantId );
		key.setRequiredScopeId( argScopeId );
		deleteDbKeyHash128TypeByScopeIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash128TypeByDefSchemaIdx( CFSecAuthorization Authorization,
		...
		Long argDefSchemaId )
	{
		...
		deleteDbKeyHash128TypeByDefSchemaIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash128TypeByPrevIdx( CFSecAuthorization Authorization,
		...
		Long argPrevId )
	{
		...
		deleteDbKeyHash128TypeByPrevIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash128TypeByNextIdx( CFSecAuthorization Authorization,
		...
		Long argNextId )
	{
		...
		deleteDbKeyHash128TypeByNextIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash128TypeByContPrevIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		Long argPrevId )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setOptionalPrevId( argPrevId );
		deleteDbKeyHash128TypeByContPrevIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash128TypeByContNextIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		Long argNextId )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setOptionalNextId( argNextId );
		deleteDbKeyHash128TypeByContNextIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash128TypeByCodeVisIdx( CFSecAuthorization Authorization,
		ICFBamSchema.CodeVisibilityEnum argCodeVis )
	{
		...
		deleteDbKeyHash128TypeByCodeVisIdx( Authorization, key );
	}

	public void deleteDbKeyHash128TypeByCodeVisIdx( CFSecAuthorization Authorization,
		CFBamValueByCodeVisIdxKey argKey )
	{
		final String S_ProcName = "deleteDbKeyHash128TypeByCodeVisIdx";
		CFBamDbKeyHash128TypeBuff cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
	...
	public void deleteDbKeyHash128TypeByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		ICFBamSchema.CodeVisibilityEnum argCodeVis )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setRequiredCodeVis( argCodeVis );
		deleteDbKeyHash128TypeByScopeCodeVisIdx( Authorization, key );
	}

	public void deleteDbKeyHash128TypeByScopeCodeVisIdx( CFSecAuthorization Authorization,
		CFBamValueByScopeCodeVisIdxKey argKey )
	{
		final String S_ProcName = "deleteDbKeyHash128TypeByScopeCodeVisIdx";
		CFBamDbKeyHash128TypeBuff cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		anyNotNull = true;
