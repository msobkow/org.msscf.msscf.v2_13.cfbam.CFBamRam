...
// Description: Java 11 in-memory RAM DbIO implementation for DbKeyHash160Type.
...
/*
 *	CFBamRamDbKeyHash160TypeTable in-memory RAM DbIO implementation
 *	for DbKeyHash160Type.
 */
public class CFBamRamDbKeyHash160TypeTable
	implements ICFBamDbKeyHash160TypeTable
{
	private ICFBamSchema schema;
	private Map< CFBamValuePKey,
				CFBamDbKeyHash160TypeBuff > dictByPKey
		= new HashMap< CFBamValuePKey,
				CFBamDbKeyHash160TypeBuff >();
	private Map< CFBamDbKeyHash160TypeBySchemaIdxKey,
				Map< CFBamValuePKey,
					CFBamDbKeyHash160TypeBuff >> dictBySchemaIdx
		= new HashMap< CFBamDbKeyHash160TypeBySchemaIdxKey,
				Map< CFBamValuePKey,
					CFBamDbKeyHash160TypeBuff >>();

	public CFBamRamDbKeyHash160TypeTable( ICFBamSchema argSchema ) {
		schema = argSchema;
	}

	public void createDbKeyHash160Type( CFSecAuthorization Authorization,
		CFBamDbKeyHash160TypeBuff Buff )
	{
		final String S_ProcName = "createDbKeyHash160Type";
		CFBamValueBuff tail = null;
		if( Buff.getClassCode().equals( "a841" ) ) {
		...
		schema.getTableDbKeyHash160Def().createDbKeyHash160Def( Authorization,
			Buff );
		CFBamValuePKey pkey = schema.getFactoryValue().newPKey();
		pkey.setClassCode( Buff.getClassCode() );
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
		CFBamDbKeyHash160TypeBySchemaIdxKey keySchemaIdx = schema.getFactoryDbKeyHash160Type().newSchemaIdxKey();
...

		{
			...
			allNull = false;
			if( ! allNull ) {
				if( null == schema.getTableDbKeyHash160Def().readDerivedByIdIdx( Authorization,
						Buff.getRequiredTenantId(),
						Buff.getRequiredId() ) )
				{
		...
		Map< CFBamValuePKey, CFBamDbKeyHash160TypeBuff > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< CFBamValuePKey, CFBamDbKeyHash160TypeBuff >();
	...
	public CFBamDbKeyHash160TypeBuff readDerived( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash160Type.readDerived";
	...
	public CFBamDbKeyHash160TypeBuff lockDerived( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash160Type.readDerived";
		CFBamValuePKey key = schema.getFactoryValue().newPKey();
	...
	public CFBamDbKeyHash160TypeBuff[] readAllDerived( CFSecAuthorization Authorization ) {
		final String S_ProcName = "CFBamRamDbKeyHash160Type.readAllDerived";
		CFBamDbKeyHash160TypeBuff[] retList = new CFBamDbKeyHash160TypeBuff[ dictByPKey.values().size() ];
		Iterator< CFBamDbKeyHash160TypeBuff > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
	...
	public CFBamDbKeyHash160TypeBuff readDerivedByUNameIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		String Name )
	{
		...
		else if( buff instanceof CFBamDbKeyHash160TypeBuff ) {
			return( (CFBamDbKeyHash160TypeBuff)buff );
		}
		else {
			return( null );
		}
	...
	public CFBamDbKeyHash160TypeBuff[] readDerivedByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		...
		if( buffList == null ) {
			...
			CFBamValueBuff buff;
			ArrayList<CFBamDbKeyHash160TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash160TypeBuff>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof CFBamDbKeyHash160TypeBuff ) ) {
					filteredList.add( (CFBamDbKeyHash160TypeBuff)buff );
				}
			}
			return( filteredList.toArray( new CFBamDbKeyHash160TypeBuff[0] ) );
		}
	}

	public CFBamDbKeyHash160TypeBuff[] readDerivedByScopeIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId )
	{
	...
	public CFBamDbKeyHash160TypeBuff[] readDerivedByDefSchemaIdx( CFSecAuthorization Authorization,
	...
	public CFBamDbKeyHash160TypeBuff[] readDerivedByPrevIdx( CFSecAuthorization Authorization,
		Long PrevTenantId,
		Long PrevId )
	{
	...
	public CFBamDbKeyHash160TypeBuff[] readDerivedByNextIdx( CFSecAuthorization Authorization,
		Long NextTenantId,
		Long NextId )
	{
	...
	public CFBamDbKeyHash160TypeBuff[] readDerivedByContPrevIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long PrevId )
	{
	...
	public CFBamDbKeyHash160TypeBuff[] readDerivedByContNextIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long NextId )
	{
	...
	public CFBamDbKeyHash160TypeBuff[] readDerivedByCodeVisIdx( CFSecAuthorization Authorization,
	...
	public CFBamDbKeyHash160TypeBuff[] readDerivedByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
	...
	public CFBamDbKeyHash160TypeBuff[] readDerivedBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId )
	{
		...
		CFBamDbKeyHash160TypeBuff[] recArray;
		if( dictBySchemaIdx.containsKey( key ) ) {
			Map< CFBamValuePKey, CFBamDbKeyHash160TypeBuff > subdictSchemaIdx
				= dictBySchemaIdx.get( key );
			recArray = new CFBamDbKeyHash160TypeBuff[ subdictSchemaIdx.size() ];
			Iterator< CFBamDbKeyHash160TypeBuff > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< CFBamValuePKey, CFBamDbKeyHash160TypeBuff > subdictSchemaIdx
				= new HashMap< CFBamValuePKey, CFBamDbKeyHash160TypeBuff >();
			dictBySchemaIdx.put( key, subdictSchemaIdx );
			recArray = new CFBamDbKeyHash160TypeBuff[0];
		}
		return( recArray );
	}

	public CFBamDbKeyHash160TypeBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		long TenantId,
		long Id )
	{
	...
	public CFBamDbKeyHash160TypeBuff readBuff( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash160Type.readBuff";
		CFBamDbKeyHash160TypeBuff buff = readDerived( Authorization, PKey );
	...
	public CFBamDbKeyHash160TypeBuff lockBuff( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
	...
	public CFBamDbKeyHash160TypeBuff[] readAllBuff( CFSecAuthorization Authorization )
	{
		final String S_ProcName = "CFBamRamDbKeyHash160Type.readAllBuff";
		CFBamDbKeyHash160TypeBuff buff;
		ArrayList<CFBamDbKeyHash160TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash160TypeBuff>();
		CFBamDbKeyHash160TypeBuff[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a841" ) ) {
	...
	public CFBamDbKeyHash160TypeBuff readBuffByIdIdx( CFSecAuthorization Authorization,
		long TenantId,
		long Id )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByIdIdx() ";
		CFBamDbKeyHash160TypeBuff buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
	...
	public CFBamDbKeyHash160TypeBuff readBuffByUNameIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		String Name )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByUNameIdx() ";
		CFBamDbKeyHash160TypeBuff buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash160TypeBuff[] readBuffByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByValTentIdx() ";
		CFBamDbKeyHash160TypeBuff buff;
		ArrayList<CFBamDbKeyHash160TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash160TypeBuff>();
		CFBamDbKeyHash160TypeBuff[] buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash160TypeBuff[] readBuffByScopeIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId )
	{
		...
		CFBamDbKeyHash160TypeBuff buff;
		ArrayList<CFBamDbKeyHash160TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash160TypeBuff>();
		CFBamDbKeyHash160TypeBuff[] buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash160TypeBuff[] readBuffByDefSchemaIdx( CFSecAuthorization Authorization,
		Long DefSchemaTenantId,
		Long DefSchemaId )
	{
		...
		CFBamDbKeyHash160TypeBuff buff;
		ArrayList<CFBamDbKeyHash160TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash160TypeBuff>();
		CFBamDbKeyHash160TypeBuff[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash160TypeBuff[] readBuffByPrevIdx( CFSecAuthorization Authorization,
		Long PrevTenantId,
		Long PrevId )
	{
		...
		CFBamDbKeyHash160TypeBuff buff;
		ArrayList<CFBamDbKeyHash160TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash160TypeBuff>();
		CFBamDbKeyHash160TypeBuff[] buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash160TypeBuff[] readBuffByNextIdx( CFSecAuthorization Authorization,
		Long NextTenantId,
		Long NextId )
	{
		...
		CFBamDbKeyHash160TypeBuff buff;
		ArrayList<CFBamDbKeyHash160TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash160TypeBuff>();
		CFBamDbKeyHash160TypeBuff[] buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash160TypeBuff[] readBuffByContPrevIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long PrevId )
	{
		...
		CFBamDbKeyHash160TypeBuff buff;
		ArrayList<CFBamDbKeyHash160TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash160TypeBuff>();
		CFBamDbKeyHash160TypeBuff[] buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash160TypeBuff[] readBuffByContNextIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long NextId )
	{
		...
		CFBamDbKeyHash160TypeBuff buff;
		ArrayList<CFBamDbKeyHash160TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash160TypeBuff>();
		CFBamDbKeyHash160TypeBuff[] buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash160TypeBuff[] readBuffByCodeVisIdx( CFSecAuthorization Authorization,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByCodeVisIdx() ";
		CFBamDbKeyHash160TypeBuff buff;
		ArrayList<CFBamDbKeyHash160TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash160TypeBuff>();
		CFBamDbKeyHash160TypeBuff[] buffList = readDerivedByCodeVisIdx( Authorization,
			CodeVis );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash160TypeBuff[] readBuffByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		...
		CFBamDbKeyHash160TypeBuff buff;
		ArrayList<CFBamDbKeyHash160TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash160TypeBuff>();
		CFBamDbKeyHash160TypeBuff[] buffList = readDerivedByScopeCodeVisIdx( Authorization,
			TenantId,
			ScopeId,
			CodeVis );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash160TypeBuff[] readBuffBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId )
	{
		...
		CFBamDbKeyHash160TypeBuff buff;
		ArrayList<CFBamDbKeyHash160TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash160TypeBuff>();
		CFBamDbKeyHash160TypeBuff[] buffList = readDerivedBySchemaIdx( Authorization,
			TenantId,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	/**
	 *	Read a page array of the specific DbKeyHash160Type buffer instances identified by the duplicate key SchemaIdx.
	 *
	 ...
	 */
	public CFBamDbKeyHash160TypeBuff[] pageBuffBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId,
		Long priorTenantId,
		Long priorId )
	 ...
	 */
	public CFBamDbKeyHash160TypeBuff moveBuffUp( CFSecAuthorization Authorization,
		long TenantId,
		long Id,
		int revision )
	{
		...
		{
			return( (CFBamDbKeyHash160TypeBuff)cur );
		}
		...
		return( (CFBamDbKeyHash160TypeBuff)editCur );
	}
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public CFBamDbKeyHash160TypeBuff moveBuffDown( CFSecAuthorization Authorization,
		long TenantId,
		long Id,
		int revision )
	{
	...
	public void updateDbKeyHash160Type( CFSecAuthorization Authorization,
		CFBamDbKeyHash160TypeBuff Buff )
	{
		schema.getTableDbKeyHash160Def().updateDbKeyHash160Def( Authorization,
			Buff );
		CFBamValuePKey pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
		CFBamDbKeyHash160TypeBuff existing = dictByPKey.get( pkey );
		if( existing == null ) {
			throw new CFLibStaleCacheDetectedException( getClass(),
				"updateDbKeyHash160Type",
				"Existing record not found",
				"DbKeyHash160Type",
				pkey );
		}
		CFBamDbKeyHash160TypeBySchemaIdxKey existingKeySchemaIdx = schema.getFactoryDbKeyHash160Type().newSchemaIdxKey();
		...
		CFBamDbKeyHash160TypeBySchemaIdxKey newKeySchemaIdx = schema.getFactoryDbKeyHash160Type().newSchemaIdxKey();
		...
		Map< CFBamValuePKey, CFBamDbKeyHash160TypeBuff > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< CFBamValuePKey, CFBamDbKeyHash160TypeBuff >();
	...
	public void deleteDbKeyHash160Type( CFSecAuthorization Authorization,
		CFBamDbKeyHash160TypeBuff Buff )
	{
		final String S_ProcName = "CFBamRamDbKeyHash160TypeTable.deleteDbKeyHash160Type() ";
		String classCode;
		CFBamValuePKey pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
		...
		if( schema.getTableDbKeyHash160Gen().readDerivedByIdIdx( Authorization,
					existing.getRequiredTenantId(),
		...
		schema.getTableDbKeyHash160Def().deleteDbKeyHash160Def( Authorization,
			Buff );
	}
	public void deleteDbKeyHash160TypeBySchemaIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argSchemaDefId )
	{
		CFBamDbKeyHash160TypeBySchemaIdxKey key = schema.getFactoryDbKeyHash160Type().newSchemaIdxKey();
		...
		deleteDbKeyHash160TypeBySchemaIdx( Authorization, key );
	}
		...
		CFBamDbKeyHash160TypeBySchemaIdxKey argKey )
	{
		...
		LinkedList<CFBamDbKeyHash160TypeBuff> matchSet = new LinkedList<CFBamDbKeyHash160TypeBuff>();
		Iterator<CFBamDbKeyHash160TypeBuff> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamDbKeyHash160TypeBuff> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = schema.getTableDbKeyHash160Type().readDerivedByIdIdx( Authorization,
				cur.getRequiredTenantId(),
				cur.getRequiredId() );
			String subClassCode = cur.getClassCode();
			if( "a841".equals( subClassCode ) ) {
				schema.getTableDbKeyHash160Type().deleteDbKeyHash160Type( Authorization, cur );
			}
				...
				throw new CFLibUnsupportedClassException( getClass(),
					...
					"subClassCode",
					cur,
					"Instance of or subclass of DbKeyHash160Type must not be \"" + subClassCode + "\"" );
			}
		}
	}

	public void deleteDbKeyHash160TypeByIdIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argId )
	{
		CFBamValuePKey key = schema.getFactoryValue().newPKey();
		...
		deleteDbKeyHash160TypeByIdIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash160TypeByUNameIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		String argName )
	{
		...
		deleteDbKeyHash160TypeByUNameIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash160TypeByValTentIdx( CFSecAuthorization Authorization,
		long argTenantId )
	{
		CFBamValueByValTentIdxKey key = schema.getFactoryValue().newValTentIdxKey();
		key.setRequiredTenantId( argTenantId );
		deleteDbKeyHash160TypeByValTentIdx( Authorization, key );
	}

	public void deleteDbKeyHash160TypeByValTentIdx( CFSecAuthorization Authorization,
		CFBamValueByValTentIdxKey argKey )
	{
		final String S_ProcName = "deleteDbKeyHash160TypeByValTentIdx";
		CFBamDbKeyHash160TypeBuff cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
	...
	public void deleteDbKeyHash160TypeByScopeIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId )
	{
		...
		key.setRequiredTenantId( argTenantId );
		key.setRequiredScopeId( argScopeId );
		deleteDbKeyHash160TypeByScopeIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash160TypeByDefSchemaIdx( CFSecAuthorization Authorization,
		...
		Long argDefSchemaId )
	{
		...
		deleteDbKeyHash160TypeByDefSchemaIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash160TypeByPrevIdx( CFSecAuthorization Authorization,
		...
		Long argPrevId )
	{
		...
		deleteDbKeyHash160TypeByPrevIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash160TypeByNextIdx( CFSecAuthorization Authorization,
		...
		Long argNextId )
	{
		...
		deleteDbKeyHash160TypeByNextIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash160TypeByContPrevIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		Long argPrevId )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setOptionalPrevId( argPrevId );
		deleteDbKeyHash160TypeByContPrevIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash160TypeByContNextIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		Long argNextId )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setOptionalNextId( argNextId );
		deleteDbKeyHash160TypeByContNextIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash160TypeByCodeVisIdx( CFSecAuthorization Authorization,
		ICFBamSchema.CodeVisibilityEnum argCodeVis )
	{
		...
		deleteDbKeyHash160TypeByCodeVisIdx( Authorization, key );
	}

	public void deleteDbKeyHash160TypeByCodeVisIdx( CFSecAuthorization Authorization,
		CFBamValueByCodeVisIdxKey argKey )
	{
		final String S_ProcName = "deleteDbKeyHash160TypeByCodeVisIdx";
		CFBamDbKeyHash160TypeBuff cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
	...
	public void deleteDbKeyHash160TypeByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		ICFBamSchema.CodeVisibilityEnum argCodeVis )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setRequiredCodeVis( argCodeVis );
		deleteDbKeyHash160TypeByScopeCodeVisIdx( Authorization, key );
	}

	public void deleteDbKeyHash160TypeByScopeCodeVisIdx( CFSecAuthorization Authorization,
		CFBamValueByScopeCodeVisIdxKey argKey )
	{
		final String S_ProcName = "deleteDbKeyHash160TypeByScopeCodeVisIdx";
		CFBamDbKeyHash160TypeBuff cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		anyNotNull = true;
