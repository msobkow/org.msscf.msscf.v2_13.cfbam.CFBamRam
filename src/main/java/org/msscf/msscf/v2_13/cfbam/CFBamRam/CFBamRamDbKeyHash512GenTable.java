...
// Description: Java 11 in-memory RAM DbIO implementation for DbKeyHash512Gen.
...
/*
 *	CFBamRamDbKeyHash512GenTable in-memory RAM DbIO implementation
 *	for DbKeyHash512Gen.
 */
public class CFBamRamDbKeyHash512GenTable
	implements ICFBamDbKeyHash512GenTable
{
	private ICFBamSchema schema;
	private Map< CFBamValuePKey,
				CFBamDbKeyHash512GenBuff > dictByPKey
		= new HashMap< CFBamValuePKey,
				CFBamDbKeyHash512GenBuff >();
	private Map< CFBamDbKeyHash512GenByDispIdxKey,
				Map< CFBamValuePKey,
					CFBamDbKeyHash512GenBuff >> dictByDispIdx
		= new HashMap< CFBamDbKeyHash512GenByDispIdxKey,
				Map< CFBamValuePKey,
					CFBamDbKeyHash512GenBuff >>();

	public CFBamRamDbKeyHash512GenTable( ICFBamSchema argSchema ) {
		schema = argSchema;
	}

	public void createDbKeyHash512Gen( CFSecAuthorization Authorization,
		CFBamDbKeyHash512GenBuff Buff )
	{
		final String S_ProcName = "createDbKeyHash512Gen";
		...
		schema.getTableDbKeyHash512Type().createDbKeyHash512Type( Authorization,
			Buff );
		CFBamValuePKey pkey = schema.getFactoryValue().newPKey();
		pkey.setClassCode( Buff.getClassCode() );
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
		CFBamDbKeyHash512GenByDispIdxKey keyDispIdx = schema.getFactoryDbKeyHash512Gen().newDispIdxKey();
...

		{
			...
			allNull = false;
			if( ! allNull ) {
				if( null == schema.getTableDbKeyHash512Type().readDerivedByIdIdx( Authorization,
						Buff.getRequiredTenantId(),
						Buff.getRequiredId() ) )
				{
		...
		Map< CFBamValuePKey, CFBamDbKeyHash512GenBuff > subdictDispIdx;
		if( dictByDispIdx.containsKey( keyDispIdx ) ) {
			subdictDispIdx = dictByDispIdx.get( keyDispIdx );
		}
		else {
			subdictDispIdx = new HashMap< CFBamValuePKey, CFBamDbKeyHash512GenBuff >();
	...
	public CFBamDbKeyHash512GenBuff readDerived( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash512Gen.readDerived";
	...
	public CFBamDbKeyHash512GenBuff lockDerived( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash512Gen.readDerived";
		CFBamValuePKey key = schema.getFactoryValue().newPKey();
	...
	public CFBamDbKeyHash512GenBuff[] readAllDerived( CFSecAuthorization Authorization ) {
		final String S_ProcName = "CFBamRamDbKeyHash512Gen.readAllDerived";
		CFBamDbKeyHash512GenBuff[] retList = new CFBamDbKeyHash512GenBuff[ dictByPKey.values().size() ];
		Iterator< CFBamDbKeyHash512GenBuff > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
	...
	public CFBamDbKeyHash512GenBuff readDerivedByUNameIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		String Name )
	{
		...
		else if( buff instanceof CFBamDbKeyHash512GenBuff ) {
			return( (CFBamDbKeyHash512GenBuff)buff );
		}
		else {
			return( null );
		}
	...
	public CFBamDbKeyHash512GenBuff[] readDerivedByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		...
		if( buffList == null ) {
			...
			CFBamValueBuff buff;
			ArrayList<CFBamDbKeyHash512GenBuff> filteredList = new ArrayList<CFBamDbKeyHash512GenBuff>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof CFBamDbKeyHash512GenBuff ) ) {
					filteredList.add( (CFBamDbKeyHash512GenBuff)buff );
				}
			}
			return( filteredList.toArray( new CFBamDbKeyHash512GenBuff[0] ) );
		}
	}

	public CFBamDbKeyHash512GenBuff[] readDerivedByScopeIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId )
	{
	...
	public CFBamDbKeyHash512GenBuff[] readDerivedByDefSchemaIdx( CFSecAuthorization Authorization,
	...
	public CFBamDbKeyHash512GenBuff[] readDerivedByPrevIdx( CFSecAuthorization Authorization,
		Long PrevTenantId,
		Long PrevId )
	{
	...
	public CFBamDbKeyHash512GenBuff[] readDerivedByNextIdx( CFSecAuthorization Authorization,
		Long NextTenantId,
		Long NextId )
	{
	...
	public CFBamDbKeyHash512GenBuff[] readDerivedByContPrevIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long PrevId )
	{
	...
	public CFBamDbKeyHash512GenBuff[] readDerivedByContNextIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long NextId )
	{
	...
	public CFBamDbKeyHash512GenBuff[] readDerivedByCodeVisIdx( CFSecAuthorization Authorization,
	...
	public CFBamDbKeyHash512GenBuff[] readDerivedByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
	...
	public CFBamDbKeyHash512GenBuff[] readDerivedBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId )
	{
		final String S_ProcName = "CFBamRamDbKeyHash512Type.readDerivedBySchemaIdx";
		CFBamDbKeyHash512TypeBuff buffList[] = schema.getTableDbKeyHash512Type().readDerivedBySchemaIdx( Authorization,
			TenantId,
			SchemaDefId );
		if( buffList == null ) {
			return( null );
	...
	public CFBamDbKeyHash512GenBuff[] readDerivedByDispIdx( CFSecAuthorization Authorization,
		Long DispenserTenantId,
		Long DispenserId )
	{
		final String S_ProcName = "CFBamRamDbKeyHash512Gen.readDerivedByDispIdx";
		CFBamDbKeyHash512GenByDispIdxKey key = schema.getFactoryDbKeyHash512Gen().newDispIdxKey();
		key.setOptionalDispenserTenantId( DispenserTenantId );
		key.setOptionalDispenserId( DispenserId );

		CFBamDbKeyHash512GenBuff[] recArray;
		if( dictByDispIdx.containsKey( key ) ) {
			Map< CFBamValuePKey, CFBamDbKeyHash512GenBuff > subdictDispIdx
				= dictByDispIdx.get( key );
			recArray = new CFBamDbKeyHash512GenBuff[ subdictDispIdx.size() ];
			Iterator< CFBamDbKeyHash512GenBuff > iter = subdictDispIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< CFBamValuePKey, CFBamDbKeyHash512GenBuff > subdictDispIdx
				= new HashMap< CFBamValuePKey, CFBamDbKeyHash512GenBuff >();
			dictByDispIdx.put( key, subdictDispIdx );
			recArray = new CFBamDbKeyHash512GenBuff[0];
		}
		return( recArray );
	}

	public CFBamDbKeyHash512GenBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		long TenantId,
		long Id )
	{
	...
	public CFBamDbKeyHash512GenBuff readBuff( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash512Gen.readBuff";
		CFBamDbKeyHash512GenBuff buff = readDerived( Authorization, PKey );
	...
	public CFBamDbKeyHash512GenBuff lockBuff( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
	...
	public CFBamDbKeyHash512GenBuff[] readAllBuff( CFSecAuthorization Authorization )
	{
		final String S_ProcName = "CFBamRamDbKeyHash512Gen.readAllBuff";
		CFBamDbKeyHash512GenBuff buff;
		ArrayList<CFBamDbKeyHash512GenBuff> filteredList = new ArrayList<CFBamDbKeyHash512GenBuff>();
		CFBamDbKeyHash512GenBuff[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a852" ) ) {
	...
	public CFBamDbKeyHash512GenBuff readBuffByIdIdx( CFSecAuthorization Authorization,
		long TenantId,
		long Id )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByIdIdx() ";
		CFBamDbKeyHash512GenBuff buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
	...
	public CFBamDbKeyHash512GenBuff readBuffByUNameIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		String Name )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByUNameIdx() ";
		CFBamDbKeyHash512GenBuff buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash512GenBuff[] readBuffByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByValTentIdx() ";
		CFBamDbKeyHash512GenBuff buff;
		ArrayList<CFBamDbKeyHash512GenBuff> filteredList = new ArrayList<CFBamDbKeyHash512GenBuff>();
		CFBamDbKeyHash512GenBuff[] buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash512GenBuff[] readBuffByScopeIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId )
	{
		...
		CFBamDbKeyHash512GenBuff buff;
		ArrayList<CFBamDbKeyHash512GenBuff> filteredList = new ArrayList<CFBamDbKeyHash512GenBuff>();
		CFBamDbKeyHash512GenBuff[] buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash512GenBuff[] readBuffByDefSchemaIdx( CFSecAuthorization Authorization,
		Long DefSchemaTenantId,
		Long DefSchemaId )
	{
		...
		CFBamDbKeyHash512GenBuff buff;
		ArrayList<CFBamDbKeyHash512GenBuff> filteredList = new ArrayList<CFBamDbKeyHash512GenBuff>();
		CFBamDbKeyHash512GenBuff[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash512GenBuff[] readBuffByPrevIdx( CFSecAuthorization Authorization,
		Long PrevTenantId,
		Long PrevId )
	{
		...
		CFBamDbKeyHash512GenBuff buff;
		ArrayList<CFBamDbKeyHash512GenBuff> filteredList = new ArrayList<CFBamDbKeyHash512GenBuff>();
		CFBamDbKeyHash512GenBuff[] buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash512GenBuff[] readBuffByNextIdx( CFSecAuthorization Authorization,
		Long NextTenantId,
		Long NextId )
	{
		...
		CFBamDbKeyHash512GenBuff buff;
		ArrayList<CFBamDbKeyHash512GenBuff> filteredList = new ArrayList<CFBamDbKeyHash512GenBuff>();
		CFBamDbKeyHash512GenBuff[] buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash512GenBuff[] readBuffByContPrevIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long PrevId )
	{
		...
		CFBamDbKeyHash512GenBuff buff;
		ArrayList<CFBamDbKeyHash512GenBuff> filteredList = new ArrayList<CFBamDbKeyHash512GenBuff>();
		CFBamDbKeyHash512GenBuff[] buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash512GenBuff[] readBuffByContNextIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long NextId )
	{
		...
		CFBamDbKeyHash512GenBuff buff;
		ArrayList<CFBamDbKeyHash512GenBuff> filteredList = new ArrayList<CFBamDbKeyHash512GenBuff>();
		CFBamDbKeyHash512GenBuff[] buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash512GenBuff[] readBuffByCodeVisIdx( CFSecAuthorization Authorization,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByCodeVisIdx() ";
		CFBamDbKeyHash512GenBuff buff;
		ArrayList<CFBamDbKeyHash512GenBuff> filteredList = new ArrayList<CFBamDbKeyHash512GenBuff>();
		CFBamDbKeyHash512GenBuff[] buffList = readDerivedByCodeVisIdx( Authorization,
			CodeVis );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash512GenBuff[] readBuffByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		...
		CFBamDbKeyHash512GenBuff buff;
		ArrayList<CFBamDbKeyHash512GenBuff> filteredList = new ArrayList<CFBamDbKeyHash512GenBuff>();
		CFBamDbKeyHash512GenBuff[] buffList = readDerivedByScopeCodeVisIdx( Authorization,
			TenantId,
			ScopeId,
			CodeVis );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash512GenBuff[] readBuffBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId )
	{
		final String S_ProcName = "CFBamRamDbKeyHash512Type.readBuffBySchemaIdx() ";
		CFBamDbKeyHash512GenBuff buff;
		ArrayList<CFBamDbKeyHash512GenBuff> filteredList = new ArrayList<CFBamDbKeyHash512GenBuff>();
		CFBamDbKeyHash512GenBuff[] buffList = readDerivedBySchemaIdx( Authorization,
			TenantId,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash512GenBuff[] readBuffByDispIdx( CFSecAuthorization Authorization,
		Long DispenserTenantId,
		Long DispenserId )
	{
		final String S_ProcName = "CFBamRamDbKeyHash512Gen.readBuffByDispIdx() ";
		CFBamDbKeyHash512GenBuff buff;
		ArrayList<CFBamDbKeyHash512GenBuff> filteredList = new ArrayList<CFBamDbKeyHash512GenBuff>();
		CFBamDbKeyHash512GenBuff[] buffList = readDerivedByDispIdx( Authorization,
			DispenserTenantId,
			DispenserId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	/**
	 *	Read a page array of the specific DbKeyHash512Gen buffer instances identified by the duplicate key SchemaIdx.
	 *
	 ...
	 */
	public CFBamDbKeyHash512GenBuff[] pageBuffBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId,
		Long priorTenantId,
		Long priorId )
	...
	/**
	 *	Read a page array of the specific DbKeyHash512Gen buffer instances identified by the duplicate key DispIdx.
	 *
	 *	@param	Authorization	The session authorization information.
	 *
	 ...
	 *	@throws	CFLibNotSupportedException thrown by client-side implementations.
	 */
	public CFBamDbKeyHash512GenBuff[] pageBuffByDispIdx( CFSecAuthorization Authorization,
		Long DispenserTenantId,
		Long DispenserId,
		Long priorTenantId,
		Long priorId )
	 ...
	 */
	public CFBamDbKeyHash512GenBuff moveBuffUp( CFSecAuthorization Authorization,
		long TenantId,
		long Id,
		int revision )
	{
		...
		{
			return( (CFBamDbKeyHash512GenBuff)cur );
		}
		...
		return( (CFBamDbKeyHash512GenBuff)editCur );
	}
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public CFBamDbKeyHash512GenBuff moveBuffDown( CFSecAuthorization Authorization,
		long TenantId,
		long Id,
		int revision )
	{
	...
	public void updateDbKeyHash512Gen( CFSecAuthorization Authorization,
		CFBamDbKeyHash512GenBuff Buff )
	{
		schema.getTableDbKeyHash512Type().updateDbKeyHash512Type( Authorization,
			Buff );
		CFBamValuePKey pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
		CFBamDbKeyHash512GenBuff existing = dictByPKey.get( pkey );
		if( existing == null ) {
			throw new CFLibStaleCacheDetectedException( getClass(),
				"updateDbKeyHash512Gen",
				"Existing record not found",
				"DbKeyHash512Gen",
				pkey );
		}
		CFBamDbKeyHash512GenByDispIdxKey existingKeyDispIdx = schema.getFactoryDbKeyHash512Gen().newDispIdxKey();
		...
		CFBamDbKeyHash512GenByDispIdxKey newKeyDispIdx = schema.getFactoryDbKeyHash512Gen().newDispIdxKey();
		...
		Map< CFBamValuePKey, CFBamDbKeyHash512GenBuff > subdict;
		...
		if( dictByDispIdx.containsKey( newKeyDispIdx ) ) {
			...
			subdict = new HashMap< CFBamValuePKey, CFBamDbKeyHash512GenBuff >();
	...
	public void deleteDbKeyHash512Gen( CFSecAuthorization Authorization,
		CFBamDbKeyHash512GenBuff Buff )
	{
		final String S_ProcName = "CFBamRamDbKeyHash512GenTable.deleteDbKeyHash512Gen() ";
		String classCode;
		CFBamValuePKey pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
		...
		schema.getTableDbKeyHash512Type().deleteDbKeyHash512Type( Authorization,
			Buff );
	}
	public void deleteDbKeyHash512GenByDispIdx( CFSecAuthorization Authorization,
		...
		Long argDispenserId )
	{
		...
		deleteDbKeyHash512GenByDispIdx( Authorization, key );
	}

	public void deleteDbKeyHash512GenByDispIdx( CFSecAuthorization Authorization,
		CFBamDbKeyHash512GenByDispIdxKey argKey )
	{
		CFBamDbKeyHash512GenBuff cur;
		...
		LinkedList<CFBamDbKeyHash512GenBuff> matchSet = new LinkedList<CFBamDbKeyHash512GenBuff>();
		Iterator<CFBamDbKeyHash512GenBuff> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamDbKeyHash512GenBuff> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = schema.getTableDbKeyHash512Gen().readDerivedByIdIdx( Authorization,
				cur.getRequiredTenantId(),
				cur.getRequiredId() );
			deleteDbKeyHash512Gen( Authorization, cur );
		}
	}

	public void deleteDbKeyHash512GenBySchemaIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argSchemaDefId )
	{
		CFBamDbKeyHash512TypeBySchemaIdxKey key = schema.getFactoryDbKeyHash512Type().newSchemaIdxKey();
		key.setRequiredTenantId( argTenantId );
		key.setRequiredSchemaDefId( argSchemaDefId );
		deleteDbKeyHash512GenBySchemaIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash512GenByIdIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argId )
	{
		CFBamValuePKey key = schema.getFactoryValue().newPKey();
		...
		deleteDbKeyHash512GenByIdIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash512GenByUNameIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		String argName )
	{
		...
		deleteDbKeyHash512GenByUNameIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash512GenByValTentIdx( CFSecAuthorization Authorization,
		long argTenantId )
	{
		CFBamValueByValTentIdxKey key = schema.getFactoryValue().newValTentIdxKey();
		key.setRequiredTenantId( argTenantId );
		deleteDbKeyHash512GenByValTentIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash512GenByScopeIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId )
	{
		...
		key.setRequiredTenantId( argTenantId );
		key.setRequiredScopeId( argScopeId );
		deleteDbKeyHash512GenByScopeIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash512GenByDefSchemaIdx( CFSecAuthorization Authorization,
		...
		Long argDefSchemaId )
	{
		...
		deleteDbKeyHash512GenByDefSchemaIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash512GenByPrevIdx( CFSecAuthorization Authorization,
		...
		Long argPrevId )
	{
		...
		deleteDbKeyHash512GenByPrevIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash512GenByNextIdx( CFSecAuthorization Authorization,
		...
		Long argNextId )
	{
		...
		deleteDbKeyHash512GenByNextIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash512GenByContPrevIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		Long argPrevId )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setOptionalPrevId( argPrevId );
		deleteDbKeyHash512GenByContPrevIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash512GenByContNextIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		Long argNextId )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setOptionalNextId( argNextId );
		deleteDbKeyHash512GenByContNextIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash512GenByCodeVisIdx( CFSecAuthorization Authorization,
		ICFBamSchema.CodeVisibilityEnum argCodeVis )
	{
		...
		deleteDbKeyHash512GenByCodeVisIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash512GenByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		ICFBamSchema.CodeVisibilityEnum argCodeVis )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setRequiredCodeVis( argCodeVis );
		deleteDbKeyHash512GenByScopeCodeVisIdx( Authorization, key );
	}
