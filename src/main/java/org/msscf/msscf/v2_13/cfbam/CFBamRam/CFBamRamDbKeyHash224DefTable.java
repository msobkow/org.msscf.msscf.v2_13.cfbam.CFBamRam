...
// Description: Java 11 in-memory RAM DbIO implementation for DbKeyHash224Def.
...
/*
 *	CFBamRamDbKeyHash224DefTable in-memory RAM DbIO implementation
 *	for DbKeyHash224Def.
 */
public class CFBamRamDbKeyHash224DefTable
	implements ICFBamDbKeyHash224DefTable
{
	private ICFBamSchema schema;
	private Map< CFBamValuePKey,
				CFBamDbKeyHash224DefBuff > dictByPKey
		= new HashMap< CFBamValuePKey,
				CFBamDbKeyHash224DefBuff >();

	public CFBamRamDbKeyHash224DefTable( ICFBamSchema argSchema ) {
		schema = argSchema;
	}

	public void createDbKeyHash224Def( CFSecAuthorization Authorization,
	...
	public CFBamDbKeyHash224DefBuff readDerived( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
	...
	public CFBamDbKeyHash224DefBuff lockDerived( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash224Def.readDerived";
		CFBamValuePKey key = schema.getFactoryValue().newPKey();
	...
	public CFBamDbKeyHash224DefBuff[] readAllDerived( CFSecAuthorization Authorization ) {
		final String S_ProcName = "CFBamRamDbKeyHash224Def.readAllDerived";
		CFBamDbKeyHash224DefBuff[] retList = new CFBamDbKeyHash224DefBuff[ dictByPKey.values().size() ];
		Iterator< CFBamDbKeyHash224DefBuff > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
	...
	public CFBamDbKeyHash224DefBuff readDerivedByUNameIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		String Name )
	{
		...
		else if( buff instanceof CFBamDbKeyHash224DefBuff ) {
			return( (CFBamDbKeyHash224DefBuff)buff );
		}
		else {
			return( null );
		}
	...
	public CFBamDbKeyHash224DefBuff[] readDerivedByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		...
		if( buffList == null ) {
			...
			CFBamValueBuff buff;
			ArrayList<CFBamDbKeyHash224DefBuff> filteredList = new ArrayList<CFBamDbKeyHash224DefBuff>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof CFBamDbKeyHash224DefBuff ) ) {
					filteredList.add( (CFBamDbKeyHash224DefBuff)buff );
				}
			}
			return( filteredList.toArray( new CFBamDbKeyHash224DefBuff[0] ) );
		}
	}

	public CFBamDbKeyHash224DefBuff[] readDerivedByScopeIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId )
	{
	...
	public CFBamDbKeyHash224DefBuff[] readDerivedByDefSchemaIdx( CFSecAuthorization Authorization,
	...
	public CFBamDbKeyHash224DefBuff[] readDerivedByPrevIdx( CFSecAuthorization Authorization,
		Long PrevTenantId,
		Long PrevId )
	{
	...
	public CFBamDbKeyHash224DefBuff[] readDerivedByNextIdx( CFSecAuthorization Authorization,
		Long NextTenantId,
		Long NextId )
	{
	...
	public CFBamDbKeyHash224DefBuff[] readDerivedByContPrevIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long PrevId )
	{
	...
	public CFBamDbKeyHash224DefBuff[] readDerivedByContNextIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long NextId )
	{
	...
	public CFBamDbKeyHash224DefBuff[] readDerivedByCodeVisIdx( CFSecAuthorization Authorization,
	...
	public CFBamDbKeyHash224DefBuff[] readDerivedByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
	...
	public CFBamDbKeyHash224DefBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		long TenantId,
		long Id )
	{
	...
	public CFBamDbKeyHash224DefBuff readBuff( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash224Def.readBuff";
		CFBamDbKeyHash224DefBuff buff = readDerived( Authorization, PKey );
	...
	public CFBamDbKeyHash224DefBuff lockBuff( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
	...
	public CFBamDbKeyHash224DefBuff[] readAllBuff( CFSecAuthorization Authorization )
	{
		final String S_ProcName = "CFBamRamDbKeyHash224Def.readAllBuff";
		CFBamDbKeyHash224DefBuff buff;
		ArrayList<CFBamDbKeyHash224DefBuff> filteredList = new ArrayList<CFBamDbKeyHash224DefBuff>();
		CFBamDbKeyHash224DefBuff[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a843" ) ) {
	...
	public CFBamDbKeyHash224DefBuff readBuffByIdIdx( CFSecAuthorization Authorization,
		long TenantId,
		long Id )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByIdIdx() ";
		CFBamDbKeyHash224DefBuff buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
	...
	public CFBamDbKeyHash224DefBuff readBuffByUNameIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		String Name )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByUNameIdx() ";
		CFBamDbKeyHash224DefBuff buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash224DefBuff[] readBuffByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByValTentIdx() ";
		CFBamDbKeyHash224DefBuff buff;
		ArrayList<CFBamDbKeyHash224DefBuff> filteredList = new ArrayList<CFBamDbKeyHash224DefBuff>();
		CFBamDbKeyHash224DefBuff[] buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash224DefBuff[] readBuffByScopeIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId )
	{
		...
		CFBamDbKeyHash224DefBuff buff;
		ArrayList<CFBamDbKeyHash224DefBuff> filteredList = new ArrayList<CFBamDbKeyHash224DefBuff>();
		CFBamDbKeyHash224DefBuff[] buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash224DefBuff[] readBuffByDefSchemaIdx( CFSecAuthorization Authorization,
		Long DefSchemaTenantId,
		Long DefSchemaId )
	{
		...
		CFBamDbKeyHash224DefBuff buff;
		ArrayList<CFBamDbKeyHash224DefBuff> filteredList = new ArrayList<CFBamDbKeyHash224DefBuff>();
		CFBamDbKeyHash224DefBuff[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash224DefBuff[] readBuffByPrevIdx( CFSecAuthorization Authorization,
		Long PrevTenantId,
		Long PrevId )
	{
		...
		CFBamDbKeyHash224DefBuff buff;
		ArrayList<CFBamDbKeyHash224DefBuff> filteredList = new ArrayList<CFBamDbKeyHash224DefBuff>();
		CFBamDbKeyHash224DefBuff[] buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash224DefBuff[] readBuffByNextIdx( CFSecAuthorization Authorization,
		Long NextTenantId,
		Long NextId )
	{
		...
		CFBamDbKeyHash224DefBuff buff;
		ArrayList<CFBamDbKeyHash224DefBuff> filteredList = new ArrayList<CFBamDbKeyHash224DefBuff>();
		CFBamDbKeyHash224DefBuff[] buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash224DefBuff[] readBuffByContPrevIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long PrevId )
	{
		...
		CFBamDbKeyHash224DefBuff buff;
		ArrayList<CFBamDbKeyHash224DefBuff> filteredList = new ArrayList<CFBamDbKeyHash224DefBuff>();
		CFBamDbKeyHash224DefBuff[] buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash224DefBuff[] readBuffByContNextIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long NextId )
	{
		...
		CFBamDbKeyHash224DefBuff buff;
		ArrayList<CFBamDbKeyHash224DefBuff> filteredList = new ArrayList<CFBamDbKeyHash224DefBuff>();
		CFBamDbKeyHash224DefBuff[] buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash224DefBuff[] readBuffByCodeVisIdx( CFSecAuthorization Authorization,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByCodeVisIdx() ";
		CFBamDbKeyHash224DefBuff buff;
		ArrayList<CFBamDbKeyHash224DefBuff> filteredList = new ArrayList<CFBamDbKeyHash224DefBuff>();
		CFBamDbKeyHash224DefBuff[] buffList = readDerivedByCodeVisIdx( Authorization,
			CodeVis );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash224DefBuff[] readBuffByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		...
		CFBamDbKeyHash224DefBuff buff;
		ArrayList<CFBamDbKeyHash224DefBuff> filteredList = new ArrayList<CFBamDbKeyHash224DefBuff>();
		CFBamDbKeyHash224DefBuff[] buffList = readDerivedByScopeCodeVisIdx( Authorization,
			TenantId,
			ScopeId,
			CodeVis );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	 ...
	 */
	public CFBamDbKeyHash224DefBuff moveBuffUp( CFSecAuthorization Authorization,
		long TenantId,
		long Id,
		int revision )
	{
		...
		{
			return( (CFBamDbKeyHash224DefBuff)cur );
		}
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public CFBamDbKeyHash224DefBuff moveBuffDown( CFSecAuthorization Authorization,
		long TenantId,
		long Id,
		int revision )
	{
	...
	public void updateDbKeyHash224Def( CFSecAuthorization Authorization,
		CFBamDbKeyHash224DefBuff Buff )
	{
		...
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
		CFBamDbKeyHash224DefBuff existing = dictByPKey.get( pkey );
		if( existing == null ) {
			throw new CFLibStaleCacheDetectedException( getClass(),
				"updateDbKeyHash224Def",
		...
		Map< CFBamValuePKey, CFBamDbKeyHash224DefBuff > subdict;
	...
	public void deleteDbKeyHash224Def( CFSecAuthorization Authorization,
		CFBamDbKeyHash224DefBuff Buff )
	{
		final String S_ProcName = "CFBamRamDbKeyHash224DefTable.deleteDbKeyHash224Def() ";
		String classCode;
		CFBamValuePKey pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
		...
		if( schema.getTableDbKeyHash224Col().readDerivedByIdIdx( Authorization,
					existing.getRequiredTenantId(),
		...
		if( schema.getTableDbKeyHash224Type().readDerivedByIdIdx( Authorization,
					existing.getRequiredTenantId(),
					existing.getRequiredId() ) != null )
		{
			throw new CFLibDependentsDetectedException( getClass(),
	...
	public void deleteDbKeyHash224DefByIdIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argId )
	{
		CFBamValuePKey key = schema.getFactoryValue().newPKey();
		...
		CFBamValuePKey argKey )
	{
		...
		CFBamDbKeyHash224DefBuff cur;
		LinkedList<CFBamDbKeyHash224DefBuff> matchSet = new LinkedList<CFBamDbKeyHash224DefBuff>();
		Iterator<CFBamDbKeyHash224DefBuff> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamDbKeyHash224DefBuff> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = schema.getTableDbKeyHash224Def().readDerivedByIdIdx( Authorization,
				cur.getRequiredTenantId(),
				cur.getRequiredId() );
			String subClassCode = cur.getClassCode();
			if( "a843".equals( subClassCode ) ) {
				schema.getTableDbKeyHash224Def().deleteDbKeyHash224Def( Authorization, cur );
			}
				...
				throw new CFLibUnsupportedClassException( getClass(),
					...
					"subClassCode",
					cur,
					"Instance of or subclass of DbKeyHash224Def must not be \"" + subClassCode + "\"" );
			}
		}
	}

	public void deleteDbKeyHash224DefByUNameIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		String argName )
	{
	...
	public void deleteDbKeyHash224DefByValTentIdx( CFSecAuthorization Authorization,
		long argTenantId )
	{
		CFBamValueByValTentIdxKey key = schema.getFactoryValue().newValTentIdxKey();
		key.setRequiredTenantId( argTenantId );
		deleteDbKeyHash224DefByValTentIdx( Authorization, key );
	}

	public void deleteDbKeyHash224DefByValTentIdx( CFSecAuthorization Authorization,
		CFBamValueByValTentIdxKey argKey )
	{
		final String S_ProcName = "deleteDbKeyHash224DefByValTentIdx";
		CFBamDbKeyHash224DefBuff cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
	...
	public void deleteDbKeyHash224DefByScopeIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId )
	{
	...
	public void deleteDbKeyHash224DefByDefSchemaIdx( CFSecAuthorization Authorization,
	...
	public void deleteDbKeyHash224DefByPrevIdx( CFSecAuthorization Authorization,
	...
	public void deleteDbKeyHash224DefByNextIdx( CFSecAuthorization Authorization,
	...
	public void deleteDbKeyHash224DefByContPrevIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		Long argPrevId )
	{
	...
	public void deleteDbKeyHash224DefByContNextIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		Long argNextId )
	{
	...
	public void deleteDbKeyHash224DefByCodeVisIdx( CFSecAuthorization Authorization,
		ICFBamSchema.CodeVisibilityEnum argCodeVis )
	{
		...
		deleteDbKeyHash224DefByCodeVisIdx( Authorization, key );
	}

	public void deleteDbKeyHash224DefByCodeVisIdx( CFSecAuthorization Authorization,
		CFBamValueByCodeVisIdxKey argKey )
	{
		final String S_ProcName = "deleteDbKeyHash224DefByCodeVisIdx";
		CFBamDbKeyHash224DefBuff cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
	...
	public void deleteDbKeyHash224DefByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		ICFBamSchema.CodeVisibilityEnum argCodeVis )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setRequiredCodeVis( argCodeVis );
		deleteDbKeyHash224DefByScopeCodeVisIdx( Authorization, key );
	}

	public void deleteDbKeyHash224DefByScopeCodeVisIdx( CFSecAuthorization Authorization,
		CFBamValueByScopeCodeVisIdxKey argKey )
	{
		final String S_ProcName = "deleteDbKeyHash224DefByScopeCodeVisIdx";
		CFBamDbKeyHash224DefBuff cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		anyNotNull = true;
