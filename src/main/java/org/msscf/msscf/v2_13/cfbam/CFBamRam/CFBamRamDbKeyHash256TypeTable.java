...
// Description: Java 11 in-memory RAM DbIO implementation for DbKeyHash256Type.
...
/*
 *	CFBamRamDbKeyHash256TypeTable in-memory RAM DbIO implementation
 *	for DbKeyHash256Type.
 */
public class CFBamRamDbKeyHash256TypeTable
	implements ICFBamDbKeyHash256TypeTable
{
	private ICFBamSchema schema;
	private Map< CFBamValuePKey,
				CFBamDbKeyHash256TypeBuff > dictByPKey
		= new HashMap< CFBamValuePKey,
				CFBamDbKeyHash256TypeBuff >();
	private Map< CFBamDbKeyHash256TypeBySchemaIdxKey,
				Map< CFBamValuePKey,
					CFBamDbKeyHash256TypeBuff >> dictBySchemaIdx
		= new HashMap< CFBamDbKeyHash256TypeBySchemaIdxKey,
				Map< CFBamValuePKey,
					CFBamDbKeyHash256TypeBuff >>();

	public CFBamRamDbKeyHash256TypeTable( ICFBamSchema argSchema ) {
		schema = argSchema;
	}

	public void createDbKeyHash256Type( CFSecAuthorization Authorization,
		CFBamDbKeyHash256TypeBuff Buff )
	{
		...
		schema.getTableDbKeyHash256Def().createDbKeyHash256Def( Authorization,
			Buff );
		CFBamValuePKey pkey = schema.getFactoryValue().newPKey();
		pkey.setClassCode( Buff.getClassCode() );
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
		CFBamDbKeyHash256TypeBySchemaIdxKey keySchemaIdx = schema.getFactoryDbKeyHash256Type().newSchemaIdxKey();
...

		{
			...
			allNull = false;
			if( ! allNull ) {
				if( null == schema.getTableDbKeyHash256Def().readDerivedByIdIdx( Authorization,
						Buff.getRequiredTenantId(),
						Buff.getRequiredId() ) )
				{
		...
		Map< CFBamValuePKey, CFBamDbKeyHash256TypeBuff > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< CFBamValuePKey, CFBamDbKeyHash256TypeBuff >();
	...
	public CFBamDbKeyHash256TypeBuff readDerived( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
	...
	public CFBamDbKeyHash256TypeBuff lockDerived( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash256Type.readDerived";
		CFBamValuePKey key = schema.getFactoryValue().newPKey();
	...
	public CFBamDbKeyHash256TypeBuff[] readAllDerived( CFSecAuthorization Authorization ) {
		final String S_ProcName = "CFBamRamDbKeyHash256Type.readAllDerived";
		CFBamDbKeyHash256TypeBuff[] retList = new CFBamDbKeyHash256TypeBuff[ dictByPKey.values().size() ];
		Iterator< CFBamDbKeyHash256TypeBuff > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
	...
	public CFBamDbKeyHash256TypeBuff readDerivedByUNameIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		String Name )
	{
		...
		else if( buff instanceof CFBamDbKeyHash256TypeBuff ) {
			return( (CFBamDbKeyHash256TypeBuff)buff );
		}
		else {
			return( null );
		}
	...
	public CFBamDbKeyHash256TypeBuff[] readDerivedByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		...
		if( buffList == null ) {
			...
			CFBamValueBuff buff;
			ArrayList<CFBamDbKeyHash256TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash256TypeBuff>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof CFBamDbKeyHash256TypeBuff ) ) {
					filteredList.add( (CFBamDbKeyHash256TypeBuff)buff );
				}
			}
			return( filteredList.toArray( new CFBamDbKeyHash256TypeBuff[0] ) );
		}
	}

	public CFBamDbKeyHash256TypeBuff[] readDerivedByScopeIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId )
	{
	...
	public CFBamDbKeyHash256TypeBuff[] readDerivedByDefSchemaIdx( CFSecAuthorization Authorization,
	...
	public CFBamDbKeyHash256TypeBuff[] readDerivedByPrevIdx( CFSecAuthorization Authorization,
		Long PrevTenantId,
		Long PrevId )
	{
	...
	public CFBamDbKeyHash256TypeBuff[] readDerivedByNextIdx( CFSecAuthorization Authorization,
		Long NextTenantId,
		Long NextId )
	{
	...
	public CFBamDbKeyHash256TypeBuff[] readDerivedByContPrevIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long PrevId )
	{
	...
	public CFBamDbKeyHash256TypeBuff[] readDerivedByContNextIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long NextId )
	{
	...
	public CFBamDbKeyHash256TypeBuff[] readDerivedByCodeVisIdx( CFSecAuthorization Authorization,
	...
	public CFBamDbKeyHash256TypeBuff[] readDerivedByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
	...
	public CFBamDbKeyHash256TypeBuff[] readDerivedBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId )
	{
		final String S_ProcName = "CFBamRamDbKeyHash256Type.readDerivedBySchemaIdx";
		CFBamDbKeyHash256TypeBySchemaIdxKey key = schema.getFactoryDbKeyHash256Type().newSchemaIdxKey();
		key.setRequiredTenantId( TenantId );
		key.setRequiredSchemaDefId( SchemaDefId );

		CFBamDbKeyHash256TypeBuff[] recArray;
		if( dictBySchemaIdx.containsKey( key ) ) {
			Map< CFBamValuePKey, CFBamDbKeyHash256TypeBuff > subdictSchemaIdx
				= dictBySchemaIdx.get( key );
			recArray = new CFBamDbKeyHash256TypeBuff[ subdictSchemaIdx.size() ];
			Iterator< CFBamDbKeyHash256TypeBuff > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< CFBamValuePKey, CFBamDbKeyHash256TypeBuff > subdictSchemaIdx
				= new HashMap< CFBamValuePKey, CFBamDbKeyHash256TypeBuff >();
			dictBySchemaIdx.put( key, subdictSchemaIdx );
			recArray = new CFBamDbKeyHash256TypeBuff[0];
		}
		return( recArray );
	}

	public CFBamDbKeyHash256TypeBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		long TenantId,
		long Id )
	{
	...
	public CFBamDbKeyHash256TypeBuff readBuff( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash256Type.readBuff";
		CFBamDbKeyHash256TypeBuff buff = readDerived( Authorization, PKey );
	...
	public CFBamDbKeyHash256TypeBuff lockBuff( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
	...
	public CFBamDbKeyHash256TypeBuff[] readAllBuff( CFSecAuthorization Authorization )
	{
		final String S_ProcName = "CFBamRamDbKeyHash256Type.readAllBuff";
		CFBamDbKeyHash256TypeBuff buff;
		ArrayList<CFBamDbKeyHash256TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash256TypeBuff>();
		CFBamDbKeyHash256TypeBuff[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a849" ) ) {
	...
	public CFBamDbKeyHash256TypeBuff readBuffByIdIdx( CFSecAuthorization Authorization,
		long TenantId,
		long Id )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByIdIdx() ";
		CFBamDbKeyHash256TypeBuff buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
	...
	public CFBamDbKeyHash256TypeBuff readBuffByUNameIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		String Name )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByUNameIdx() ";
		CFBamDbKeyHash256TypeBuff buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash256TypeBuff[] readBuffByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByValTentIdx() ";
		CFBamDbKeyHash256TypeBuff buff;
		ArrayList<CFBamDbKeyHash256TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash256TypeBuff>();
		CFBamDbKeyHash256TypeBuff[] buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash256TypeBuff[] readBuffByScopeIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId )
	{
		...
		CFBamDbKeyHash256TypeBuff buff;
		ArrayList<CFBamDbKeyHash256TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash256TypeBuff>();
		CFBamDbKeyHash256TypeBuff[] buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash256TypeBuff[] readBuffByDefSchemaIdx( CFSecAuthorization Authorization,
		Long DefSchemaTenantId,
		Long DefSchemaId )
	{
		...
		CFBamDbKeyHash256TypeBuff buff;
		ArrayList<CFBamDbKeyHash256TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash256TypeBuff>();
		CFBamDbKeyHash256TypeBuff[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash256TypeBuff[] readBuffByPrevIdx( CFSecAuthorization Authorization,
		Long PrevTenantId,
		Long PrevId )
	{
		...
		CFBamDbKeyHash256TypeBuff buff;
		ArrayList<CFBamDbKeyHash256TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash256TypeBuff>();
		CFBamDbKeyHash256TypeBuff[] buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash256TypeBuff[] readBuffByNextIdx( CFSecAuthorization Authorization,
		Long NextTenantId,
		Long NextId )
	{
		...
		CFBamDbKeyHash256TypeBuff buff;
		ArrayList<CFBamDbKeyHash256TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash256TypeBuff>();
		CFBamDbKeyHash256TypeBuff[] buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash256TypeBuff[] readBuffByContPrevIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long PrevId )
	{
		...
		CFBamDbKeyHash256TypeBuff buff;
		ArrayList<CFBamDbKeyHash256TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash256TypeBuff>();
		CFBamDbKeyHash256TypeBuff[] buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash256TypeBuff[] readBuffByContNextIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long NextId )
	{
		...
		CFBamDbKeyHash256TypeBuff buff;
		ArrayList<CFBamDbKeyHash256TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash256TypeBuff>();
		CFBamDbKeyHash256TypeBuff[] buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash256TypeBuff[] readBuffByCodeVisIdx( CFSecAuthorization Authorization,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByCodeVisIdx() ";
		CFBamDbKeyHash256TypeBuff buff;
		ArrayList<CFBamDbKeyHash256TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash256TypeBuff>();
		CFBamDbKeyHash256TypeBuff[] buffList = readDerivedByCodeVisIdx( Authorization,
			CodeVis );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash256TypeBuff[] readBuffByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		...
		CFBamDbKeyHash256TypeBuff buff;
		ArrayList<CFBamDbKeyHash256TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash256TypeBuff>();
		CFBamDbKeyHash256TypeBuff[] buffList = readDerivedByScopeCodeVisIdx( Authorization,
			TenantId,
			ScopeId,
			CodeVis );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash256TypeBuff[] readBuffBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId )
	{
		final String S_ProcName = "CFBamRamDbKeyHash256Type.readBuffBySchemaIdx() ";
		CFBamDbKeyHash256TypeBuff buff;
		ArrayList<CFBamDbKeyHash256TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash256TypeBuff>();
		CFBamDbKeyHash256TypeBuff[] buffList = readDerivedBySchemaIdx( Authorization,
			TenantId,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	/**
	 *	Read a page array of the specific DbKeyHash256Type buffer instances identified by the duplicate key SchemaIdx.
	 *
	 ...
	 */
	public CFBamDbKeyHash256TypeBuff[] pageBuffBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId,
		Long priorTenantId,
		Long priorId )
	 ...
	 */
	public CFBamDbKeyHash256TypeBuff moveBuffUp( CFSecAuthorization Authorization,
		long TenantId,
		long Id,
		int revision )
	{
		...
		{
			return( (CFBamDbKeyHash256TypeBuff)cur );
		}
		...
		return( (CFBamDbKeyHash256TypeBuff)editCur );
	}
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public CFBamDbKeyHash256TypeBuff moveBuffDown( CFSecAuthorization Authorization,
		long TenantId,
		long Id,
		int revision )
	{
	...
	public void updateDbKeyHash256Type( CFSecAuthorization Authorization,
		CFBamDbKeyHash256TypeBuff Buff )
	{
		schema.getTableDbKeyHash256Def().updateDbKeyHash256Def( Authorization,
			Buff );
		CFBamValuePKey pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
		CFBamDbKeyHash256TypeBuff existing = dictByPKey.get( pkey );
		if( existing == null ) {
			throw new CFLibStaleCacheDetectedException( getClass(),
				"updateDbKeyHash256Type",
				"Existing record not found",
				"DbKeyHash256Type",
				pkey );
		}
		CFBamDbKeyHash256TypeBySchemaIdxKey existingKeySchemaIdx = schema.getFactoryDbKeyHash256Type().newSchemaIdxKey();
		...
		CFBamDbKeyHash256TypeBySchemaIdxKey newKeySchemaIdx = schema.getFactoryDbKeyHash256Type().newSchemaIdxKey();
		...
		Map< CFBamValuePKey, CFBamDbKeyHash256TypeBuff > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< CFBamValuePKey, CFBamDbKeyHash256TypeBuff >();
	...
	public void deleteDbKeyHash256Type( CFSecAuthorization Authorization,
		CFBamDbKeyHash256TypeBuff Buff )
	{
		final String S_ProcName = "CFBamRamDbKeyHash256TypeTable.deleteDbKeyHash256Type() ";
		String classCode;
		CFBamValuePKey pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
		...
		if( schema.getTableDbKeyHash256Gen().readDerivedByIdIdx( Authorization,
					existing.getRequiredTenantId(),
		...
		schema.getTableDbKeyHash256Def().deleteDbKeyHash256Def( Authorization,
			Buff );
	}
	public void deleteDbKeyHash256TypeBySchemaIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argSchemaDefId )
	{
		CFBamDbKeyHash256TypeBySchemaIdxKey key = schema.getFactoryDbKeyHash256Type().newSchemaIdxKey();
		...
		deleteDbKeyHash256TypeBySchemaIdx( Authorization, key );
	}
		...
		CFBamDbKeyHash256TypeBySchemaIdxKey argKey )
	{
		...
		LinkedList<CFBamDbKeyHash256TypeBuff> matchSet = new LinkedList<CFBamDbKeyHash256TypeBuff>();
		Iterator<CFBamDbKeyHash256TypeBuff> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamDbKeyHash256TypeBuff> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = schema.getTableDbKeyHash256Type().readDerivedByIdIdx( Authorization,
				cur.getRequiredTenantId(),
				cur.getRequiredId() );
			String subClassCode = cur.getClassCode();
			if( "a849".equals( subClassCode ) ) {
				schema.getTableDbKeyHash256Type().deleteDbKeyHash256Type( Authorization, cur );
			}
				...
				throw new CFLibUnsupportedClassException( getClass(),
					...
					"subClassCode",
					cur,
					"Instance of or subclass of DbKeyHash256Type must not be \"" + subClassCode + "\"" );
			}
		}
	}

	public void deleteDbKeyHash256TypeByIdIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argId )
	{
		CFBamValuePKey key = schema.getFactoryValue().newPKey();
		...
		deleteDbKeyHash256TypeByIdIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash256TypeByUNameIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		String argName )
	{
		...
		deleteDbKeyHash256TypeByUNameIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash256TypeByValTentIdx( CFSecAuthorization Authorization,
		long argTenantId )
	{
		CFBamValueByValTentIdxKey key = schema.getFactoryValue().newValTentIdxKey();
		key.setRequiredTenantId( argTenantId );
		deleteDbKeyHash256TypeByValTentIdx( Authorization, key );
	}

	public void deleteDbKeyHash256TypeByValTentIdx( CFSecAuthorization Authorization,
		CFBamValueByValTentIdxKey argKey )
	{
		final String S_ProcName = "deleteDbKeyHash256TypeByValTentIdx";
		CFBamDbKeyHash256TypeBuff cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
	...
	public void deleteDbKeyHash256TypeByScopeIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId )
	{
		...
		key.setRequiredTenantId( argTenantId );
		key.setRequiredScopeId( argScopeId );
		deleteDbKeyHash256TypeByScopeIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash256TypeByDefSchemaIdx( CFSecAuthorization Authorization,
		...
		Long argDefSchemaId )
	{
		...
		deleteDbKeyHash256TypeByDefSchemaIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash256TypeByPrevIdx( CFSecAuthorization Authorization,
		...
		Long argPrevId )
	{
		...
		deleteDbKeyHash256TypeByPrevIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash256TypeByNextIdx( CFSecAuthorization Authorization,
		...
		Long argNextId )
	{
		...
		deleteDbKeyHash256TypeByNextIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash256TypeByContPrevIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		Long argPrevId )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setOptionalPrevId( argPrevId );
		deleteDbKeyHash256TypeByContPrevIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash256TypeByContNextIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		Long argNextId )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setOptionalNextId( argNextId );
		deleteDbKeyHash256TypeByContNextIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash256TypeByCodeVisIdx( CFSecAuthorization Authorization,
		ICFBamSchema.CodeVisibilityEnum argCodeVis )
	{
		...
		deleteDbKeyHash256TypeByCodeVisIdx( Authorization, key );
	}

	public void deleteDbKeyHash256TypeByCodeVisIdx( CFSecAuthorization Authorization,
		CFBamValueByCodeVisIdxKey argKey )
	{
		final String S_ProcName = "deleteDbKeyHash256TypeByCodeVisIdx";
		CFBamDbKeyHash256TypeBuff cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
	...
	public void deleteDbKeyHash256TypeByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		ICFBamSchema.CodeVisibilityEnum argCodeVis )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setRequiredCodeVis( argCodeVis );
		deleteDbKeyHash256TypeByScopeCodeVisIdx( Authorization, key );
	}

	public void deleteDbKeyHash256TypeByScopeCodeVisIdx( CFSecAuthorization Authorization,
		CFBamValueByScopeCodeVisIdxKey argKey )
	{
		final String S_ProcName = "deleteDbKeyHash256TypeByScopeCodeVisIdx";
		CFBamDbKeyHash256TypeBuff cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		anyNotNull = true;
