...
// Description: Java 11 in-memory RAM DbIO implementation for DbKeyHash160Col.
...
/*
 *	CFBamRamDbKeyHash160ColTable in-memory RAM DbIO implementation
 *	for DbKeyHash160Col.
 */
public class CFBamRamDbKeyHash160ColTable
	implements ICFBamDbKeyHash160ColTable
{
	private ICFBamSchema schema;
	private Map< CFBamValuePKey,
				CFBamDbKeyHash160ColBuff > dictByPKey
		= new HashMap< CFBamValuePKey,
				CFBamDbKeyHash160ColBuff >();
	private Map< CFBamDbKeyHash160ColByTableIdxKey,
				Map< CFBamValuePKey,
					CFBamDbKeyHash160ColBuff >> dictByTableIdx
		= new HashMap< CFBamDbKeyHash160ColByTableIdxKey,
				Map< CFBamValuePKey,
					CFBamDbKeyHash160ColBuff >>();

	public CFBamRamDbKeyHash160ColTable( ICFBamSchema argSchema ) {
		schema = argSchema;
	}

	public void createDbKeyHash160Col( CFSecAuthorization Authorization,
		CFBamDbKeyHash160ColBuff Buff )
	{
		final String S_ProcName = "createDbKeyHash160Col";
		...
		CFBamDbKeyHash160ColByTableIdxKey keyTableIdx = schema.getFactoryDbKeyHash160Col().newTableIdxKey();
		...
		Map< CFBamValuePKey, CFBamDbKeyHash160ColBuff > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< CFBamValuePKey, CFBamDbKeyHash160ColBuff >();
	...
	public CFBamDbKeyHash160ColBuff readDerived( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash160Col.readDerived";
	...
	public CFBamDbKeyHash160ColBuff lockDerived( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash160Col.readDerived";
		CFBamValuePKey key = schema.getFactoryValue().newPKey();
	...
	public CFBamDbKeyHash160ColBuff[] readAllDerived( CFSecAuthorization Authorization ) {
		final String S_ProcName = "CFBamRamDbKeyHash160Col.readAllDerived";
		CFBamDbKeyHash160ColBuff[] retList = new CFBamDbKeyHash160ColBuff[ dictByPKey.values().size() ];
		Iterator< CFBamDbKeyHash160ColBuff > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
	...
	public CFBamDbKeyHash160ColBuff readDerivedByUNameIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		String Name )
	{
		...
		else if( buff instanceof CFBamDbKeyHash160ColBuff ) {
			return( (CFBamDbKeyHash160ColBuff)buff );
		}
		else {
			return( null );
		}
	...
	public CFBamDbKeyHash160ColBuff[] readDerivedByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		...
		if( buffList == null ) {
			...
			CFBamValueBuff buff;
			ArrayList<CFBamDbKeyHash160ColBuff> filteredList = new ArrayList<CFBamDbKeyHash160ColBuff>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof CFBamDbKeyHash160ColBuff ) ) {
					filteredList.add( (CFBamDbKeyHash160ColBuff)buff );
				}
			}
			return( filteredList.toArray( new CFBamDbKeyHash160ColBuff[0] ) );
		}
	}

	public CFBamDbKeyHash160ColBuff[] readDerivedByScopeIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId )
	{
	...
	public CFBamDbKeyHash160ColBuff[] readDerivedByDefSchemaIdx( CFSecAuthorization Authorization,
	...
	public CFBamDbKeyHash160ColBuff[] readDerivedByPrevIdx( CFSecAuthorization Authorization,
		Long PrevTenantId,
		Long PrevId )
	{
	...
	public CFBamDbKeyHash160ColBuff[] readDerivedByNextIdx( CFSecAuthorization Authorization,
		Long NextTenantId,
		Long NextId )
	{
	...
	public CFBamDbKeyHash160ColBuff[] readDerivedByContPrevIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long PrevId )
	{
	...
	public CFBamDbKeyHash160ColBuff[] readDerivedByContNextIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long NextId )
	{
	...
	public CFBamDbKeyHash160ColBuff[] readDerivedByCodeVisIdx( CFSecAuthorization Authorization,
	...
	public CFBamDbKeyHash160ColBuff[] readDerivedByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
	...
	public CFBamDbKeyHash160ColBuff[] readDerivedByTableIdx( CFSecAuthorization Authorization,
		long TenantId,
		long TableId )
	{
		final String S_ProcName = "CFBamRamDbKeyHash160Col.readDerivedByTableIdx";
		CFBamDbKeyHash160ColByTableIdxKey key = schema.getFactoryDbKeyHash160Col().newTableIdxKey();
		key.setRequiredTenantId( TenantId );
		key.setRequiredTableId( TableId );

		CFBamDbKeyHash160ColBuff[] recArray;
		if( dictByTableIdx.containsKey( key ) ) {
			Map< CFBamValuePKey, CFBamDbKeyHash160ColBuff > subdictTableIdx
				= dictByTableIdx.get( key );
			recArray = new CFBamDbKeyHash160ColBuff[ subdictTableIdx.size() ];
			Iterator< CFBamDbKeyHash160ColBuff > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< CFBamValuePKey, CFBamDbKeyHash160ColBuff > subdictTableIdx
				= new HashMap< CFBamValuePKey, CFBamDbKeyHash160ColBuff >();
			dictByTableIdx.put( key, subdictTableIdx );
			recArray = new CFBamDbKeyHash160ColBuff[0];
		}
		return( recArray );
	}

	public CFBamDbKeyHash160ColBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		long TenantId,
		long Id )
	{
	...
	public CFBamDbKeyHash160ColBuff readBuff( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash160Col.readBuff";
		CFBamDbKeyHash160ColBuff buff = readDerived( Authorization, PKey );
	...
	public CFBamDbKeyHash160ColBuff lockBuff( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
	...
	public CFBamDbKeyHash160ColBuff[] readAllBuff( CFSecAuthorization Authorization )
	{
		final String S_ProcName = "CFBamRamDbKeyHash160Col.readAllBuff";
		CFBamDbKeyHash160ColBuff buff;
		ArrayList<CFBamDbKeyHash160ColBuff> filteredList = new ArrayList<CFBamDbKeyHash160ColBuff>();
		CFBamDbKeyHash160ColBuff[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a840" ) ) {
	...
	public CFBamDbKeyHash160ColBuff readBuffByIdIdx( CFSecAuthorization Authorization,
		long TenantId,
		long Id )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByIdIdx() ";
		CFBamDbKeyHash160ColBuff buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
	...
	public CFBamDbKeyHash160ColBuff readBuffByUNameIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		String Name )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByUNameIdx() ";
		CFBamDbKeyHash160ColBuff buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash160ColBuff[] readBuffByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByValTentIdx() ";
		CFBamDbKeyHash160ColBuff buff;
		ArrayList<CFBamDbKeyHash160ColBuff> filteredList = new ArrayList<CFBamDbKeyHash160ColBuff>();
		CFBamDbKeyHash160ColBuff[] buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash160ColBuff[] readBuffByScopeIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId )
	{
		...
		CFBamDbKeyHash160ColBuff buff;
		ArrayList<CFBamDbKeyHash160ColBuff> filteredList = new ArrayList<CFBamDbKeyHash160ColBuff>();
		CFBamDbKeyHash160ColBuff[] buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash160ColBuff[] readBuffByDefSchemaIdx( CFSecAuthorization Authorization,
		Long DefSchemaTenantId,
		Long DefSchemaId )
	{
		...
		CFBamDbKeyHash160ColBuff buff;
		ArrayList<CFBamDbKeyHash160ColBuff> filteredList = new ArrayList<CFBamDbKeyHash160ColBuff>();
		CFBamDbKeyHash160ColBuff[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash160ColBuff[] readBuffByPrevIdx( CFSecAuthorization Authorization,
		Long PrevTenantId,
		Long PrevId )
	{
		...
		CFBamDbKeyHash160ColBuff buff;
		ArrayList<CFBamDbKeyHash160ColBuff> filteredList = new ArrayList<CFBamDbKeyHash160ColBuff>();
		CFBamDbKeyHash160ColBuff[] buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash160ColBuff[] readBuffByNextIdx( CFSecAuthorization Authorization,
		Long NextTenantId,
		Long NextId )
	{
		...
		CFBamDbKeyHash160ColBuff buff;
		ArrayList<CFBamDbKeyHash160ColBuff> filteredList = new ArrayList<CFBamDbKeyHash160ColBuff>();
		CFBamDbKeyHash160ColBuff[] buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash160ColBuff[] readBuffByContPrevIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long PrevId )
	{
		...
		CFBamDbKeyHash160ColBuff buff;
		ArrayList<CFBamDbKeyHash160ColBuff> filteredList = new ArrayList<CFBamDbKeyHash160ColBuff>();
		CFBamDbKeyHash160ColBuff[] buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash160ColBuff[] readBuffByContNextIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long NextId )
	{
		...
		CFBamDbKeyHash160ColBuff buff;
		ArrayList<CFBamDbKeyHash160ColBuff> filteredList = new ArrayList<CFBamDbKeyHash160ColBuff>();
		CFBamDbKeyHash160ColBuff[] buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash160ColBuff[] readBuffByCodeVisIdx( CFSecAuthorization Authorization,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByCodeVisIdx() ";
		CFBamDbKeyHash160ColBuff buff;
		ArrayList<CFBamDbKeyHash160ColBuff> filteredList = new ArrayList<CFBamDbKeyHash160ColBuff>();
		CFBamDbKeyHash160ColBuff[] buffList = readDerivedByCodeVisIdx( Authorization,
			CodeVis );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash160ColBuff[] readBuffByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		...
		CFBamDbKeyHash160ColBuff buff;
		ArrayList<CFBamDbKeyHash160ColBuff> filteredList = new ArrayList<CFBamDbKeyHash160ColBuff>();
		CFBamDbKeyHash160ColBuff[] buffList = readDerivedByScopeCodeVisIdx( Authorization,
			TenantId,
			ScopeId,
			CodeVis );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash160ColBuff[] readBuffByTableIdx( CFSecAuthorization Authorization,
		long TenantId,
		long TableId )
	{
		final String S_ProcName = "CFBamRamDbKeyHash160Col.readBuffByTableIdx() ";
		CFBamDbKeyHash160ColBuff buff;
		ArrayList<CFBamDbKeyHash160ColBuff> filteredList = new ArrayList<CFBamDbKeyHash160ColBuff>();
		CFBamDbKeyHash160ColBuff[] buffList = readDerivedByTableIdx( Authorization,
			TenantId,
			TableId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	/**
	 *	Read a page array of the specific DbKeyHash160Col buffer instances identified by the duplicate key TableIdx.
	 *
	 ...
	 */
	public CFBamDbKeyHash160ColBuff[] pageBuffByTableIdx( CFSecAuthorization Authorization,
		long TenantId,
		long TableId,
		Long priorTenantId,
		Long priorId )
	 ...
	 */
	public CFBamDbKeyHash160ColBuff moveBuffUp( CFSecAuthorization Authorization,
		long TenantId,
		long Id,
		int revision )
	{
		...
		{
			return( (CFBamDbKeyHash160ColBuff)cur );
		}
		...
		return( (CFBamDbKeyHash160ColBuff)editCur );
	}
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public CFBamDbKeyHash160ColBuff moveBuffDown( CFSecAuthorization Authorization,
		long TenantId,
		long Id,
		int revision )
	{
	...
	public void updateDbKeyHash160Col( CFSecAuthorization Authorization,
		CFBamDbKeyHash160ColBuff Buff )
	{
		...
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
		CFBamDbKeyHash160ColBuff existing = dictByPKey.get( pkey );
		if( existing == null ) {
			throw new CFLibStaleCacheDetectedException( getClass(),
				"updateDbKeyHash160Col",
				"Existing record not found",
				"DbKeyHash160Col",
				pkey );
		}
		CFBamDbKeyHash160ColByTableIdxKey existingKeyTableIdx = schema.getFactoryDbKeyHash160Col().newTableIdxKey();
		...
		CFBamDbKeyHash160ColByTableIdxKey newKeyTableIdx = schema.getFactoryDbKeyHash160Col().newTableIdxKey();
		...
		Map< CFBamValuePKey, CFBamDbKeyHash160ColBuff > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< CFBamValuePKey, CFBamDbKeyHash160ColBuff >();
	...
	public void deleteDbKeyHash160Col( CFSecAuthorization Authorization,
		CFBamDbKeyHash160ColBuff Buff )
	{
		final String S_ProcName = "CFBamRamDbKeyHash160ColTable.deleteDbKeyHash160Col() ";
		String classCode;
		CFBamValuePKey pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
	...
	public void deleteDbKeyHash160ColByTableIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argTableId )
	{
		CFBamDbKeyHash160ColByTableIdxKey key = schema.getFactoryDbKeyHash160Col().newTableIdxKey();
		...
		deleteDbKeyHash160ColByTableIdx( Authorization, key );
	}

	public void deleteDbKeyHash160ColByTableIdx( CFSecAuthorization Authorization,
		CFBamDbKeyHash160ColByTableIdxKey argKey )
	{
		CFBamDbKeyHash160ColBuff cur;
		...
		LinkedList<CFBamDbKeyHash160ColBuff> matchSet = new LinkedList<CFBamDbKeyHash160ColBuff>();
		Iterator<CFBamDbKeyHash160ColBuff> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamDbKeyHash160ColBuff> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = schema.getTableDbKeyHash160Col().readDerivedByIdIdx( Authorization,
				cur.getRequiredTenantId(),
				cur.getRequiredId() );
			deleteDbKeyHash160Col( Authorization, cur );
		}
	}

	public void deleteDbKeyHash160ColByIdIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argId )
	{
		CFBamValuePKey key = schema.getFactoryValue().newPKey();
		...
		deleteDbKeyHash160ColByIdIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash160ColByUNameIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		String argName )
	{
		...
		deleteDbKeyHash160ColByUNameIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash160ColByValTentIdx( CFSecAuthorization Authorization,
		long argTenantId )
	{
		CFBamValueByValTentIdxKey key = schema.getFactoryValue().newValTentIdxKey();
		key.setRequiredTenantId( argTenantId );
		deleteDbKeyHash160ColByValTentIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash160ColByScopeIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId )
	{
		...
		key.setRequiredTenantId( argTenantId );
		key.setRequiredScopeId( argScopeId );
		deleteDbKeyHash160ColByScopeIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash160ColByDefSchemaIdx( CFSecAuthorization Authorization,
		...
		Long argDefSchemaId )
	{
		...
		deleteDbKeyHash160ColByDefSchemaIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash160ColByPrevIdx( CFSecAuthorization Authorization,
		...
		Long argPrevId )
	{
		...
		deleteDbKeyHash160ColByPrevIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash160ColByNextIdx( CFSecAuthorization Authorization,
		...
		Long argNextId )
	{
		...
		deleteDbKeyHash160ColByNextIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash160ColByContPrevIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		Long argPrevId )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setOptionalPrevId( argPrevId );
		deleteDbKeyHash160ColByContPrevIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash160ColByContNextIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		Long argNextId )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setOptionalNextId( argNextId );
		deleteDbKeyHash160ColByContNextIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash160ColByCodeVisIdx( CFSecAuthorization Authorization,
		ICFBamSchema.CodeVisibilityEnum argCodeVis )
	{
		...
		deleteDbKeyHash160ColByCodeVisIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash160ColByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		ICFBamSchema.CodeVisibilityEnum argCodeVis )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setRequiredCodeVis( argCodeVis );
		deleteDbKeyHash160ColByScopeCodeVisIdx( Authorization, key );
	}
