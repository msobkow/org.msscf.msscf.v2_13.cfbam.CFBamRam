...
// Description: Java 11 in-memory RAM DbIO implementation for Uuid6Col.
	...
	implements ICFBamUuid6ColTable
{
	...
	private Map< CFBamValuePKey,
				CFBamUuid6ColBuff > dictByPKey
		= new HashMap< CFBamValuePKey,
				CFBamUuid6ColBuff >();
	private Map< CFBamUuid6ColByTableIdxKey,
				Map< CFBamValuePKey,
					CFBamUuid6ColBuff >> dictByTableIdx
		= new HashMap< CFBamUuid6ColByTableIdxKey,
				Map< CFBamValuePKey,
					CFBamUuid6ColBuff >>();
	...
	public void createUuid6Col( CFSecAuthorization Authorization,
		CFBamUuid6ColBuff Buff )
	{
		final String S_ProcName = "createUuid6Col";
		CFBamValueBuff tail = null;
		if( Buff.getClassCode().equals( "a88a" ) ) {
		...
		CFBamUuid6ColByTableIdxKey keyTableIdx = schema.getFactoryUuid6Col().newTableIdxKey();
		...
		Map< CFBamValuePKey, CFBamUuid6ColBuff > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< CFBamValuePKey, CFBamUuid6ColBuff >();
	...
	public CFBamUuid6ColBuff readDerived( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
	...
	public CFBamUuid6ColBuff lockDerived( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamUuid6Col.readDerived";
		CFBamValuePKey key = schema.getFactoryValue().newPKey();
	...
	public CFBamUuid6ColBuff[] readAllDerived( CFSecAuthorization Authorization ) {
		final String S_ProcName = "CFBamRamUuid6Col.readAllDerived";
		CFBamUuid6ColBuff[] retList = new CFBamUuid6ColBuff[ dictByPKey.values().size() ];
		Iterator< CFBamUuid6ColBuff > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
	...
	public CFBamUuid6ColBuff readDerivedByUNameIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		String Name )
	{
		...
		else if( buff instanceof CFBamUuid6ColBuff ) {
			return( (CFBamUuid6ColBuff)buff );
		}
		else {
			return( null );
		}
	...
	public CFBamUuid6ColBuff[] readDerivedByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		...
		if( buffList == null ) {
			...
			CFBamValueBuff buff;
			ArrayList<CFBamUuid6ColBuff> filteredList = new ArrayList<CFBamUuid6ColBuff>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof CFBamUuid6ColBuff ) ) {
					filteredList.add( (CFBamUuid6ColBuff)buff );
				}
			}
			return( filteredList.toArray( new CFBamUuid6ColBuff[0] ) );
		}
	}

	public CFBamUuid6ColBuff[] readDerivedByScopeIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId )
	{
	...
	public CFBamUuid6ColBuff[] readDerivedByDefSchemaIdx( CFSecAuthorization Authorization,
	...
	public CFBamUuid6ColBuff[] readDerivedByPrevIdx( CFSecAuthorization Authorization,
		Long PrevTenantId,
		Long PrevId )
	{
	...
	public CFBamUuid6ColBuff[] readDerivedByNextIdx( CFSecAuthorization Authorization,
		Long NextTenantId,
		Long NextId )
	{
	...
	public CFBamUuid6ColBuff[] readDerivedByContPrevIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long PrevId )
	{
	...
	public CFBamUuid6ColBuff[] readDerivedByContNextIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long NextId )
	{
	...
	public CFBamUuid6ColBuff[] readDerivedByCodeVisIdx( CFSecAuthorization Authorization,
	...
	public CFBamUuid6ColBuff[] readDerivedByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
	...
	public CFBamUuid6ColBuff[] readDerivedByTableIdx( CFSecAuthorization Authorization,
		long TenantId,
		long TableId )
	{
		final String S_ProcName = "CFBamRamUuid6Col.readDerivedByTableIdx";
		CFBamUuid6ColByTableIdxKey key = schema.getFactoryUuid6Col().newTableIdxKey();
		key.setRequiredTenantId( TenantId );
		key.setRequiredTableId( TableId );

		CFBamUuid6ColBuff[] recArray;
		if( dictByTableIdx.containsKey( key ) ) {
			Map< CFBamValuePKey, CFBamUuid6ColBuff > subdictTableIdx
				= dictByTableIdx.get( key );
			recArray = new CFBamUuid6ColBuff[ subdictTableIdx.size() ];
			Iterator< CFBamUuid6ColBuff > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< CFBamValuePKey, CFBamUuid6ColBuff > subdictTableIdx
				= new HashMap< CFBamValuePKey, CFBamUuid6ColBuff >();
			dictByTableIdx.put( key, subdictTableIdx );
			recArray = new CFBamUuid6ColBuff[0];
		}
		return( recArray );
	}

	public CFBamUuid6ColBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		long TenantId,
		long Id )
	{
	...
	public CFBamUuid6ColBuff readBuff( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamUuid6Col.readBuff";
		CFBamUuid6ColBuff buff = readDerived( Authorization, PKey );
	...
	public CFBamUuid6ColBuff lockBuff( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
	...
	public CFBamUuid6ColBuff[] readAllBuff( CFSecAuthorization Authorization )
	{
		final String S_ProcName = "CFBamRamUuid6Col.readAllBuff";
		CFBamUuid6ColBuff buff;
		ArrayList<CFBamUuid6ColBuff> filteredList = new ArrayList<CFBamUuid6ColBuff>();
		CFBamUuid6ColBuff[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a88a" ) ) {
	...
	public CFBamUuid6ColBuff readBuffByIdIdx( CFSecAuthorization Authorization,
		long TenantId,
		long Id )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByIdIdx() ";
		CFBamUuid6ColBuff buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
	...
	public CFBamUuid6ColBuff readBuffByUNameIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		String Name )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByUNameIdx() ";
		CFBamUuid6ColBuff buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamUuid6ColBuff[] readBuffByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByValTentIdx() ";
		CFBamUuid6ColBuff buff;
		ArrayList<CFBamUuid6ColBuff> filteredList = new ArrayList<CFBamUuid6ColBuff>();
		CFBamUuid6ColBuff[] buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamUuid6ColBuff[] readBuffByScopeIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId )
	{
		...
		CFBamUuid6ColBuff buff;
		ArrayList<CFBamUuid6ColBuff> filteredList = new ArrayList<CFBamUuid6ColBuff>();
		CFBamUuid6ColBuff[] buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamUuid6ColBuff[] readBuffByDefSchemaIdx( CFSecAuthorization Authorization,
		Long DefSchemaTenantId,
		Long DefSchemaId )
	{
		...
		CFBamUuid6ColBuff buff;
		ArrayList<CFBamUuid6ColBuff> filteredList = new ArrayList<CFBamUuid6ColBuff>();
		CFBamUuid6ColBuff[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamUuid6ColBuff[] readBuffByPrevIdx( CFSecAuthorization Authorization,
		Long PrevTenantId,
		Long PrevId )
	{
		...
		CFBamUuid6ColBuff buff;
		ArrayList<CFBamUuid6ColBuff> filteredList = new ArrayList<CFBamUuid6ColBuff>();
		CFBamUuid6ColBuff[] buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamUuid6ColBuff[] readBuffByNextIdx( CFSecAuthorization Authorization,
		Long NextTenantId,
		Long NextId )
	{
		...
		CFBamUuid6ColBuff buff;
		ArrayList<CFBamUuid6ColBuff> filteredList = new ArrayList<CFBamUuid6ColBuff>();
		CFBamUuid6ColBuff[] buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamUuid6ColBuff[] readBuffByContPrevIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long PrevId )
	{
		...
		CFBamUuid6ColBuff buff;
		ArrayList<CFBamUuid6ColBuff> filteredList = new ArrayList<CFBamUuid6ColBuff>();
		CFBamUuid6ColBuff[] buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamUuid6ColBuff[] readBuffByContNextIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long NextId )
	{
		...
		CFBamUuid6ColBuff buff;
		ArrayList<CFBamUuid6ColBuff> filteredList = new ArrayList<CFBamUuid6ColBuff>();
		CFBamUuid6ColBuff[] buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamUuid6ColBuff[] readBuffByCodeVisIdx( CFSecAuthorization Authorization,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByCodeVisIdx() ";
		CFBamUuid6ColBuff buff;
		ArrayList<CFBamUuid6ColBuff> filteredList = new ArrayList<CFBamUuid6ColBuff>();
		CFBamUuid6ColBuff[] buffList = readDerivedByCodeVisIdx( Authorization,
			CodeVis );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamUuid6ColBuff[] readBuffByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		...
		CFBamUuid6ColBuff buff;
		ArrayList<CFBamUuid6ColBuff> filteredList = new ArrayList<CFBamUuid6ColBuff>();
		CFBamUuid6ColBuff[] buffList = readDerivedByScopeCodeVisIdx( Authorization,
			TenantId,
			ScopeId,
			CodeVis );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamUuid6ColBuff[] readBuffByTableIdx( CFSecAuthorization Authorization,
		long TenantId,
		long TableId )
	{
		final String S_ProcName = "CFBamRamUuid6Col.readBuffByTableIdx() ";
		CFBamUuid6ColBuff buff;
		ArrayList<CFBamUuid6ColBuff> filteredList = new ArrayList<CFBamUuid6ColBuff>();
		CFBamUuid6ColBuff[] buffList = readDerivedByTableIdx( Authorization,
			TenantId,
			TableId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	/**
	 *	Read a page array of the specific Uuid6Col buffer instances identified by the duplicate key TableIdx.
	 *
	 ...
	 */
	public CFBamUuid6ColBuff[] pageBuffByTableIdx( CFSecAuthorization Authorization,
		long TenantId,
		long TableId,
		Long priorTenantId,
		Long priorId )
	 ...
	 */
	public CFBamUuid6ColBuff moveBuffUp( CFSecAuthorization Authorization,
		long TenantId,
		long Id,
		int revision )
	{
		...
		return( (CFBamUuid6ColBuff)editCur );
	}
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public CFBamUuid6ColBuff moveBuffDown( CFSecAuthorization Authorization,
		long TenantId,
		long Id,
		int revision )
	{
	...
	public void updateUuid6Col( CFSecAuthorization Authorization,
		CFBamUuid6ColBuff Buff )
	{
		...
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
		CFBamUuid6ColBuff existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamUuid6ColByTableIdxKey existingKeyTableIdx = schema.getFactoryUuid6Col().newTableIdxKey();
		...
		CFBamUuid6ColByTableIdxKey newKeyTableIdx = schema.getFactoryUuid6Col().newTableIdxKey();
		...
		Map< CFBamValuePKey, CFBamUuid6ColBuff > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< CFBamValuePKey, CFBamUuid6ColBuff >();
	...
	public void deleteUuid6Col( CFSecAuthorization Authorization,
		CFBamUuid6ColBuff Buff )
	{
	...
	public void deleteUuid6ColByTableIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argTableId )
	{
		CFBamUuid6ColByTableIdxKey key = schema.getFactoryUuid6Col().newTableIdxKey();
		...
		CFBamUuid6ColByTableIdxKey argKey )
	{
		...
		LinkedList<CFBamUuid6ColBuff> matchSet = new LinkedList<CFBamUuid6ColBuff>();
		Iterator<CFBamUuid6ColBuff> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamUuid6ColBuff> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = schema.getTableUuid6Col().readDerivedByIdIdx( Authorization,
	...
	public void deleteUuid6ColByIdIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argId )
	{
		CFBamValuePKey key = schema.getFactoryValue().newPKey();
		...
		deleteUuid6ColByIdIdx( Authorization, key );
	}
	...
	public void deleteUuid6ColByUNameIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		String argName )
	{
	...
	public void deleteUuid6ColByValTentIdx( CFSecAuthorization Authorization,
		long argTenantId )
	{
		CFBamValueByValTentIdxKey key = schema.getFactoryValue().newValTentIdxKey();
		key.setRequiredTenantId( argTenantId );
		deleteUuid6ColByValTentIdx( Authorization, key );
	}
	...
	public void deleteUuid6ColByScopeIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId )
	{
	...
	public void deleteUuid6ColByDefSchemaIdx( CFSecAuthorization Authorization,
	...
	public void deleteUuid6ColByPrevIdx( CFSecAuthorization Authorization,
	...
	public void deleteUuid6ColByNextIdx( CFSecAuthorization Authorization,
	...
	public void deleteUuid6ColByContPrevIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		Long argPrevId )
	{
	...
	public void deleteUuid6ColByContNextIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		Long argNextId )
	{
	...
	public void deleteUuid6ColByCodeVisIdx( CFSecAuthorization Authorization,
		ICFBamSchema.CodeVisibilityEnum argCodeVis )
	{
		...
		deleteUuid6ColByCodeVisIdx( Authorization, key );
	}
	...
	public void deleteUuid6ColByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		ICFBamSchema.CodeVisibilityEnum argCodeVis )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setRequiredCodeVis( argCodeVis );
		deleteUuid6ColByScopeCodeVisIdx( Authorization, key );
	}
