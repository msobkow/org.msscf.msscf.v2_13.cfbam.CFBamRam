...
// Description: Java 11 in-memory RAM DbIO implementation for DbKeyHash512Col.
...
/*
 *	CFBamRamDbKeyHash512ColTable in-memory RAM DbIO implementation
 *	for DbKeyHash512Col.
 */
public class CFBamRamDbKeyHash512ColTable
	implements ICFBamDbKeyHash512ColTable
{
	private ICFBamSchema schema;
	private Map< CFBamValuePKey,
				CFBamDbKeyHash512ColBuff > dictByPKey
		= new HashMap< CFBamValuePKey,
				CFBamDbKeyHash512ColBuff >();
	private Map< CFBamDbKeyHash512ColByTableIdxKey,
				Map< CFBamValuePKey,
					CFBamDbKeyHash512ColBuff >> dictByTableIdx
		= new HashMap< CFBamDbKeyHash512ColByTableIdxKey,
				Map< CFBamValuePKey,
					CFBamDbKeyHash512ColBuff >>();

	public CFBamRamDbKeyHash512ColTable( ICFBamSchema argSchema ) {
		schema = argSchema;
	}

	public void createDbKeyHash512Col( CFSecAuthorization Authorization,
		CFBamDbKeyHash512ColBuff Buff )
	{
		final String S_ProcName = "createDbKeyHash512Col";
		CFBamValueBuff tail = null;
		if( Buff.getClassCode().equals( "a850" ) ) {
		...
		schema.getTableDbKeyHash512Def().createDbKeyHash512Def( Authorization,
			Buff );
		CFBamValuePKey pkey = schema.getFactoryValue().newPKey();
		pkey.setClassCode( Buff.getClassCode() );
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
		CFBamDbKeyHash512ColByTableIdxKey keyTableIdx = schema.getFactoryDbKeyHash512Col().newTableIdxKey();
		...
		Map< CFBamValuePKey, CFBamDbKeyHash512ColBuff > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< CFBamValuePKey, CFBamDbKeyHash512ColBuff >();
	...
	public CFBamDbKeyHash512ColBuff readDerived( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash512Col.readDerived";
	...
	public CFBamDbKeyHash512ColBuff lockDerived( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash512Col.readDerived";
		CFBamValuePKey key = schema.getFactoryValue().newPKey();
	...
	public CFBamDbKeyHash512ColBuff[] readAllDerived( CFSecAuthorization Authorization ) {
		final String S_ProcName = "CFBamRamDbKeyHash512Col.readAllDerived";
		CFBamDbKeyHash512ColBuff[] retList = new CFBamDbKeyHash512ColBuff[ dictByPKey.values().size() ];
		Iterator< CFBamDbKeyHash512ColBuff > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
	...
	public CFBamDbKeyHash512ColBuff readDerivedByUNameIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		String Name )
	{
		...
		else if( buff instanceof CFBamDbKeyHash512ColBuff ) {
			return( (CFBamDbKeyHash512ColBuff)buff );
		}
		else {
			return( null );
		}
	...
	public CFBamDbKeyHash512ColBuff[] readDerivedByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		...
		if( buffList == null ) {
			...
			CFBamValueBuff buff;
			ArrayList<CFBamDbKeyHash512ColBuff> filteredList = new ArrayList<CFBamDbKeyHash512ColBuff>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof CFBamDbKeyHash512ColBuff ) ) {
					filteredList.add( (CFBamDbKeyHash512ColBuff)buff );
				}
			}
			return( filteredList.toArray( new CFBamDbKeyHash512ColBuff[0] ) );
		}
	}

	public CFBamDbKeyHash512ColBuff[] readDerivedByScopeIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId )
	{
	...
	public CFBamDbKeyHash512ColBuff[] readDerivedByDefSchemaIdx( CFSecAuthorization Authorization,
	...
	public CFBamDbKeyHash512ColBuff[] readDerivedByPrevIdx( CFSecAuthorization Authorization,
		Long PrevTenantId,
		Long PrevId )
	{
	...
	public CFBamDbKeyHash512ColBuff[] readDerivedByNextIdx( CFSecAuthorization Authorization,
		Long NextTenantId,
		Long NextId )
	{
	...
	public CFBamDbKeyHash512ColBuff[] readDerivedByContPrevIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long PrevId )
	{
	...
	public CFBamDbKeyHash512ColBuff[] readDerivedByContNextIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long NextId )
	{
	...
	public CFBamDbKeyHash512ColBuff[] readDerivedByCodeVisIdx( CFSecAuthorization Authorization,
	...
	public CFBamDbKeyHash512ColBuff[] readDerivedByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
	...
	public CFBamDbKeyHash512ColBuff[] readDerivedByTableIdx( CFSecAuthorization Authorization,
		long TenantId,
		long TableId )
	{
		final String S_ProcName = "CFBamRamDbKeyHash512Col.readDerivedByTableIdx";
		CFBamDbKeyHash512ColByTableIdxKey key = schema.getFactoryDbKeyHash512Col().newTableIdxKey();
		key.setRequiredTenantId( TenantId );
		key.setRequiredTableId( TableId );

		CFBamDbKeyHash512ColBuff[] recArray;
		if( dictByTableIdx.containsKey( key ) ) {
			Map< CFBamValuePKey, CFBamDbKeyHash512ColBuff > subdictTableIdx
				= dictByTableIdx.get( key );
			recArray = new CFBamDbKeyHash512ColBuff[ subdictTableIdx.size() ];
			Iterator< CFBamDbKeyHash512ColBuff > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< CFBamValuePKey, CFBamDbKeyHash512ColBuff > subdictTableIdx
				= new HashMap< CFBamValuePKey, CFBamDbKeyHash512ColBuff >();
			dictByTableIdx.put( key, subdictTableIdx );
			recArray = new CFBamDbKeyHash512ColBuff[0];
		}
		return( recArray );
	}

	public CFBamDbKeyHash512ColBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		long TenantId,
		long Id )
	{
	...
	public CFBamDbKeyHash512ColBuff readBuff( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash512Col.readBuff";
		CFBamDbKeyHash512ColBuff buff = readDerived( Authorization, PKey );
	...
	public CFBamDbKeyHash512ColBuff lockBuff( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
	...
	public CFBamDbKeyHash512ColBuff[] readAllBuff( CFSecAuthorization Authorization )
	{
		final String S_ProcName = "CFBamRamDbKeyHash512Col.readAllBuff";
		CFBamDbKeyHash512ColBuff buff;
		ArrayList<CFBamDbKeyHash512ColBuff> filteredList = new ArrayList<CFBamDbKeyHash512ColBuff>();
		CFBamDbKeyHash512ColBuff[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a850" ) ) {
	...
	public CFBamDbKeyHash512ColBuff readBuffByIdIdx( CFSecAuthorization Authorization,
		long TenantId,
		long Id )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByIdIdx() ";
		CFBamDbKeyHash512ColBuff buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
	...
	public CFBamDbKeyHash512ColBuff readBuffByUNameIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		String Name )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByUNameIdx() ";
		CFBamDbKeyHash512ColBuff buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash512ColBuff[] readBuffByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByValTentIdx() ";
		CFBamDbKeyHash512ColBuff buff;
		ArrayList<CFBamDbKeyHash512ColBuff> filteredList = new ArrayList<CFBamDbKeyHash512ColBuff>();
		CFBamDbKeyHash512ColBuff[] buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash512ColBuff[] readBuffByScopeIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId )
	{
		...
		CFBamDbKeyHash512ColBuff buff;
		ArrayList<CFBamDbKeyHash512ColBuff> filteredList = new ArrayList<CFBamDbKeyHash512ColBuff>();
		CFBamDbKeyHash512ColBuff[] buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash512ColBuff[] readBuffByDefSchemaIdx( CFSecAuthorization Authorization,
		Long DefSchemaTenantId,
		Long DefSchemaId )
	{
		...
		CFBamDbKeyHash512ColBuff buff;
		ArrayList<CFBamDbKeyHash512ColBuff> filteredList = new ArrayList<CFBamDbKeyHash512ColBuff>();
		CFBamDbKeyHash512ColBuff[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash512ColBuff[] readBuffByPrevIdx( CFSecAuthorization Authorization,
		Long PrevTenantId,
		Long PrevId )
	{
		...
		CFBamDbKeyHash512ColBuff buff;
		ArrayList<CFBamDbKeyHash512ColBuff> filteredList = new ArrayList<CFBamDbKeyHash512ColBuff>();
		CFBamDbKeyHash512ColBuff[] buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash512ColBuff[] readBuffByNextIdx( CFSecAuthorization Authorization,
		Long NextTenantId,
		Long NextId )
	{
		...
		CFBamDbKeyHash512ColBuff buff;
		ArrayList<CFBamDbKeyHash512ColBuff> filteredList = new ArrayList<CFBamDbKeyHash512ColBuff>();
		CFBamDbKeyHash512ColBuff[] buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash512ColBuff[] readBuffByContPrevIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long PrevId )
	{
		...
		CFBamDbKeyHash512ColBuff buff;
		ArrayList<CFBamDbKeyHash512ColBuff> filteredList = new ArrayList<CFBamDbKeyHash512ColBuff>();
		CFBamDbKeyHash512ColBuff[] buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash512ColBuff[] readBuffByContNextIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long NextId )
	{
		...
		CFBamDbKeyHash512ColBuff buff;
		ArrayList<CFBamDbKeyHash512ColBuff> filteredList = new ArrayList<CFBamDbKeyHash512ColBuff>();
		CFBamDbKeyHash512ColBuff[] buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash512ColBuff[] readBuffByCodeVisIdx( CFSecAuthorization Authorization,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByCodeVisIdx() ";
		CFBamDbKeyHash512ColBuff buff;
		ArrayList<CFBamDbKeyHash512ColBuff> filteredList = new ArrayList<CFBamDbKeyHash512ColBuff>();
		CFBamDbKeyHash512ColBuff[] buffList = readDerivedByCodeVisIdx( Authorization,
			CodeVis );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash512ColBuff[] readBuffByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		...
		CFBamDbKeyHash512ColBuff buff;
		ArrayList<CFBamDbKeyHash512ColBuff> filteredList = new ArrayList<CFBamDbKeyHash512ColBuff>();
		CFBamDbKeyHash512ColBuff[] buffList = readDerivedByScopeCodeVisIdx( Authorization,
			TenantId,
			ScopeId,
			CodeVis );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash512ColBuff[] readBuffByTableIdx( CFSecAuthorization Authorization,
		long TenantId,
		long TableId )
	{
		final String S_ProcName = "CFBamRamDbKeyHash512Col.readBuffByTableIdx() ";
		CFBamDbKeyHash512ColBuff buff;
		ArrayList<CFBamDbKeyHash512ColBuff> filteredList = new ArrayList<CFBamDbKeyHash512ColBuff>();
		CFBamDbKeyHash512ColBuff[] buffList = readDerivedByTableIdx( Authorization,
			TenantId,
			TableId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	/**
	 *	Read a page array of the specific DbKeyHash512Col buffer instances identified by the duplicate key TableIdx.
	 *
	 ...
	 */
	public CFBamDbKeyHash512ColBuff[] pageBuffByTableIdx( CFSecAuthorization Authorization,
		long TenantId,
		long TableId,
		Long priorTenantId,
		Long priorId )
	 ...
	 */
	public CFBamDbKeyHash512ColBuff moveBuffUp( CFSecAuthorization Authorization,
		long TenantId,
		long Id,
		int revision )
	{
		...
		{
			return( (CFBamDbKeyHash512ColBuff)cur );
		}
		...
		return( (CFBamDbKeyHash512ColBuff)editCur );
	}
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public CFBamDbKeyHash512ColBuff moveBuffDown( CFSecAuthorization Authorization,
		long TenantId,
		long Id,
		int revision )
	{
	...
	public void updateDbKeyHash512Col( CFSecAuthorization Authorization,
		CFBamDbKeyHash512ColBuff Buff )
	{
		schema.getTableDbKeyHash512Def().updateDbKeyHash512Def( Authorization,
			Buff );
		CFBamValuePKey pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
		CFBamDbKeyHash512ColBuff existing = dictByPKey.get( pkey );
		if( existing == null ) {
			throw new CFLibStaleCacheDetectedException( getClass(),
				"updateDbKeyHash512Col",
				"Existing record not found",
				"DbKeyHash512Col",
				pkey );
		}
		CFBamDbKeyHash512ColByTableIdxKey existingKeyTableIdx = schema.getFactoryDbKeyHash512Col().newTableIdxKey();
		...
		CFBamDbKeyHash512ColByTableIdxKey newKeyTableIdx = schema.getFactoryDbKeyHash512Col().newTableIdxKey();
		...
		Map< CFBamValuePKey, CFBamDbKeyHash512ColBuff > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< CFBamValuePKey, CFBamDbKeyHash512ColBuff >();
	...
	public void deleteDbKeyHash512Col( CFSecAuthorization Authorization,
		CFBamDbKeyHash512ColBuff Buff )
	{
		final String S_ProcName = "CFBamRamDbKeyHash512ColTable.deleteDbKeyHash512Col() ";
		String classCode;
		CFBamValuePKey pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
	...
	public void deleteDbKeyHash512ColByTableIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argTableId )
	{
		CFBamDbKeyHash512ColByTableIdxKey key = schema.getFactoryDbKeyHash512Col().newTableIdxKey();
		...
		deleteDbKeyHash512ColByTableIdx( Authorization, key );
	}

	public void deleteDbKeyHash512ColByTableIdx( CFSecAuthorization Authorization,
		CFBamDbKeyHash512ColByTableIdxKey argKey )
	{
		CFBamDbKeyHash512ColBuff cur;
		...
		LinkedList<CFBamDbKeyHash512ColBuff> matchSet = new LinkedList<CFBamDbKeyHash512ColBuff>();
		Iterator<CFBamDbKeyHash512ColBuff> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamDbKeyHash512ColBuff> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = schema.getTableDbKeyHash512Col().readDerivedByIdIdx( Authorization,
				cur.getRequiredTenantId(),
				cur.getRequiredId() );
			deleteDbKeyHash512Col( Authorization, cur );
		}
	}

	public void deleteDbKeyHash512ColByIdIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argId )
	{
		CFBamValuePKey key = schema.getFactoryValue().newPKey();
		...
		deleteDbKeyHash512ColByIdIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash512ColByUNameIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		String argName )
	{
		...
		deleteDbKeyHash512ColByUNameIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash512ColByValTentIdx( CFSecAuthorization Authorization,
		long argTenantId )
	{
		CFBamValueByValTentIdxKey key = schema.getFactoryValue().newValTentIdxKey();
		key.setRequiredTenantId( argTenantId );
		deleteDbKeyHash512ColByValTentIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash512ColByScopeIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId )
	{
		...
		key.setRequiredTenantId( argTenantId );
		key.setRequiredScopeId( argScopeId );
		deleteDbKeyHash512ColByScopeIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash512ColByDefSchemaIdx( CFSecAuthorization Authorization,
		...
		Long argDefSchemaId )
	{
		...
		deleteDbKeyHash512ColByDefSchemaIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash512ColByPrevIdx( CFSecAuthorization Authorization,
		...
		Long argPrevId )
	{
		...
		deleteDbKeyHash512ColByPrevIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash512ColByNextIdx( CFSecAuthorization Authorization,
		...
		Long argNextId )
	{
		...
		deleteDbKeyHash512ColByNextIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash512ColByContPrevIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		Long argPrevId )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setOptionalPrevId( argPrevId );
		deleteDbKeyHash512ColByContPrevIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash512ColByContNextIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		Long argNextId )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setOptionalNextId( argNextId );
		deleteDbKeyHash512ColByContNextIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash512ColByCodeVisIdx( CFSecAuthorization Authorization,
		ICFBamSchema.CodeVisibilityEnum argCodeVis )
	{
		...
		deleteDbKeyHash512ColByCodeVisIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash512ColByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		ICFBamSchema.CodeVisibilityEnum argCodeVis )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setRequiredCodeVis( argCodeVis );
		deleteDbKeyHash512ColByScopeCodeVisIdx( Authorization, key );
	}
