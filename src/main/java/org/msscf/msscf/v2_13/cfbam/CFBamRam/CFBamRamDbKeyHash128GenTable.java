...
// Description: Java 11 in-memory RAM DbIO implementation for DbKeyHash128Gen.
...
/*
 *	CFBamRamDbKeyHash128GenTable in-memory RAM DbIO implementation
 *	for DbKeyHash128Gen.
 */
public class CFBamRamDbKeyHash128GenTable
	implements ICFBamDbKeyHash128GenTable
{
	private ICFBamSchema schema;
	private Map< CFBamValuePKey,
				CFBamDbKeyHash128GenBuff > dictByPKey
		= new HashMap< CFBamValuePKey,
				CFBamDbKeyHash128GenBuff >();
	private Map< CFBamDbKeyHash128GenByDispIdxKey,
				Map< CFBamValuePKey,
					CFBamDbKeyHash128GenBuff >> dictByDispIdx
		= new HashMap< CFBamDbKeyHash128GenByDispIdxKey,
				Map< CFBamValuePKey,
					CFBamDbKeyHash128GenBuff >>();

	public CFBamRamDbKeyHash128GenTable( ICFBamSchema argSchema ) {
		schema = argSchema;
	}

	public void createDbKeyHash128Gen( CFSecAuthorization Authorization,
		CFBamDbKeyHash128GenBuff Buff )
	{
		final String S_ProcName = "createDbKeyHash128Gen";
		CFBamValueBuff tail = null;
		if( Buff.getClassCode().equals( "a83e" ) ) {
		...
		schema.getTableDbKeyHash128Type().createDbKeyHash128Type( Authorization,
			Buff );
		CFBamValuePKey pkey = schema.getFactoryValue().newPKey();
		pkey.setClassCode( Buff.getClassCode() );
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
		CFBamDbKeyHash128GenByDispIdxKey keyDispIdx = schema.getFactoryDbKeyHash128Gen().newDispIdxKey();
...

		{
			...
			allNull = false;
			if( ! allNull ) {
				if( null == schema.getTableDbKeyHash128Type().readDerivedByIdIdx( Authorization,
						Buff.getRequiredTenantId(),
						Buff.getRequiredId() ) )
				{
		...
		Map< CFBamValuePKey, CFBamDbKeyHash128GenBuff > subdictDispIdx;
		if( dictByDispIdx.containsKey( keyDispIdx ) ) {
			subdictDispIdx = dictByDispIdx.get( keyDispIdx );
		}
		else {
			subdictDispIdx = new HashMap< CFBamValuePKey, CFBamDbKeyHash128GenBuff >();
	...
	public CFBamDbKeyHash128GenBuff readDerived( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash128Gen.readDerived";
	...
	public CFBamDbKeyHash128GenBuff lockDerived( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash128Gen.readDerived";
		CFBamValuePKey key = schema.getFactoryValue().newPKey();
	...
	public CFBamDbKeyHash128GenBuff[] readAllDerived( CFSecAuthorization Authorization ) {
		final String S_ProcName = "CFBamRamDbKeyHash128Gen.readAllDerived";
		CFBamDbKeyHash128GenBuff[] retList = new CFBamDbKeyHash128GenBuff[ dictByPKey.values().size() ];
		Iterator< CFBamDbKeyHash128GenBuff > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
	...
	public CFBamDbKeyHash128GenBuff readDerivedByUNameIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		String Name )
	{
		...
		else if( buff instanceof CFBamDbKeyHash128GenBuff ) {
			return( (CFBamDbKeyHash128GenBuff)buff );
		}
		else {
			return( null );
		}
	...
	public CFBamDbKeyHash128GenBuff[] readDerivedByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		...
		if( buffList == null ) {
			...
			CFBamValueBuff buff;
			ArrayList<CFBamDbKeyHash128GenBuff> filteredList = new ArrayList<CFBamDbKeyHash128GenBuff>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof CFBamDbKeyHash128GenBuff ) ) {
					filteredList.add( (CFBamDbKeyHash128GenBuff)buff );
				}
			}
			return( filteredList.toArray( new CFBamDbKeyHash128GenBuff[0] ) );
		}
	}

	public CFBamDbKeyHash128GenBuff[] readDerivedByScopeIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId )
	{
	...
	public CFBamDbKeyHash128GenBuff[] readDerivedByDefSchemaIdx( CFSecAuthorization Authorization,
	...
	public CFBamDbKeyHash128GenBuff[] readDerivedByPrevIdx( CFSecAuthorization Authorization,
		Long PrevTenantId,
		Long PrevId )
	{
	...
	public CFBamDbKeyHash128GenBuff[] readDerivedByNextIdx( CFSecAuthorization Authorization,
		Long NextTenantId,
		Long NextId )
	{
	...
	public CFBamDbKeyHash128GenBuff[] readDerivedByContPrevIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long PrevId )
	{
	...
	public CFBamDbKeyHash128GenBuff[] readDerivedByContNextIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long NextId )
	{
	...
	public CFBamDbKeyHash128GenBuff[] readDerivedByCodeVisIdx( CFSecAuthorization Authorization,
	...
	public CFBamDbKeyHash128GenBuff[] readDerivedByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
	...
	public CFBamDbKeyHash128GenBuff[] readDerivedBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId )
	{
		final String S_ProcName = "CFBamRamDbKeyHash128Type.readDerivedBySchemaIdx";
		CFBamDbKeyHash128TypeBuff buffList[] = schema.getTableDbKeyHash128Type().readDerivedBySchemaIdx( Authorization,
			TenantId,
			SchemaDefId );
		if( buffList == null ) {
			return( null );
	...
	public CFBamDbKeyHash128GenBuff[] readDerivedByDispIdx( CFSecAuthorization Authorization,
		Long DispenserTenantId,
		Long DispenserId )
	{
		final String S_ProcName = "CFBamRamDbKeyHash128Gen.readDerivedByDispIdx";
		CFBamDbKeyHash128GenByDispIdxKey key = schema.getFactoryDbKeyHash128Gen().newDispIdxKey();
		key.setOptionalDispenserTenantId( DispenserTenantId );
		key.setOptionalDispenserId( DispenserId );

		CFBamDbKeyHash128GenBuff[] recArray;
		if( dictByDispIdx.containsKey( key ) ) {
			Map< CFBamValuePKey, CFBamDbKeyHash128GenBuff > subdictDispIdx
				= dictByDispIdx.get( key );
			recArray = new CFBamDbKeyHash128GenBuff[ subdictDispIdx.size() ];
			Iterator< CFBamDbKeyHash128GenBuff > iter = subdictDispIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< CFBamValuePKey, CFBamDbKeyHash128GenBuff > subdictDispIdx
				= new HashMap< CFBamValuePKey, CFBamDbKeyHash128GenBuff >();
			dictByDispIdx.put( key, subdictDispIdx );
			recArray = new CFBamDbKeyHash128GenBuff[0];
		}
		return( recArray );
	}

	public CFBamDbKeyHash128GenBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		long TenantId,
		long Id )
	{
	...
	public CFBamDbKeyHash128GenBuff readBuff( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash128Gen.readBuff";
		CFBamDbKeyHash128GenBuff buff = readDerived( Authorization, PKey );
	...
	public CFBamDbKeyHash128GenBuff lockBuff( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
	...
	public CFBamDbKeyHash128GenBuff[] readAllBuff( CFSecAuthorization Authorization )
	{
		final String S_ProcName = "CFBamRamDbKeyHash128Gen.readAllBuff";
		CFBamDbKeyHash128GenBuff buff;
		ArrayList<CFBamDbKeyHash128GenBuff> filteredList = new ArrayList<CFBamDbKeyHash128GenBuff>();
		CFBamDbKeyHash128GenBuff[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a83e" ) ) {
	...
	public CFBamDbKeyHash128GenBuff readBuffByIdIdx( CFSecAuthorization Authorization,
		long TenantId,
		long Id )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByIdIdx() ";
		CFBamDbKeyHash128GenBuff buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
	...
	public CFBamDbKeyHash128GenBuff readBuffByUNameIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		String Name )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByUNameIdx() ";
		CFBamDbKeyHash128GenBuff buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash128GenBuff[] readBuffByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByValTentIdx() ";
		CFBamDbKeyHash128GenBuff buff;
		ArrayList<CFBamDbKeyHash128GenBuff> filteredList = new ArrayList<CFBamDbKeyHash128GenBuff>();
		CFBamDbKeyHash128GenBuff[] buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash128GenBuff[] readBuffByScopeIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId )
	{
		...
		CFBamDbKeyHash128GenBuff buff;
		ArrayList<CFBamDbKeyHash128GenBuff> filteredList = new ArrayList<CFBamDbKeyHash128GenBuff>();
		CFBamDbKeyHash128GenBuff[] buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash128GenBuff[] readBuffByDefSchemaIdx( CFSecAuthorization Authorization,
		Long DefSchemaTenantId,
		Long DefSchemaId )
	{
		...
		CFBamDbKeyHash128GenBuff buff;
		ArrayList<CFBamDbKeyHash128GenBuff> filteredList = new ArrayList<CFBamDbKeyHash128GenBuff>();
		CFBamDbKeyHash128GenBuff[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash128GenBuff[] readBuffByPrevIdx( CFSecAuthorization Authorization,
		Long PrevTenantId,
		Long PrevId )
	{
		...
		CFBamDbKeyHash128GenBuff buff;
		ArrayList<CFBamDbKeyHash128GenBuff> filteredList = new ArrayList<CFBamDbKeyHash128GenBuff>();
		CFBamDbKeyHash128GenBuff[] buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash128GenBuff[] readBuffByNextIdx( CFSecAuthorization Authorization,
		Long NextTenantId,
		Long NextId )
	{
		...
		CFBamDbKeyHash128GenBuff buff;
		ArrayList<CFBamDbKeyHash128GenBuff> filteredList = new ArrayList<CFBamDbKeyHash128GenBuff>();
		CFBamDbKeyHash128GenBuff[] buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash128GenBuff[] readBuffByContPrevIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long PrevId )
	{
		...
		CFBamDbKeyHash128GenBuff buff;
		ArrayList<CFBamDbKeyHash128GenBuff> filteredList = new ArrayList<CFBamDbKeyHash128GenBuff>();
		CFBamDbKeyHash128GenBuff[] buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash128GenBuff[] readBuffByContNextIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long NextId )
	{
		...
		CFBamDbKeyHash128GenBuff buff;
		ArrayList<CFBamDbKeyHash128GenBuff> filteredList = new ArrayList<CFBamDbKeyHash128GenBuff>();
		CFBamDbKeyHash128GenBuff[] buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash128GenBuff[] readBuffByCodeVisIdx( CFSecAuthorization Authorization,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByCodeVisIdx() ";
		CFBamDbKeyHash128GenBuff buff;
		ArrayList<CFBamDbKeyHash128GenBuff> filteredList = new ArrayList<CFBamDbKeyHash128GenBuff>();
		CFBamDbKeyHash128GenBuff[] buffList = readDerivedByCodeVisIdx( Authorization,
			CodeVis );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash128GenBuff[] readBuffByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		...
		CFBamDbKeyHash128GenBuff buff;
		ArrayList<CFBamDbKeyHash128GenBuff> filteredList = new ArrayList<CFBamDbKeyHash128GenBuff>();
		CFBamDbKeyHash128GenBuff[] buffList = readDerivedByScopeCodeVisIdx( Authorization,
			TenantId,
			ScopeId,
			CodeVis );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash128GenBuff[] readBuffBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId )
	{
		final String S_ProcName = "CFBamRamDbKeyHash128Type.readBuffBySchemaIdx() ";
		CFBamDbKeyHash128GenBuff buff;
		ArrayList<CFBamDbKeyHash128GenBuff> filteredList = new ArrayList<CFBamDbKeyHash128GenBuff>();
		CFBamDbKeyHash128GenBuff[] buffList = readDerivedBySchemaIdx( Authorization,
			TenantId,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash128GenBuff[] readBuffByDispIdx( CFSecAuthorization Authorization,
		Long DispenserTenantId,
		Long DispenserId )
	{
		final String S_ProcName = "CFBamRamDbKeyHash128Gen.readBuffByDispIdx() ";
		CFBamDbKeyHash128GenBuff buff;
		ArrayList<CFBamDbKeyHash128GenBuff> filteredList = new ArrayList<CFBamDbKeyHash128GenBuff>();
		CFBamDbKeyHash128GenBuff[] buffList = readDerivedByDispIdx( Authorization,
			DispenserTenantId,
			DispenserId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	/**
	 *	Read a page array of the specific DbKeyHash128Gen buffer instances identified by the duplicate key SchemaIdx.
	 *
	 ...
	 */
	public CFBamDbKeyHash128GenBuff[] pageBuffBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId,
		Long priorTenantId,
		Long priorId )
	...
	/**
	 *	Read a page array of the specific DbKeyHash128Gen buffer instances identified by the duplicate key DispIdx.
	 *
	 *	@param	Authorization	The session authorization information.
	 *
	 ...
	 *	@throws	CFLibNotSupportedException thrown by client-side implementations.
	 */
	public CFBamDbKeyHash128GenBuff[] pageBuffByDispIdx( CFSecAuthorization Authorization,
		Long DispenserTenantId,
		Long DispenserId,
		Long priorTenantId,
		Long priorId )
	 ...
	 */
	public CFBamDbKeyHash128GenBuff moveBuffUp( CFSecAuthorization Authorization,
		long TenantId,
		long Id,
		int revision )
	{
		...
		{
			return( (CFBamDbKeyHash128GenBuff)cur );
		}
		...
		return( (CFBamDbKeyHash128GenBuff)editCur );
	}
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public CFBamDbKeyHash128GenBuff moveBuffDown( CFSecAuthorization Authorization,
		long TenantId,
		long Id,
		int revision )
	{
	...
	public void updateDbKeyHash128Gen( CFSecAuthorization Authorization,
		CFBamDbKeyHash128GenBuff Buff )
	{
		schema.getTableDbKeyHash128Type().updateDbKeyHash128Type( Authorization,
			Buff );
		CFBamValuePKey pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
		CFBamDbKeyHash128GenBuff existing = dictByPKey.get( pkey );
		if( existing == null ) {
			throw new CFLibStaleCacheDetectedException( getClass(),
				"updateDbKeyHash128Gen",
				"Existing record not found",
				"DbKeyHash128Gen",
				pkey );
		}
		CFBamDbKeyHash128GenByDispIdxKey existingKeyDispIdx = schema.getFactoryDbKeyHash128Gen().newDispIdxKey();
		...
		CFBamDbKeyHash128GenByDispIdxKey newKeyDispIdx = schema.getFactoryDbKeyHash128Gen().newDispIdxKey();
		...
		Map< CFBamValuePKey, CFBamDbKeyHash128GenBuff > subdict;
		...
		if( dictByDispIdx.containsKey( newKeyDispIdx ) ) {
			...
			subdict = new HashMap< CFBamValuePKey, CFBamDbKeyHash128GenBuff >();
	...
	public void deleteDbKeyHash128Gen( CFSecAuthorization Authorization,
		CFBamDbKeyHash128GenBuff Buff )
	{
		final String S_ProcName = "CFBamRamDbKeyHash128GenTable.deleteDbKeyHash128Gen() ";
		String classCode;
		CFBamValuePKey pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
		...
		schema.getTableDbKeyHash128Type().deleteDbKeyHash128Type( Authorization,
			Buff );
	}
	public void deleteDbKeyHash128GenByDispIdx( CFSecAuthorization Authorization,
		...
		Long argDispenserId )
	{
		...
		deleteDbKeyHash128GenByDispIdx( Authorization, key );
	}

	public void deleteDbKeyHash128GenByDispIdx( CFSecAuthorization Authorization,
		CFBamDbKeyHash128GenByDispIdxKey argKey )
	{
		CFBamDbKeyHash128GenBuff cur;
		...
		LinkedList<CFBamDbKeyHash128GenBuff> matchSet = new LinkedList<CFBamDbKeyHash128GenBuff>();
		Iterator<CFBamDbKeyHash128GenBuff> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamDbKeyHash128GenBuff> iterMatch = matchSet.iterator();
	...
	public void deleteDbKeyHash128GenBySchemaIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argSchemaDefId )
	{
		CFBamDbKeyHash128TypeBySchemaIdxKey key = schema.getFactoryDbKeyHash128Type().newSchemaIdxKey();
		key.setRequiredTenantId( argTenantId );
		key.setRequiredSchemaDefId( argSchemaDefId );
		deleteDbKeyHash128GenBySchemaIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash128GenByIdIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argId )
	{
		CFBamValuePKey key = schema.getFactoryValue().newPKey();
		...
		deleteDbKeyHash128GenByIdIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash128GenByUNameIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		String argName )
	{
		...
		deleteDbKeyHash128GenByUNameIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash128GenByValTentIdx( CFSecAuthorization Authorization,
		long argTenantId )
	{
		CFBamValueByValTentIdxKey key = schema.getFactoryValue().newValTentIdxKey();
		key.setRequiredTenantId( argTenantId );
		deleteDbKeyHash128GenByValTentIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash128GenByScopeIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId )
	{
		...
		key.setRequiredTenantId( argTenantId );
		key.setRequiredScopeId( argScopeId );
		deleteDbKeyHash128GenByScopeIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash128GenByDefSchemaIdx( CFSecAuthorization Authorization,
		...
		Long argDefSchemaId )
	{
		...
		deleteDbKeyHash128GenByDefSchemaIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash128GenByPrevIdx( CFSecAuthorization Authorization,
		...
		Long argPrevId )
	{
		...
		deleteDbKeyHash128GenByPrevIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash128GenByNextIdx( CFSecAuthorization Authorization,
		...
		Long argNextId )
	{
		...
		deleteDbKeyHash128GenByNextIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash128GenByContPrevIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		Long argPrevId )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setOptionalPrevId( argPrevId );
		deleteDbKeyHash128GenByContPrevIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash128GenByContNextIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		Long argNextId )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setOptionalNextId( argNextId );
		deleteDbKeyHash128GenByContNextIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash128GenByCodeVisIdx( CFSecAuthorization Authorization,
		ICFBamSchema.CodeVisibilityEnum argCodeVis )
	{
		...
		deleteDbKeyHash128GenByCodeVisIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash128GenByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		ICFBamSchema.CodeVisibilityEnum argCodeVis )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setRequiredCodeVis( argCodeVis );
		deleteDbKeyHash128GenByScopeCodeVisIdx( Authorization, key );
	}
