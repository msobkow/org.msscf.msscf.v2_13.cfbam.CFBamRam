...
// Description: Java 11 in-memory RAM DbIO implementation for DbKeyHash512Type.
	...
	implements ICFBamDbKeyHash512TypeTable
{
	...
	private Map< CFBamValuePKey,
				CFBamDbKeyHash512TypeBuff > dictByPKey
		= new HashMap< CFBamValuePKey,
				CFBamDbKeyHash512TypeBuff >();
	private Map< CFBamDbKeyHash512TypeBySchemaIdxKey,
				Map< CFBamValuePKey,
					CFBamDbKeyHash512TypeBuff >> dictBySchemaIdx
		= new HashMap< CFBamDbKeyHash512TypeBySchemaIdxKey,
				Map< CFBamValuePKey,
					CFBamDbKeyHash512TypeBuff >>();
	...
	public void createDbKeyHash512Type( CFSecAuthorization Authorization,
		CFBamDbKeyHash512TypeBuff Buff )
	{
		...
		CFBamDbKeyHash512TypeBySchemaIdxKey keySchemaIdx = schema.getFactoryDbKeyHash512Type().newSchemaIdxKey();
		...
		Map< CFBamValuePKey, CFBamDbKeyHash512TypeBuff > subdictSchemaIdx;
		if( dictBySchemaIdx.containsKey( keySchemaIdx ) ) {
			subdictSchemaIdx = dictBySchemaIdx.get( keySchemaIdx );
		}
		else {
			subdictSchemaIdx = new HashMap< CFBamValuePKey, CFBamDbKeyHash512TypeBuff >();
	...
	public CFBamDbKeyHash512TypeBuff readDerived( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
	...
	public CFBamDbKeyHash512TypeBuff lockDerived( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash512Type.readDerived";
		CFBamValuePKey key = schema.getFactoryValue().newPKey();
	...
	public CFBamDbKeyHash512TypeBuff[] readAllDerived( CFSecAuthorization Authorization ) {
		final String S_ProcName = "CFBamRamDbKeyHash512Type.readAllDerived";
		CFBamDbKeyHash512TypeBuff[] retList = new CFBamDbKeyHash512TypeBuff[ dictByPKey.values().size() ];
		Iterator< CFBamDbKeyHash512TypeBuff > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
	...
	public CFBamDbKeyHash512TypeBuff readDerivedByUNameIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		String Name )
	{
		...
		else if( buff instanceof CFBamDbKeyHash512TypeBuff ) {
			return( (CFBamDbKeyHash512TypeBuff)buff );
		}
		else {
			return( null );
		}
	...
	public CFBamDbKeyHash512TypeBuff[] readDerivedByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		...
		if( buffList == null ) {
			...
			CFBamValueBuff buff;
			ArrayList<CFBamDbKeyHash512TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash512TypeBuff>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof CFBamDbKeyHash512TypeBuff ) ) {
					filteredList.add( (CFBamDbKeyHash512TypeBuff)buff );
				}
			}
			return( filteredList.toArray( new CFBamDbKeyHash512TypeBuff[0] ) );
		}
	}

	public CFBamDbKeyHash512TypeBuff[] readDerivedByScopeIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId )
	{
	...
	public CFBamDbKeyHash512TypeBuff[] readDerivedByDefSchemaIdx( CFSecAuthorization Authorization,
	...
	public CFBamDbKeyHash512TypeBuff[] readDerivedByPrevIdx( CFSecAuthorization Authorization,
		Long PrevTenantId,
		Long PrevId )
	{
	...
	public CFBamDbKeyHash512TypeBuff[] readDerivedByNextIdx( CFSecAuthorization Authorization,
		Long NextTenantId,
		Long NextId )
	{
	...
	public CFBamDbKeyHash512TypeBuff[] readDerivedByContPrevIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long PrevId )
	{
	...
	public CFBamDbKeyHash512TypeBuff[] readDerivedByContNextIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long NextId )
	{
	...
	public CFBamDbKeyHash512TypeBuff[] readDerivedByCodeVisIdx( CFSecAuthorization Authorization,
	...
	public CFBamDbKeyHash512TypeBuff[] readDerivedByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
	...
	public CFBamDbKeyHash512TypeBuff[] readDerivedBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId )
	{
		...
		CFBamDbKeyHash512TypeBuff[] recArray;
		if( dictBySchemaIdx.containsKey( key ) ) {
			Map< CFBamValuePKey, CFBamDbKeyHash512TypeBuff > subdictSchemaIdx
				= dictBySchemaIdx.get( key );
			recArray = new CFBamDbKeyHash512TypeBuff[ subdictSchemaIdx.size() ];
			Iterator< CFBamDbKeyHash512TypeBuff > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< CFBamValuePKey, CFBamDbKeyHash512TypeBuff > subdictSchemaIdx
				= new HashMap< CFBamValuePKey, CFBamDbKeyHash512TypeBuff >();
			dictBySchemaIdx.put( key, subdictSchemaIdx );
			recArray = new CFBamDbKeyHash512TypeBuff[0];
		}
		return( recArray );
	}

	public CFBamDbKeyHash512TypeBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		long TenantId,
		long Id )
	{
	...
	public CFBamDbKeyHash512TypeBuff readBuff( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash512Type.readBuff";
		CFBamDbKeyHash512TypeBuff buff = readDerived( Authorization, PKey );
	...
	public CFBamDbKeyHash512TypeBuff lockBuff( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
	...
	public CFBamDbKeyHash512TypeBuff[] readAllBuff( CFSecAuthorization Authorization )
	{
		final String S_ProcName = "CFBamRamDbKeyHash512Type.readAllBuff";
		CFBamDbKeyHash512TypeBuff buff;
		ArrayList<CFBamDbKeyHash512TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash512TypeBuff>();
		CFBamDbKeyHash512TypeBuff[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a851" ) ) {
	...
	public CFBamDbKeyHash512TypeBuff readBuffByIdIdx( CFSecAuthorization Authorization,
		long TenantId,
		long Id )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByIdIdx() ";
		CFBamDbKeyHash512TypeBuff buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
	...
	public CFBamDbKeyHash512TypeBuff readBuffByUNameIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		String Name )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByUNameIdx() ";
		CFBamDbKeyHash512TypeBuff buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash512TypeBuff[] readBuffByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByValTentIdx() ";
		CFBamDbKeyHash512TypeBuff buff;
		ArrayList<CFBamDbKeyHash512TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash512TypeBuff>();
		CFBamDbKeyHash512TypeBuff[] buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash512TypeBuff[] readBuffByScopeIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId )
	{
		...
		CFBamDbKeyHash512TypeBuff buff;
		ArrayList<CFBamDbKeyHash512TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash512TypeBuff>();
		CFBamDbKeyHash512TypeBuff[] buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash512TypeBuff[] readBuffByDefSchemaIdx( CFSecAuthorization Authorization,
		Long DefSchemaTenantId,
		Long DefSchemaId )
	{
		...
		CFBamDbKeyHash512TypeBuff buff;
		ArrayList<CFBamDbKeyHash512TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash512TypeBuff>();
		CFBamDbKeyHash512TypeBuff[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash512TypeBuff[] readBuffByPrevIdx( CFSecAuthorization Authorization,
		Long PrevTenantId,
		Long PrevId )
	{
		...
		CFBamDbKeyHash512TypeBuff buff;
		ArrayList<CFBamDbKeyHash512TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash512TypeBuff>();
		CFBamDbKeyHash512TypeBuff[] buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash512TypeBuff[] readBuffByNextIdx( CFSecAuthorization Authorization,
		Long NextTenantId,
		Long NextId )
	{
		...
		CFBamDbKeyHash512TypeBuff buff;
		ArrayList<CFBamDbKeyHash512TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash512TypeBuff>();
		CFBamDbKeyHash512TypeBuff[] buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash512TypeBuff[] readBuffByContPrevIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long PrevId )
	{
		...
		CFBamDbKeyHash512TypeBuff buff;
		ArrayList<CFBamDbKeyHash512TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash512TypeBuff>();
		CFBamDbKeyHash512TypeBuff[] buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash512TypeBuff[] readBuffByContNextIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long NextId )
	{
		...
		CFBamDbKeyHash512TypeBuff buff;
		ArrayList<CFBamDbKeyHash512TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash512TypeBuff>();
		CFBamDbKeyHash512TypeBuff[] buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash512TypeBuff[] readBuffByCodeVisIdx( CFSecAuthorization Authorization,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByCodeVisIdx() ";
		CFBamDbKeyHash512TypeBuff buff;
		ArrayList<CFBamDbKeyHash512TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash512TypeBuff>();
		CFBamDbKeyHash512TypeBuff[] buffList = readDerivedByCodeVisIdx( Authorization,
			CodeVis );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash512TypeBuff[] readBuffByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		...
		CFBamDbKeyHash512TypeBuff buff;
		ArrayList<CFBamDbKeyHash512TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash512TypeBuff>();
		CFBamDbKeyHash512TypeBuff[] buffList = readDerivedByScopeCodeVisIdx( Authorization,
			TenantId,
			ScopeId,
			CodeVis );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash512TypeBuff[] readBuffBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId )
	{
		...
		CFBamDbKeyHash512TypeBuff buff;
		ArrayList<CFBamDbKeyHash512TypeBuff> filteredList = new ArrayList<CFBamDbKeyHash512TypeBuff>();
		CFBamDbKeyHash512TypeBuff[] buffList = readDerivedBySchemaIdx( Authorization,
			TenantId,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	/**
	 *	Read a page array of the specific DbKeyHash512Type buffer instances identified by the duplicate key SchemaIdx.
	 *
	 ...
	 */
	public CFBamDbKeyHash512TypeBuff[] pageBuffBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId,
		Long priorTenantId,
		Long priorId )
	 ...
	 */
	public CFBamDbKeyHash512TypeBuff moveBuffUp( CFSecAuthorization Authorization,
		long TenantId,
		long Id,
		int revision )
	{
		...
		{
			return( (CFBamDbKeyHash512TypeBuff)cur );
		}
		...
		return( (CFBamDbKeyHash512TypeBuff)editCur );
	}
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public CFBamDbKeyHash512TypeBuff moveBuffDown( CFSecAuthorization Authorization,
		long TenantId,
		long Id,
		int revision )
	{
	...
	public void updateDbKeyHash512Type( CFSecAuthorization Authorization,
		CFBamDbKeyHash512TypeBuff Buff )
	{
		...
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
		CFBamDbKeyHash512TypeBuff existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamDbKeyHash512TypeBySchemaIdxKey existingKeySchemaIdx = schema.getFactoryDbKeyHash512Type().newSchemaIdxKey();
		...
		CFBamDbKeyHash512TypeBySchemaIdxKey newKeySchemaIdx = schema.getFactoryDbKeyHash512Type().newSchemaIdxKey();
		...
		Map< CFBamValuePKey, CFBamDbKeyHash512TypeBuff > subdict;
		...
		if( dictBySchemaIdx.containsKey( newKeySchemaIdx ) ) {
			...
			subdict = new HashMap< CFBamValuePKey, CFBamDbKeyHash512TypeBuff >();
	...
	public void deleteDbKeyHash512Type( CFSecAuthorization Authorization,
		CFBamDbKeyHash512TypeBuff Buff )
	{
	...
	public void deleteDbKeyHash512TypeBySchemaIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argSchemaDefId )
	{
		CFBamDbKeyHash512TypeBySchemaIdxKey key = schema.getFactoryDbKeyHash512Type().newSchemaIdxKey();
		...
		CFBamDbKeyHash512TypeBySchemaIdxKey argKey )
	{
		...
		LinkedList<CFBamDbKeyHash512TypeBuff> matchSet = new LinkedList<CFBamDbKeyHash512TypeBuff>();
		Iterator<CFBamDbKeyHash512TypeBuff> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamDbKeyHash512TypeBuff> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = schema.getTableDbKeyHash512Type().readDerivedByIdIdx( Authorization,
			...
			if( "a851".equals( subClassCode ) ) {
				...
				throw new CFLibUnsupportedClassException( getClass(),
					...
					"subClassCode",
					cur,
					"Instance of or subclass of DbKeyHash512Type must not be \"" + subClassCode + "\"" );
			}
		}
	}

	public void deleteDbKeyHash512TypeByIdIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argId )
	{
		CFBamValuePKey key = schema.getFactoryValue().newPKey();
		...
		deleteDbKeyHash512TypeByIdIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash512TypeByUNameIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		String argName )
	{
	...
	public void deleteDbKeyHash512TypeByValTentIdx( CFSecAuthorization Authorization,
		long argTenantId )
	{
		CFBamValueByValTentIdxKey key = schema.getFactoryValue().newValTentIdxKey();
		key.setRequiredTenantId( argTenantId );
		deleteDbKeyHash512TypeByValTentIdx( Authorization, key );
	}

	public void deleteDbKeyHash512TypeByValTentIdx( CFSecAuthorization Authorization,
		CFBamValueByValTentIdxKey argKey )
	{
		final String S_ProcName = "deleteDbKeyHash512TypeByValTentIdx";
		CFBamDbKeyHash512TypeBuff cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
	...
	public void deleteDbKeyHash512TypeByScopeIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId )
	{
	...
	public void deleteDbKeyHash512TypeByDefSchemaIdx( CFSecAuthorization Authorization,
	...
	public void deleteDbKeyHash512TypeByPrevIdx( CFSecAuthorization Authorization,
	...
	public void deleteDbKeyHash512TypeByNextIdx( CFSecAuthorization Authorization,
	...
	public void deleteDbKeyHash512TypeByContPrevIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		Long argPrevId )
	{
	...
	public void deleteDbKeyHash512TypeByContNextIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		Long argNextId )
	{
	...
	public void deleteDbKeyHash512TypeByCodeVisIdx( CFSecAuthorization Authorization,
		ICFBamSchema.CodeVisibilityEnum argCodeVis )
	{
		...
		deleteDbKeyHash512TypeByCodeVisIdx( Authorization, key );
	}

	public void deleteDbKeyHash512TypeByCodeVisIdx( CFSecAuthorization Authorization,
		CFBamValueByCodeVisIdxKey argKey )
	{
		final String S_ProcName = "deleteDbKeyHash512TypeByCodeVisIdx";
		CFBamDbKeyHash512TypeBuff cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
	...
	public void deleteDbKeyHash512TypeByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		ICFBamSchema.CodeVisibilityEnum argCodeVis )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setRequiredCodeVis( argCodeVis );
		deleteDbKeyHash512TypeByScopeCodeVisIdx( Authorization, key );
	}

	public void deleteDbKeyHash512TypeByScopeCodeVisIdx( CFSecAuthorization Authorization,
		CFBamValueByScopeCodeVisIdxKey argKey )
	{
		final String S_ProcName = "deleteDbKeyHash512TypeByScopeCodeVisIdx";
		CFBamDbKeyHash512TypeBuff cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		anyNotNull = true;
