...
// Description: Java 11 in-memory RAM DbIO implementation for DbKeyHash256Gen.
...
/*
 *	CFBamRamDbKeyHash256GenTable in-memory RAM DbIO implementation
 *	for DbKeyHash256Gen.
 */
public class CFBamRamDbKeyHash256GenTable
	implements ICFBamDbKeyHash256GenTable
{
	private ICFBamSchema schema;
	private Map< CFBamValuePKey,
				CFBamDbKeyHash256GenBuff > dictByPKey
		= new HashMap< CFBamValuePKey,
				CFBamDbKeyHash256GenBuff >();
	private Map< CFBamDbKeyHash256GenByDispIdxKey,
				Map< CFBamValuePKey,
					CFBamDbKeyHash256GenBuff >> dictByDispIdx
		= new HashMap< CFBamDbKeyHash256GenByDispIdxKey,
				Map< CFBamValuePKey,
					CFBamDbKeyHash256GenBuff >>();

	public CFBamRamDbKeyHash256GenTable( ICFBamSchema argSchema ) {
		schema = argSchema;
	}

	public void createDbKeyHash256Gen( CFSecAuthorization Authorization,
		CFBamDbKeyHash256GenBuff Buff )
	{
		final String S_ProcName = "createDbKeyHash256Gen";
		...
		schema.getTableDbKeyHash256Type().createDbKeyHash256Type( Authorization,
			Buff );
		CFBamValuePKey pkey = schema.getFactoryValue().newPKey();
		pkey.setClassCode( Buff.getClassCode() );
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
		CFBamDbKeyHash256GenByDispIdxKey keyDispIdx = schema.getFactoryDbKeyHash256Gen().newDispIdxKey();
...

		{
			...
			allNull = false;
			if( ! allNull ) {
				if( null == schema.getTableDbKeyHash256Type().readDerivedByIdIdx( Authorization,
						Buff.getRequiredTenantId(),
						Buff.getRequiredId() ) )
				{
		...
		Map< CFBamValuePKey, CFBamDbKeyHash256GenBuff > subdictDispIdx;
		if( dictByDispIdx.containsKey( keyDispIdx ) ) {
			subdictDispIdx = dictByDispIdx.get( keyDispIdx );
		}
		else {
			subdictDispIdx = new HashMap< CFBamValuePKey, CFBamDbKeyHash256GenBuff >();
	...
	public CFBamDbKeyHash256GenBuff readDerived( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash256Gen.readDerived";
	...
	public CFBamDbKeyHash256GenBuff lockDerived( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash256Gen.readDerived";
		CFBamValuePKey key = schema.getFactoryValue().newPKey();
	...
	public CFBamDbKeyHash256GenBuff[] readAllDerived( CFSecAuthorization Authorization ) {
		final String S_ProcName = "CFBamRamDbKeyHash256Gen.readAllDerived";
		CFBamDbKeyHash256GenBuff[] retList = new CFBamDbKeyHash256GenBuff[ dictByPKey.values().size() ];
		Iterator< CFBamDbKeyHash256GenBuff > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
	...
	public CFBamDbKeyHash256GenBuff readDerivedByUNameIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		String Name )
	{
		...
		else if( buff instanceof CFBamDbKeyHash256GenBuff ) {
			return( (CFBamDbKeyHash256GenBuff)buff );
		}
		else {
			return( null );
		}
	...
	public CFBamDbKeyHash256GenBuff[] readDerivedByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
	...
	public CFBamDbKeyHash256GenBuff[] readDerivedByScopeIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId )
	{
	...
	public CFBamDbKeyHash256GenBuff[] readDerivedByDefSchemaIdx( CFSecAuthorization Authorization,
	...
	public CFBamDbKeyHash256GenBuff[] readDerivedByPrevIdx( CFSecAuthorization Authorization,
		Long PrevTenantId,
		Long PrevId )
	{
	...
	public CFBamDbKeyHash256GenBuff[] readDerivedByNextIdx( CFSecAuthorization Authorization,
		Long NextTenantId,
		Long NextId )
	{
	...
	public CFBamDbKeyHash256GenBuff[] readDerivedByContPrevIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long PrevId )
	{
	...
	public CFBamDbKeyHash256GenBuff[] readDerivedByContNextIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long NextId )
	{
		...
		long SchemaDefId )
	{
		...
		CFBamDbKeyHash256TypeBuff buffList[] = schema.getTableDbKeyHash256Type().readDerivedBySchemaIdx( Authorization,
			TenantId,
			SchemaDefId );
		if( buffList == null ) {
			return( null );
	...
	public CFBamDbKeyHash256GenBuff[] readDerivedByDispIdx( CFSecAuthorization Authorization,
		Long DispenserTenantId,
		Long DispenserId )
	{
		final String S_ProcName = "CFBamRamDbKeyHash256Gen.readDerivedByDispIdx";
		CFBamDbKeyHash256GenByDispIdxKey key = schema.getFactoryDbKeyHash256Gen().newDispIdxKey();
		key.setOptionalDispenserTenantId( DispenserTenantId );
		key.setOptionalDispenserId( DispenserId );

		CFBamDbKeyHash256GenBuff[] recArray;
		if( dictByDispIdx.containsKey( key ) ) {
			Map< CFBamValuePKey, CFBamDbKeyHash256GenBuff > subdictDispIdx
				= dictByDispIdx.get( key );
			recArray = new CFBamDbKeyHash256GenBuff[ subdictDispIdx.size() ];
			Iterator< CFBamDbKeyHash256GenBuff > iter = subdictDispIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< CFBamValuePKey, CFBamDbKeyHash256GenBuff > subdictDispIdx
				= new HashMap< CFBamValuePKey, CFBamDbKeyHash256GenBuff >();
			dictByDispIdx.put( key, subdictDispIdx );
			recArray = new CFBamDbKeyHash256GenBuff[0];
		}
		return( recArray );
	}

	public CFBamDbKeyHash256GenBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		long TenantId,
		long Id )
	{
	...
	public CFBamDbKeyHash256GenBuff readBuff( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash256Gen.readBuff";
		CFBamDbKeyHash256GenBuff buff = readDerived( Authorization, PKey );
	...
	public CFBamDbKeyHash256GenBuff lockBuff( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
	...
	public CFBamDbKeyHash256GenBuff[] readAllBuff( CFSecAuthorization Authorization )
	{
		final String S_ProcName = "CFBamRamDbKeyHash256Gen.readAllBuff";
		CFBamDbKeyHash256GenBuff buff;
		ArrayList<CFBamDbKeyHash256GenBuff> filteredList = new ArrayList<CFBamDbKeyHash256GenBuff>();
		CFBamDbKeyHash256GenBuff[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a84a" ) ) {
	...
	public CFBamDbKeyHash256GenBuff readBuffByIdIdx( CFSecAuthorization Authorization,
		long TenantId,
		long Id )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByIdIdx() ";
		CFBamDbKeyHash256GenBuff buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
	...
	public CFBamDbKeyHash256GenBuff readBuffByUNameIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		String Name )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByUNameIdx() ";
		CFBamDbKeyHash256GenBuff buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash256GenBuff[] readBuffByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByValTentIdx() ";
		CFBamDbKeyHash256GenBuff buff;
		ArrayList<CFBamDbKeyHash256GenBuff> filteredList = new ArrayList<CFBamDbKeyHash256GenBuff>();
		CFBamDbKeyHash256GenBuff[] buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash256GenBuff[] readBuffByScopeIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId )
	{
		...
		CFBamDbKeyHash256GenBuff buff;
		ArrayList<CFBamDbKeyHash256GenBuff> filteredList = new ArrayList<CFBamDbKeyHash256GenBuff>();
		CFBamDbKeyHash256GenBuff[] buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash256GenBuff[] readBuffByDefSchemaIdx( CFSecAuthorization Authorization,
		Long DefSchemaTenantId,
		Long DefSchemaId )
	{
		...
		CFBamDbKeyHash256GenBuff buff;
		ArrayList<CFBamDbKeyHash256GenBuff> filteredList = new ArrayList<CFBamDbKeyHash256GenBuff>();
		CFBamDbKeyHash256GenBuff[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash256GenBuff[] readBuffByPrevIdx( CFSecAuthorization Authorization,
		Long PrevTenantId,
		Long PrevId )
	{
		...
		CFBamDbKeyHash256GenBuff buff;
		ArrayList<CFBamDbKeyHash256GenBuff> filteredList = new ArrayList<CFBamDbKeyHash256GenBuff>();
		CFBamDbKeyHash256GenBuff[] buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash256GenBuff[] readBuffByNextIdx( CFSecAuthorization Authorization,
		Long NextTenantId,
		Long NextId )
	{
		...
		CFBamDbKeyHash256GenBuff buff;
		ArrayList<CFBamDbKeyHash256GenBuff> filteredList = new ArrayList<CFBamDbKeyHash256GenBuff>();
		CFBamDbKeyHash256GenBuff[] buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash256GenBuff[] readBuffByContPrevIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long PrevId )
	{
		...
		CFBamDbKeyHash256GenBuff buff;
		ArrayList<CFBamDbKeyHash256GenBuff> filteredList = new ArrayList<CFBamDbKeyHash256GenBuff>();
		CFBamDbKeyHash256GenBuff[] buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash256GenBuff[] readBuffByContNextIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long NextId )
	{
		...
		CFBamDbKeyHash256GenBuff buff;
		ArrayList<CFBamDbKeyHash256GenBuff> filteredList = new ArrayList<CFBamDbKeyHash256GenBuff>();
		CFBamDbKeyHash256GenBuff[] buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash256GenBuff[] readBuffBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId )
	{
		...
		CFBamDbKeyHash256GenBuff buff;
		ArrayList<CFBamDbKeyHash256GenBuff> filteredList = new ArrayList<CFBamDbKeyHash256GenBuff>();
		CFBamDbKeyHash256GenBuff[] buffList = readDerivedBySchemaIdx( Authorization,
			TenantId,
			SchemaDefId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash256GenBuff[] readBuffByDispIdx( CFSecAuthorization Authorization,
		Long DispenserTenantId,
		Long DispenserId )
	{
		final String S_ProcName = "CFBamRamDbKeyHash256Gen.readBuffByDispIdx() ";
		CFBamDbKeyHash256GenBuff buff;
		ArrayList<CFBamDbKeyHash256GenBuff> filteredList = new ArrayList<CFBamDbKeyHash256GenBuff>();
		CFBamDbKeyHash256GenBuff[] buffList = readDerivedByDispIdx( Authorization,
			DispenserTenantId,
			DispenserId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	/**
	 *	Read a page array of the specific DbKeyHash256Gen buffer instances identified by the duplicate key SchemaIdx.
	 *
	 ...
	 */
	public CFBamDbKeyHash256GenBuff[] pageBuffBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId,
		Long priorTenantId,
		Long priorId )
	...
	/**
	 *	Read a page array of the specific DbKeyHash256Gen buffer instances identified by the duplicate key DispIdx.
	 *
	 *	@param	Authorization	The session authorization information.
	 *
	 ...
	 *	@throws	CFLibNotSupportedException thrown by client-side implementations.
	 */
	public CFBamDbKeyHash256GenBuff[] pageBuffByDispIdx( CFSecAuthorization Authorization,
		Long DispenserTenantId,
		Long DispenserId,
		Long priorTenantId,
		Long priorId )
	 ...
	 */
	public CFBamDbKeyHash256GenBuff moveBuffUp( CFSecAuthorization Authorization,
		long TenantId,
		long Id,
		int revision )
	{
		...
		{
			return( (CFBamDbKeyHash256GenBuff)cur );
		}
		...
		return( (CFBamDbKeyHash256GenBuff)editCur );
	}
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public CFBamDbKeyHash256GenBuff moveBuffDown( CFSecAuthorization Authorization,
		long TenantId,
		long Id,
		int revision )
	{
	...
	public void updateDbKeyHash256Gen( CFSecAuthorization Authorization,
		CFBamDbKeyHash256GenBuff Buff )
	{
		schema.getTableDbKeyHash256Type().updateDbKeyHash256Type( Authorization,
			Buff );
		CFBamValuePKey pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
		CFBamDbKeyHash256GenBuff existing = dictByPKey.get( pkey );
		if( existing == null ) {
			throw new CFLibStaleCacheDetectedException( getClass(),
				"updateDbKeyHash256Gen",
				"Existing record not found",
				"DbKeyHash256Gen",
				pkey );
		}
		CFBamDbKeyHash256GenByDispIdxKey existingKeyDispIdx = schema.getFactoryDbKeyHash256Gen().newDispIdxKey();
		...
		CFBamDbKeyHash256GenByDispIdxKey newKeyDispIdx = schema.getFactoryDbKeyHash256Gen().newDispIdxKey();
		...
		Map< CFBamValuePKey, CFBamDbKeyHash256GenBuff > subdict;
		...
		if( dictByDispIdx.containsKey( newKeyDispIdx ) ) {
			...
			subdict = new HashMap< CFBamValuePKey, CFBamDbKeyHash256GenBuff >();
	...
	public void deleteDbKeyHash256Gen( CFSecAuthorization Authorization,
		CFBamDbKeyHash256GenBuff Buff )
	{
		final String S_ProcName = "CFBamRamDbKeyHash256GenTable.deleteDbKeyHash256Gen() ";
		String classCode;
		CFBamValuePKey pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
		...
		schema.getTableDbKeyHash256Type().deleteDbKeyHash256Type( Authorization,
			Buff );
	}
	public void deleteDbKeyHash256GenByDispIdx( CFSecAuthorization Authorization,
		...
		Long argDispenserId )
	{
		...
		deleteDbKeyHash256GenByDispIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash256GenBySchemaIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argSchemaDefId )
	{
		...
		deleteDbKeyHash256GenBySchemaIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash256GenByIdIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argId )
	{
		CFBamValuePKey key = schema.getFactoryValue().newPKey();
		...
		deleteDbKeyHash256GenByIdIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash256GenByUNameIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		String argName )
	{
		...
		deleteDbKeyHash256GenByUNameIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash256GenByValTentIdx( CFSecAuthorization Authorization,
		long argTenantId )
	{
		CFBamValueByValTentIdxKey key = schema.getFactoryValue().newValTentIdxKey();
		key.setRequiredTenantId( argTenantId );
		deleteDbKeyHash256GenByValTentIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash256GenByScopeIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId )
	{
		...
		key.setRequiredTenantId( argTenantId );
		key.setRequiredScopeId( argScopeId );
		deleteDbKeyHash256GenByScopeIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash256GenByDefSchemaIdx( CFSecAuthorization Authorization,
		...
		Long argDefSchemaId )
	{
		...
		deleteDbKeyHash256GenByDefSchemaIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash256GenByPrevIdx( CFSecAuthorization Authorization,
		...
		Long argPrevId )
	{
		...
		deleteDbKeyHash256GenByPrevIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash256GenByNextIdx( CFSecAuthorization Authorization,
		...
		Long argNextId )
	{
		...
		deleteDbKeyHash256GenByNextIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash256GenByContPrevIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		Long argPrevId )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setOptionalPrevId( argPrevId );
		deleteDbKeyHash256GenByContPrevIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash256GenByContNextIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		Long argNextId )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setOptionalNextId( argNextId );
		deleteDbKeyHash256GenByContNextIdx( Authorization, key );
	}
