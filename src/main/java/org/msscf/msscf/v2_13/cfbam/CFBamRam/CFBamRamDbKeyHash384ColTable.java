...
// Description: Java 11 in-memory RAM DbIO implementation for DbKeyHash384Col.
...
/*
 *	CFBamRamDbKeyHash384ColTable in-memory RAM DbIO implementation
 *	for DbKeyHash384Col.
 */
public class CFBamRamDbKeyHash384ColTable
	implements ICFBamDbKeyHash384ColTable
{
	private ICFBamSchema schema;
	private Map< CFBamValuePKey,
				CFBamDbKeyHash384ColBuff > dictByPKey
		= new HashMap< CFBamValuePKey,
				CFBamDbKeyHash384ColBuff >();
	private Map< CFBamDbKeyHash384ColByTableIdxKey,
				Map< CFBamValuePKey,
					CFBamDbKeyHash384ColBuff >> dictByTableIdx
		= new HashMap< CFBamDbKeyHash384ColByTableIdxKey,
				Map< CFBamValuePKey,
					CFBamDbKeyHash384ColBuff >>();

	public CFBamRamDbKeyHash384ColTable( ICFBamSchema argSchema ) {
		schema = argSchema;
	}

	public void createDbKeyHash384Col( CFSecAuthorization Authorization,
		CFBamDbKeyHash384ColBuff Buff )
	{
		final String S_ProcName = "createDbKeyHash384Col";
		CFBamValueBuff tail = null;
		if( Buff.getClassCode().equals( "a84c" ) ) {
		...
		CFBamDbKeyHash384ColByTableIdxKey keyTableIdx = schema.getFactoryDbKeyHash384Col().newTableIdxKey();
		...
		Map< CFBamValuePKey, CFBamDbKeyHash384ColBuff > subdictTableIdx;
		if( dictByTableIdx.containsKey( keyTableIdx ) ) {
			subdictTableIdx = dictByTableIdx.get( keyTableIdx );
		}
		else {
			subdictTableIdx = new HashMap< CFBamValuePKey, CFBamDbKeyHash384ColBuff >();
	...
	public CFBamDbKeyHash384ColBuff readDerived( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash384Col.readDerived";
	...
	public CFBamDbKeyHash384ColBuff lockDerived( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash384Col.readDerived";
		CFBamValuePKey key = schema.getFactoryValue().newPKey();
	...
	public CFBamDbKeyHash384ColBuff[] readAllDerived( CFSecAuthorization Authorization ) {
		final String S_ProcName = "CFBamRamDbKeyHash384Col.readAllDerived";
		CFBamDbKeyHash384ColBuff[] retList = new CFBamDbKeyHash384ColBuff[ dictByPKey.values().size() ];
		Iterator< CFBamDbKeyHash384ColBuff > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
	...
	public CFBamDbKeyHash384ColBuff readDerivedByUNameIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		String Name )
	{
		...
		else if( buff instanceof CFBamDbKeyHash384ColBuff ) {
			return( (CFBamDbKeyHash384ColBuff)buff );
		}
		else {
			return( null );
		}
	...
	public CFBamDbKeyHash384ColBuff[] readDerivedByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		...
		if( buffList == null ) {
			...
			CFBamValueBuff buff;
			ArrayList<CFBamDbKeyHash384ColBuff> filteredList = new ArrayList<CFBamDbKeyHash384ColBuff>();
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[idx];
				if( ( buff != null ) && ( buff instanceof CFBamDbKeyHash384ColBuff ) ) {
					filteredList.add( (CFBamDbKeyHash384ColBuff)buff );
				}
			}
			return( filteredList.toArray( new CFBamDbKeyHash384ColBuff[0] ) );
		}
	}

	public CFBamDbKeyHash384ColBuff[] readDerivedByScopeIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId )
	{
	...
	public CFBamDbKeyHash384ColBuff[] readDerivedByDefSchemaIdx( CFSecAuthorization Authorization,
	...
	public CFBamDbKeyHash384ColBuff[] readDerivedByPrevIdx( CFSecAuthorization Authorization,
		Long PrevTenantId,
		Long PrevId )
	{
	...
	public CFBamDbKeyHash384ColBuff[] readDerivedByNextIdx( CFSecAuthorization Authorization,
		Long NextTenantId,
		Long NextId )
	{
	...
	public CFBamDbKeyHash384ColBuff[] readDerivedByContPrevIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long PrevId )
	{
	...
	public CFBamDbKeyHash384ColBuff[] readDerivedByContNextIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long NextId )
	{
	...
	public CFBamDbKeyHash384ColBuff[] readDerivedByCodeVisIdx( CFSecAuthorization Authorization,
	...
	public CFBamDbKeyHash384ColBuff[] readDerivedByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
	...
	public CFBamDbKeyHash384ColBuff[] readDerivedByTableIdx( CFSecAuthorization Authorization,
		long TenantId,
		long TableId )
	{
		final String S_ProcName = "CFBamRamDbKeyHash384Col.readDerivedByTableIdx";
		CFBamDbKeyHash384ColByTableIdxKey key = schema.getFactoryDbKeyHash384Col().newTableIdxKey();
		key.setRequiredTenantId( TenantId );
		key.setRequiredTableId( TableId );

		CFBamDbKeyHash384ColBuff[] recArray;
		if( dictByTableIdx.containsKey( key ) ) {
			Map< CFBamValuePKey, CFBamDbKeyHash384ColBuff > subdictTableIdx
				= dictByTableIdx.get( key );
			recArray = new CFBamDbKeyHash384ColBuff[ subdictTableIdx.size() ];
			Iterator< CFBamDbKeyHash384ColBuff > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
			...
			Map< CFBamValuePKey, CFBamDbKeyHash384ColBuff > subdictTableIdx
				= new HashMap< CFBamValuePKey, CFBamDbKeyHash384ColBuff >();
			dictByTableIdx.put( key, subdictTableIdx );
			recArray = new CFBamDbKeyHash384ColBuff[0];
		}
		return( recArray );
	}

	public CFBamDbKeyHash384ColBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		long TenantId,
		long Id )
	{
	...
	public CFBamDbKeyHash384ColBuff readBuff( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		final String S_ProcName = "CFBamRamDbKeyHash384Col.readBuff";
		CFBamDbKeyHash384ColBuff buff = readDerived( Authorization, PKey );
	...
	public CFBamDbKeyHash384ColBuff lockBuff( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
	...
	public CFBamDbKeyHash384ColBuff[] readAllBuff( CFSecAuthorization Authorization )
	{
		final String S_ProcName = "CFBamRamDbKeyHash384Col.readAllBuff";
		CFBamDbKeyHash384ColBuff buff;
		ArrayList<CFBamDbKeyHash384ColBuff> filteredList = new ArrayList<CFBamDbKeyHash384ColBuff>();
		CFBamDbKeyHash384ColBuff[] buffList = readAllDerived( Authorization );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a84c" ) ) {
	...
	public CFBamDbKeyHash384ColBuff readBuffByIdIdx( CFSecAuthorization Authorization,
		long TenantId,
		long Id )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByIdIdx() ";
		CFBamDbKeyHash384ColBuff buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
	...
	public CFBamDbKeyHash384ColBuff readBuffByUNameIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		String Name )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByUNameIdx() ";
		CFBamDbKeyHash384ColBuff buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash384ColBuff[] readBuffByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByValTentIdx() ";
		CFBamDbKeyHash384ColBuff buff;
		ArrayList<CFBamDbKeyHash384ColBuff> filteredList = new ArrayList<CFBamDbKeyHash384ColBuff>();
		CFBamDbKeyHash384ColBuff[] buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash384ColBuff[] readBuffByScopeIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId )
	{
		...
		CFBamDbKeyHash384ColBuff buff;
		ArrayList<CFBamDbKeyHash384ColBuff> filteredList = new ArrayList<CFBamDbKeyHash384ColBuff>();
		CFBamDbKeyHash384ColBuff[] buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash384ColBuff[] readBuffByDefSchemaIdx( CFSecAuthorization Authorization,
		Long DefSchemaTenantId,
		Long DefSchemaId )
	{
		...
		CFBamDbKeyHash384ColBuff buff;
		ArrayList<CFBamDbKeyHash384ColBuff> filteredList = new ArrayList<CFBamDbKeyHash384ColBuff>();
		CFBamDbKeyHash384ColBuff[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash384ColBuff[] readBuffByPrevIdx( CFSecAuthorization Authorization,
		Long PrevTenantId,
		Long PrevId )
	{
		...
		CFBamDbKeyHash384ColBuff buff;
		ArrayList<CFBamDbKeyHash384ColBuff> filteredList = new ArrayList<CFBamDbKeyHash384ColBuff>();
		CFBamDbKeyHash384ColBuff[] buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash384ColBuff[] readBuffByNextIdx( CFSecAuthorization Authorization,
		Long NextTenantId,
		Long NextId )
	{
		...
		CFBamDbKeyHash384ColBuff buff;
		ArrayList<CFBamDbKeyHash384ColBuff> filteredList = new ArrayList<CFBamDbKeyHash384ColBuff>();
		CFBamDbKeyHash384ColBuff[] buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	public CFBamDbKeyHash384ColBuff[] readBuffByContPrevIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long PrevId )
	{
		...
		CFBamDbKeyHash384ColBuff buff;
		ArrayList<CFBamDbKeyHash384ColBuff> filteredList = new ArrayList<CFBamDbKeyHash384ColBuff>();
		CFBamDbKeyHash384ColBuff[] buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash384ColBuff[] readBuffByContNextIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long NextId )
	{
		...
		CFBamDbKeyHash384ColBuff buff;
		ArrayList<CFBamDbKeyHash384ColBuff> filteredList = new ArrayList<CFBamDbKeyHash384ColBuff>();
		CFBamDbKeyHash384ColBuff[] buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash384ColBuff[] readBuffByCodeVisIdx( CFSecAuthorization Authorization,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		final String S_ProcName = "CFBamRamValue.readBuffByCodeVisIdx() ";
		CFBamDbKeyHash384ColBuff buff;
		ArrayList<CFBamDbKeyHash384ColBuff> filteredList = new ArrayList<CFBamDbKeyHash384ColBuff>();
		CFBamDbKeyHash384ColBuff[] buffList = readDerivedByCodeVisIdx( Authorization,
			CodeVis );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a80c" ) ) {
	...
	public CFBamDbKeyHash384ColBuff[] readBuffByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		...
		CFBamDbKeyHash384ColBuff buff;
		ArrayList<CFBamDbKeyHash384ColBuff> filteredList = new ArrayList<CFBamDbKeyHash384ColBuff>();
		CFBamDbKeyHash384ColBuff[] buffList = readDerivedByScopeCodeVisIdx( Authorization,
			TenantId,
			ScopeId,
			CodeVis );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public CFBamDbKeyHash384ColBuff[] readBuffByTableIdx( CFSecAuthorization Authorization,
		long TenantId,
		long TableId )
	{
		final String S_ProcName = "CFBamRamDbKeyHash384Col.readBuffByTableIdx() ";
		CFBamDbKeyHash384ColBuff buff;
		ArrayList<CFBamDbKeyHash384ColBuff> filteredList = new ArrayList<CFBamDbKeyHash384ColBuff>();
		CFBamDbKeyHash384ColBuff[] buffList = readDerivedByTableIdx( Authorization,
			TenantId,
			TableId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
	...
	/**
	 *	Read a page array of the specific DbKeyHash384Col buffer instances identified by the duplicate key TableIdx.
	 *
	 ...
	 */
	public CFBamDbKeyHash384ColBuff[] pageBuffByTableIdx( CFSecAuthorization Authorization,
		long TenantId,
		long TableId,
		Long priorTenantId,
		Long priorId )
	 ...
	 */
	public CFBamDbKeyHash384ColBuff moveBuffUp( CFSecAuthorization Authorization,
		long TenantId,
		long Id,
		int revision )
	{
		...
		{
			return( (CFBamDbKeyHash384ColBuff)cur );
		}
		...
		return( (CFBamDbKeyHash384ColBuff)editCur );
	}
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public CFBamDbKeyHash384ColBuff moveBuffDown( CFSecAuthorization Authorization,
		long TenantId,
		long Id,
		int revision )
	{
	...
	public void updateDbKeyHash384Col( CFSecAuthorization Authorization,
		CFBamDbKeyHash384ColBuff Buff )
	{
		...
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
		CFBamDbKeyHash384ColBuff existing = dictByPKey.get( pkey );
		if( existing == null ) {
			throw new CFLibStaleCacheDetectedException( getClass(),
				"updateDbKeyHash384Col",
				"Existing record not found",
				"DbKeyHash384Col",
				pkey );
		}
		CFBamDbKeyHash384ColByTableIdxKey existingKeyTableIdx = schema.getFactoryDbKeyHash384Col().newTableIdxKey();
		...
		CFBamDbKeyHash384ColByTableIdxKey newKeyTableIdx = schema.getFactoryDbKeyHash384Col().newTableIdxKey();
		...
		Map< CFBamValuePKey, CFBamDbKeyHash384ColBuff > subdict;
		...
		if( dictByTableIdx.containsKey( newKeyTableIdx ) ) {
			...
			subdict = new HashMap< CFBamValuePKey, CFBamDbKeyHash384ColBuff >();
	...
	public void deleteDbKeyHash384Col( CFSecAuthorization Authorization,
		CFBamDbKeyHash384ColBuff Buff )
	{
		final String S_ProcName = "CFBamRamDbKeyHash384ColTable.deleteDbKeyHash384Col() ";
		String classCode;
		CFBamValuePKey pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredId( Buff.getRequiredId() );
	...
	public void deleteDbKeyHash384ColByTableIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argTableId )
	{
		CFBamDbKeyHash384ColByTableIdxKey key = schema.getFactoryDbKeyHash384Col().newTableIdxKey();
		...
		deleteDbKeyHash384ColByTableIdx( Authorization, key );
	}

	public void deleteDbKeyHash384ColByTableIdx( CFSecAuthorization Authorization,
		CFBamDbKeyHash384ColByTableIdxKey argKey )
	{
		CFBamDbKeyHash384ColBuff cur;
		...
		LinkedList<CFBamDbKeyHash384ColBuff> matchSet = new LinkedList<CFBamDbKeyHash384ColBuff>();
		Iterator<CFBamDbKeyHash384ColBuff> values = dictByPKey.values().iterator();
		...
		Iterator<CFBamDbKeyHash384ColBuff> iterMatch = matchSet.iterator();
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = schema.getTableDbKeyHash384Col().readDerivedByIdIdx( Authorization,
				cur.getRequiredTenantId(),
				cur.getRequiredId() );
			deleteDbKeyHash384Col( Authorization, cur );
		}
	}

	public void deleteDbKeyHash384ColByIdIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argId )
	{
		CFBamValuePKey key = schema.getFactoryValue().newPKey();
		...
		deleteDbKeyHash384ColByIdIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash384ColByUNameIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		String argName )
	{
		...
		deleteDbKeyHash384ColByUNameIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash384ColByValTentIdx( CFSecAuthorization Authorization,
		long argTenantId )
	{
		CFBamValueByValTentIdxKey key = schema.getFactoryValue().newValTentIdxKey();
		key.setRequiredTenantId( argTenantId );
		deleteDbKeyHash384ColByValTentIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash384ColByScopeIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId )
	{
		...
		key.setRequiredTenantId( argTenantId );
		key.setRequiredScopeId( argScopeId );
		deleteDbKeyHash384ColByScopeIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash384ColByDefSchemaIdx( CFSecAuthorization Authorization,
		...
		Long argDefSchemaId )
	{
		...
		deleteDbKeyHash384ColByDefSchemaIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash384ColByPrevIdx( CFSecAuthorization Authorization,
		...
		Long argPrevId )
	{
		...
		deleteDbKeyHash384ColByPrevIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash384ColByNextIdx( CFSecAuthorization Authorization,
		...
		Long argNextId )
	{
		...
		deleteDbKeyHash384ColByNextIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash384ColByContPrevIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		Long argPrevId )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setOptionalPrevId( argPrevId );
		deleteDbKeyHash384ColByContPrevIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash384ColByContNextIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		Long argNextId )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setOptionalNextId( argNextId );
		deleteDbKeyHash384ColByContNextIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash384ColByCodeVisIdx( CFSecAuthorization Authorization,
		ICFBamSchema.CodeVisibilityEnum argCodeVis )
	{
		...
		deleteDbKeyHash384ColByCodeVisIdx( Authorization, key );
	}
	...
	public void deleteDbKeyHash384ColByScopeCodeVisIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		ICFBamSchema.CodeVisibilityEnum argCodeVis )
	{
		...
		key.setRequiredScopeId( argScopeId );
		key.setRequiredCodeVis( argCodeVis );
		deleteDbKeyHash384ColByScopeCodeVisIdx( Authorization, key );
	}
